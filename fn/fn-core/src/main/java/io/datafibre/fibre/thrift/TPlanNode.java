...
public class TPlanNode implements org.apache.thrift.TBase<TPlanNode, TPlanNode._Fields>, java.io.Serializable, Cloneable, Comparable<TPlanNode> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> conjuncts; // optional
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TRuntimeFilterDescription> probe_runtime_filters; // optional
  ...
  public TPlanNode(TPlanNode other) {
    ...
    if (other.isSetConjuncts()) {
      java.util.List<io.datafibre.fibre.thrift.TExpr> __this__conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(other.conjuncts.size());
      for (io.datafibre.fibre.thrift.TExpr other_element : other.conjuncts) {
        __this__conjuncts.add(new io.datafibre.fibre.thrift.TExpr(other_element));
      }
    ...
    if (other.isSetProbe_runtime_filters()) {
      java.util.List<io.datafibre.fibre.thrift.TRuntimeFilterDescription> __this__probe_runtime_filters = new java.util.ArrayList<io.datafibre.fibre.thrift.TRuntimeFilterDescription>(other.probe_runtime_filters.size());
      for (io.datafibre.fibre.thrift.TRuntimeFilterDescription other_element : other.probe_runtime_filters) {
        __this__probe_runtime_filters.add(new io.datafibre.fibre.thrift.TRuntimeFilterDescription(other_element));
      }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TExpr> getConjunctsIterator() {
    return (this.conjuncts == null) ? null : this.conjuncts.iterator();
  }

  public void addToConjuncts(io.datafibre.fibre.thrift.TExpr elem) {
    if (this.conjuncts == null) {
      this.conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>();
    }
    this.conjuncts.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TExpr> getConjuncts() {
    return this.conjuncts;
  }

  public TPlanNode setConjuncts(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> conjuncts) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TRuntimeFilterDescription> getProbe_runtime_filtersIterator() {
    return (this.probe_runtime_filters == null) ? null : this.probe_runtime_filters.iterator();
  }

  public void addToProbe_runtime_filters(io.datafibre.fibre.thrift.TRuntimeFilterDescription elem) {
    if (this.probe_runtime_filters == null) {
      this.probe_runtime_filters = new java.util.ArrayList<io.datafibre.fibre.thrift.TRuntimeFilterDescription>();
    }
    this.probe_runtime_filters.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TRuntimeFilterDescription> getProbe_runtime_filters() {
    return this.probe_runtime_filters;
  }

  public TPlanNode setProbe_runtime_filters(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TRuntimeFilterDescription> probe_runtime_filters) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case CONJUNCTS:
      if (value == null) {
        ...
        setConjuncts((java.util.List<io.datafibre.fibre.thrift.TExpr>)value);
      }
      break;
    ...
    case PROBE_RUNTIME_FILTERS:
      if (value == null) {
        ...
        setProbe_runtime_filters((java.util.List<io.datafibre.fibre.thrift.TRuntimeFilterDescription>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list1000.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem1001;
                for (int _i1002 = 0; _i1002 < _list1000.size; ++_i1002)
                {
                  _elem1001 = new io.datafibre.fibre.thrift.TExpr();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.probe_runtime_filters = new java.util.ArrayList<io.datafibre.fibre.thrift.TRuntimeFilterDescription>(_list1003.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TRuntimeFilterDescription _elem1004;
                for (int _i1005 = 0; _i1005 < _list1003.size; ++_i1005)
                {
                  _elem1004 = new io.datafibre.fibre.thrift.TRuntimeFilterDescription();
      ...
      if (struct.conjuncts != null) {
        if (struct.isSetConjuncts()) {
          oprot.writeFieldBegin(CONJUNCTS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TExpr _iter1014 : struct.conjuncts)
            {
      ...
      if (struct.probe_runtime_filters != null) {
        if (struct.isSetProbe_runtime_filters()) {
          oprot.writeFieldBegin(PROBE_RUNTIME_FILTERS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TRuntimeFilterDescription _iter1015 : struct.probe_runtime_filters)
            {
      ...
      if (struct.isSetConjuncts()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TExpr _iter1020 : struct.conjuncts)
          {
      ...
      if (struct.isSetProbe_runtime_filters()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TRuntimeFilterDescription _iter1021 : struct.probe_runtime_filters)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list1030.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem1031;
          for (int _i1032 = 0; _i1032 < _list1030.size; ++_i1032)
          {
            _elem1031 = new io.datafibre.fibre.thrift.TExpr();
      ...
      if (incoming.get(24)) {
        {
          ...
          struct.probe_runtime_filters = new java.util.ArrayList<io.datafibre.fibre.thrift.TRuntimeFilterDescription>(_list1033.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TRuntimeFilterDescription _elem1034;
          for (int _i1035 = 0; _i1035 < _list1033.size; ++_i1035)
          {
            _elem1034 = new io.datafibre.fibre.thrift.TRuntimeFilterDescription();
