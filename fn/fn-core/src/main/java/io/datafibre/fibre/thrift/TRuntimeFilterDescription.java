...
public class TRuntimeFilterDescription implements org.apache.thrift.TBase<TRuntimeFilterDescription, TRuntimeFilterDescription._Fields>, java.io.Serializable, Cloneable, Comparable<TRuntimeFilterDescription> {
  ...
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr build_expr; // optional
  public int expr_order; // optional
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,io.datafibre.fibre.thrift.TExpr> plan_node_id_to_target_expr; // optional
  public boolean has_remote_targets; // optional
  public long bloom_filter_size; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TNetworkAddress> runtime_filter_merge_nodes; // optional
  /**
   * 
  ...
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TUniqueId sender_finst_id; // optional
  public int build_plan_node_id; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TUniqueId> broadcast_grf_senders; // optional
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>> plan_node_id_to_partition_by_exprs; // optional
  /**
   * 
  ...
  public TRuntimeFilterDescription(TRuntimeFilterDescription other) {
    ...
    if (other.isSetBuild_expr()) {
      this.build_expr = new io.datafibre.fibre.thrift.TExpr(other.build_expr);
    }
    this.expr_order = other.expr_order;
    if (other.isSetPlan_node_id_to_target_expr()) {
      java.util.Map<java.lang.Integer,io.datafibre.fibre.thrift.TExpr> __this__plan_node_id_to_target_expr = new java.util.HashMap<java.lang.Integer,io.datafibre.fibre.thrift.TExpr>(other.plan_node_id_to_target_expr.size());
      for (java.util.Map.Entry<java.lang.Integer, io.datafibre.fibre.thrift.TExpr> other_element : other.plan_node_id_to_target_expr.entrySet()) {
        ...
        io.datafibre.fibre.thrift.TExpr __this__plan_node_id_to_target_expr_copy_value = new io.datafibre.fibre.thrift.TExpr(other_element_value);
    ...
    if (other.isSetRuntime_filter_merge_nodes()) {
      java.util.List<io.datafibre.fibre.thrift.TNetworkAddress> __this__runtime_filter_merge_nodes = new java.util.ArrayList<io.datafibre.fibre.thrift.TNetworkAddress>(other.runtime_filter_merge_nodes.size());
      for (io.datafibre.fibre.thrift.TNetworkAddress other_element : other.runtime_filter_merge_nodes) {
        __this__runtime_filter_merge_nodes.add(new io.datafibre.fibre.thrift.TNetworkAddress(other_element));
      }
    ...
    if (other.isSetSender_finst_id()) {
      this.sender_finst_id = new io.datafibre.fibre.thrift.TUniqueId(other.sender_finst_id);
    }
    this.build_plan_node_id = other.build_plan_node_id;
    if (other.isSetBroadcast_grf_senders()) {
      java.util.List<io.datafibre.fibre.thrift.TUniqueId> __this__broadcast_grf_senders = new java.util.ArrayList<io.datafibre.fibre.thrift.TUniqueId>(other.broadcast_grf_senders.size());
      for (io.datafibre.fibre.thrift.TUniqueId other_element : other.broadcast_grf_senders) {
        __this__broadcast_grf_senders.add(new io.datafibre.fibre.thrift.TUniqueId(other_element));
      }
    ...
    if (other.isSetPlan_node_id_to_partition_by_exprs()) {
      java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>> __this__plan_node_id_to_partition_by_exprs = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>>(other.plan_node_id_to_partition_by_exprs.size());
      for (java.util.Map.Entry<java.lang.Integer, java.util.List<io.datafibre.fibre.thrift.TExpr>> other_element : other.plan_node_id_to_partition_by_exprs.entrySet()) {

        java.lang.Integer other_element_key = other_element.getKey();
        java.util.List<io.datafibre.fibre.thrift.TExpr> other_element_value = other_element.getValue();

        java.lang.Integer __this__plan_node_id_to_partition_by_exprs_copy_key = other_element_key;

        java.util.List<io.datafibre.fibre.thrift.TExpr> __this__plan_node_id_to_partition_by_exprs_copy_value = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(other_element_value.size());
        for (io.datafibre.fibre.thrift.TExpr other_element_value_element : other_element_value) {
          __this__plan_node_id_to_partition_by_exprs_copy_value.add(new io.datafibre.fibre.thrift.TExpr(other_element_value_element));
        }
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TExpr getBuild_expr() {
    return this.build_expr;
  }

  public TRuntimeFilterDescription setBuild_expr(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr build_expr) {
  ...
  public void putToPlan_node_id_to_target_expr(int key, io.datafibre.fibre.thrift.TExpr val) {
    if (this.plan_node_id_to_target_expr == null) {
      this.plan_node_id_to_target_expr = new java.util.HashMap<java.lang.Integer,io.datafibre.fibre.thrift.TExpr>();
    }
    this.plan_node_id_to_target_expr.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.Integer,io.datafibre.fibre.thrift.TExpr> getPlan_node_id_to_target_expr() {
    return this.plan_node_id_to_target_expr;
  }

  public TRuntimeFilterDescription setPlan_node_id_to_target_expr(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,io.datafibre.fibre.thrift.TExpr> plan_node_id_to_target_expr) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TNetworkAddress> getRuntime_filter_merge_nodesIterator() {
    return (this.runtime_filter_merge_nodes == null) ? null : this.runtime_filter_merge_nodes.iterator();
  }

  public void addToRuntime_filter_merge_nodes(io.datafibre.fibre.thrift.TNetworkAddress elem) {
    if (this.runtime_filter_merge_nodes == null) {
      this.runtime_filter_merge_nodes = new java.util.ArrayList<io.datafibre.fibre.thrift.TNetworkAddress>();
    }
    this.runtime_filter_merge_nodes.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TNetworkAddress> getRuntime_filter_merge_nodes() {
    return this.runtime_filter_merge_nodes;
  }

  public TRuntimeFilterDescription setRuntime_filter_merge_nodes(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TNetworkAddress> runtime_filter_merge_nodes) {
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TUniqueId getSender_finst_id() {
    return this.sender_finst_id;
  }

  public TRuntimeFilterDescription setSender_finst_id(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TUniqueId sender_finst_id) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TUniqueId> getBroadcast_grf_sendersIterator() {
    return (this.broadcast_grf_senders == null) ? null : this.broadcast_grf_senders.iterator();
  }

  public void addToBroadcast_grf_senders(io.datafibre.fibre.thrift.TUniqueId elem) {
    if (this.broadcast_grf_senders == null) {
      this.broadcast_grf_senders = new java.util.ArrayList<io.datafibre.fibre.thrift.TUniqueId>();
    }
    this.broadcast_grf_senders.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TUniqueId> getBroadcast_grf_senders() {
    return this.broadcast_grf_senders;
  }

  public TRuntimeFilterDescription setBroadcast_grf_senders(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TUniqueId> broadcast_grf_senders) {
  ...
  public void putToPlan_node_id_to_partition_by_exprs(int key, java.util.List<io.datafibre.fibre.thrift.TExpr> val) {
    if (this.plan_node_id_to_partition_by_exprs == null) {
      this.plan_node_id_to_partition_by_exprs = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>>();
    }
    this.plan_node_id_to_partition_by_exprs.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>> getPlan_node_id_to_partition_by_exprs() {
    return this.plan_node_id_to_partition_by_exprs;
  }

  public TRuntimeFilterDescription setPlan_node_id_to_partition_by_exprs(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>> plan_node_id_to_partition_by_exprs) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case BUILD_EXPR:
      if (value == null) {
        ...
        setBuild_expr((io.datafibre.fibre.thrift.TExpr)value);
      }
      break;
    ...
    case PLAN_NODE_ID_TO_TARGET_EXPR:
      if (value == null) {
        ...
        setPlan_node_id_to_target_expr((java.util.Map<java.lang.Integer,io.datafibre.fibre.thrift.TExpr>)value);
      }
      break;
    ...
    case RUNTIME_FILTER_MERGE_NODES:
      if (value == null) {
        ...
        setRuntime_filter_merge_nodes((java.util.List<io.datafibre.fibre.thrift.TNetworkAddress>)value);
      }
      break;
    ...
    case SENDER_FINST_ID:
      if (value == null) {
        ...
        setSender_finst_id((io.datafibre.fibre.thrift.TUniqueId)value);
      }
      break;
    ...
    case BROADCAST_GRF_SENDERS:
      if (value == null) {
        ...
        setBroadcast_grf_senders((java.util.List<io.datafibre.fibre.thrift.TUniqueId>)value);
      }
      break;
    ...
    case PLAN_NODE_ID_TO_PARTITION_BY_EXPRS:
      if (value == null) {
        ...
        setPlan_node_id_to_partition_by_exprs((java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>>)value);
      }
      break;
        ...
        switch (schemeField.id) {
          ...
          case 2: // BUILD_EXPR
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.build_expr = new io.datafibre.fibre.thrift.TExpr();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.plan_node_id_to_target_expr = new java.util.HashMap<java.lang.Integer,io.datafibre.fibre.thrift.TExpr>(2*_map32.size);
                int _key33;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.runtime_filter_merge_nodes = new java.util.ArrayList<io.datafibre.fibre.thrift.TNetworkAddress>(_list36.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TNetworkAddress _elem37;
                for (int _i38 = 0; _i38 < _list36.size; ++_i38)
                {
                  _elem37 = new io.datafibre.fibre.thrift.TNetworkAddress();
                  _elem37.read(iprot);
          ...
          case 9: // BUILD_JOIN_MODE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.build_join_mode = io.datafibre.fibre.thrift.TRuntimeFilterBuildJoinMode.findByValue(iprot.readI32());
          ...
          case 10: // SENDER_FINST_ID
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.sender_finst_id = new io.datafibre.fibre.thrift.TUniqueId();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.broadcast_grf_senders = new java.util.ArrayList<io.datafibre.fibre.thrift.TUniqueId>(_list39.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TUniqueId _elem40;
                for (int _i41 = 0; _i41 < _list39.size; ++_i41)
                {
                  _elem40 = new io.datafibre.fibre.thrift.TUniqueId();
                  _elem40.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.plan_node_id_to_partition_by_exprs = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>>(2*_map48.size);
                int _key49;
                @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _val50;
                for (int _i51 = 0; _i51 < _map48.size; ++_i51)
                {
                  _key49 = iprot.readI32();
                  {
                    org.apache.thrift.protocol.TList _list52 = iprot.readListBegin();
                    _val50 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list52.size);
                    @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem53;
                    for (int _i54 = 0; _i54 < _list52.size; ++_i54)
                    {
                      _elem53 = new io.datafibre.fibre.thrift.TExpr();
                      _elem53.read(iprot);
                      _val50.add(_elem53);
                    }
                    iprot.readListEnd();
          ...
          case 16: // FILTER_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.filter_type = io.datafibre.fibre.thrift.TRuntimeFilterBuildType.findByValue(iprot.readI32());
      ...
      if (struct.plan_node_id_to_target_expr != null) {
        if (struct.isSetPlan_node_id_to_target_expr()) {
          oprot.writeFieldBegin(PLAN_NODE_ID_TO_TARGET_EXPR_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, io.datafibre.fibre.thrift.TExpr> _iter55 : struct.plan_node_id_to_target_expr.entrySet())
            {
      ...
      if (struct.runtime_filter_merge_nodes != null) {
        if (struct.isSetRuntime_filter_merge_nodes()) {
          oprot.writeFieldBegin(RUNTIME_FILTER_MERGE_NODES_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TNetworkAddress _iter56 : struct.runtime_filter_merge_nodes)
            {
              _iter56.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.broadcast_grf_senders != null) {
        if (struct.isSetBroadcast_grf_senders()) {
          oprot.writeFieldBegin(BROADCAST_GRF_SENDERS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TUniqueId _iter57 : struct.broadcast_grf_senders)
            {
              _iter57.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.plan_node_id_to_partition_by_exprs != null) {
        if (struct.isSetPlan_node_id_to_partition_by_exprs()) {
          oprot.writeFieldBegin(PLAN_NODE_ID_TO_PARTITION_BY_EXPRS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, java.util.List<io.datafibre.fibre.thrift.TExpr>> _iter60 : struct.plan_node_id_to_partition_by_exprs.entrySet())
            {
              oprot.writeI32(_iter60.getKey());
              {
                ...
                for (io.datafibre.fibre.thrift.TExpr _iter61 : _iter60.getValue())
                {
                  _iter61.write(oprot);
                }
                oprot.writeListEnd();
      ...
      if (struct.isSetPlan_node_id_to_target_expr()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, io.datafibre.fibre.thrift.TExpr> _iter62 : struct.plan_node_id_to_target_expr.entrySet())
          {
      ...
      if (struct.isSetRuntime_filter_merge_nodes()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TNetworkAddress _iter63 : struct.runtime_filter_merge_nodes)
          {
            _iter63.write(oprot);
          }
        }
      ...
      if (struct.isSetBroadcast_grf_senders()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TUniqueId _iter64 : struct.broadcast_grf_senders)
          {
            _iter64.write(oprot);
          }
        }
      ...
      if (struct.isSetPlan_node_id_to_partition_by_exprs()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.util.List<io.datafibre.fibre.thrift.TExpr>> _iter67 : struct.plan_node_id_to_partition_by_exprs.entrySet())
          {
            oprot.writeI32(_iter67.getKey());
            {
              oprot.writeI32(_iter67.getValue().size());
              for (io.datafibre.fibre.thrift.TExpr _iter68 : _iter67.getValue())
              {
                _iter68.write(oprot);
              }
            }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.plan_node_id_to_target_expr = new java.util.HashMap<java.lang.Integer,io.datafibre.fibre.thrift.TExpr>(2*_map69.size);
          int _key70;
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _val71;
          for (int _i72 = 0; _i72 < _map69.size; ++_i72)
          {
            _key70 = iprot.readI32();
            _val71 = new io.datafibre.fibre.thrift.TExpr();
            _val71.read(iprot);
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.runtime_filter_merge_nodes = new java.util.ArrayList<io.datafibre.fibre.thrift.TNetworkAddress>(_list73.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TNetworkAddress _elem74;
          for (int _i75 = 0; _i75 < _list73.size; ++_i75)
          {
            _elem74 = new io.datafibre.fibre.thrift.TNetworkAddress();
            _elem74.read(iprot);
      ...
      if (incoming.get(10)) {
        {
          ...
          struct.broadcast_grf_senders = new java.util.ArrayList<io.datafibre.fibre.thrift.TUniqueId>(_list76.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TUniqueId _elem77;
          for (int _i78 = 0; _i78 < _list76.size; ++_i78)
          {
            _elem77 = new io.datafibre.fibre.thrift.TUniqueId();
            _elem77.read(iprot);
      ...
      if (incoming.get(13)) {
        {
          ...
          struct.plan_node_id_to_partition_by_exprs = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>>(2*_map85.size);
          int _key86;
          @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _val87;
          for (int _i88 = 0; _i88 < _map85.size; ++_i88)
          {
            _key86 = iprot.readI32();
            {
              ...
              _val87 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list89.size);
              @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem90;
              for (int _i91 = 0; _i91 < _list89.size; ++_i91)
              {
                _elem90 = new io.datafibre.fibre.thrift.TExpr();
                _elem90.read(iprot);
                _val87.add(_elem90);
              }
            }
