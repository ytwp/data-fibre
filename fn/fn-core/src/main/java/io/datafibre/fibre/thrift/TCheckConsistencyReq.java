...
public class TCheckConsistencyReq implements org.apache.thrift.TBase<TCheckConsistencyReq, TCheckConsistencyReq._Fields>, java.io.Serializable, Cloneable, Comparable<TCheckConsistencyReq> {
  ...
  public TCheckConsistencyReq setTablet_id(long tablet_id) {
    this.tablet_id = tablet_id;
    setTablet_idIsSet(true);
    return this;
  }
  ...
  public TCheckConsistencyReq setSchema_hash(int schema_hash) {
    this.schema_hash = schema_hash;
    setSchema_hashIsSet(true);
    return this;
  }
  ...
  public TCheckConsistencyReq setVersion_hash(long version_hash) {
    this.version_hash = version_hash;
    setVersion_hashIsSet(true);
    return this;
  }
