...
public class TMultiCastDataStreamSink implements org.apache.thrift.TBase<TMultiCastDataStreamSink, TMultiCastDataStreamSink._Fields>, java.io.Serializable, Cloneable, Comparable<TMultiCastDataStreamSink> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<TDataStreamSink> sinks; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<TPlanFragmentDestination>> destinations; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.SINKS, new org.apache.thrift.meta_data.FieldMetaData("sinks", org.apache.thrift.TFieldRequirementType.REQUIRED, 
    ...
    tmpMap.put(_Fields.DESTINATIONS, new org.apache.thrift.meta_data.FieldMetaData("destinations", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
  ...
  public TMultiCastDataStreamSink(
    java.util.List<TDataStreamSink> sinks,
    java.util.List<java.util.List<TPlanFragmentDestination>> destinations)
  {
    this();
    this.sinks = sinks;
  ...
  public int compareTo(TMultiCastDataStreamSink other) {
    ...
    lastComparison = Boolean.compare(isSetSinks(), other.isSetSinks());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.compare(isSetDestinations(), other.isSetDestinations());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDestinations()) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (sinks == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'sinks' was not present! Struct: " + toString());
    }
    if (destinations == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'destinations' was not present! Struct: " + toString());
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sinks = new java.util.ArrayList<TDataStreamSink>(_list34.size);
                @org.apache.thrift.annotation.Nullable TDataStreamSink _elem35;
                for (int _i36 = 0; _i36 < _list34.size; ++_i36)
                {
                  _elem35 = new TDataStreamSink();
                  _elem35.read(iprot);
                  struct.sinks.add(_elem35);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.destinations = new java.util.ArrayList<java.util.List<TPlanFragmentDestination>>(_list37.size);
                @org.apache.thrift.annotation.Nullable java.util.List<TPlanFragmentDestination> _elem38;
                for (int _i39 = 0; _i39 < _list37.size; ++_i39)
                {
                  {
                    org.apache.thrift.protocol.TList _list40 = iprot.readListBegin();
                    _elem38 = new java.util.ArrayList<TPlanFragmentDestination>(_list40.size);
                    @org.apache.thrift.annotation.Nullable TPlanFragmentDestination _elem41;
                    for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                    {
                      _elem41 = new TPlanFragmentDestination();
                      _elem41.read(iprot);
                      _elem38.add(_elem41);
                    }
                    iprot.readListEnd();
                  }
                  struct.destinations.add(_elem38);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TMultiCastDataStreamSink struct) throws org.apache.thrift.TException {
      ...
      if (struct.sinks != null) {
        oprot.writeFieldBegin(SINKS_FIELD_DESC);
        {
          ...
          for (TDataStreamSink _iter43 : struct.sinks)
          {
            _iter43.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.destinations != null) {
        oprot.writeFieldBegin(DESTINATIONS_FIELD_DESC);
        {
          ...
          for (java.util.List<TPlanFragmentDestination> _iter44 : struct.destinations)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter44.size()));
              for (TPlanFragmentDestination _iter45 : _iter44)
              {
                _iter45.write(oprot);
              }
              oprot.writeListEnd();
  ...
  private static class TMultiCastDataStreamSinkTupleScheme extends org.apache.thrift.scheme.TupleScheme<TMultiCastDataStreamSink> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TMultiCastDataStreamSink struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (TDataStreamSink _iter46 : struct.sinks)
        {
          _iter46.write(oprot);
        }
      }
      {
        ...
        for (java.util.List<TPlanFragmentDestination> _iter47 : struct.destinations)
        {
          {
            oprot.writeI32(_iter47.size());
            for (TPlanFragmentDestination _iter48 : _iter47)
            {
              _iter48.write(oprot);
            }
          }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TMultiCastDataStreamSink struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.sinks = new java.util.ArrayList<TDataStreamSink>(_list49.size);
        @org.apache.thrift.annotation.Nullable TDataStreamSink _elem50;
        for (int _i51 = 0; _i51 < _list49.size; ++_i51)
        {
          _elem50 = new TDataStreamSink();
          _elem50.read(iprot);
          struct.sinks.add(_elem50);
        }
      }
      struct.setSinksIsSet(true);
      {
        org.apache.thrift.protocol.TList _list52 = iprot.readListBegin(org.apache.thrift.protocol.TType.LIST);
        struct.destinations = new java.util.ArrayList<java.util.List<TPlanFragmentDestination>>(_list52.size);
        @org.apache.thrift.annotation.Nullable java.util.List<TPlanFragmentDestination> _elem53;
        for (int _i54 = 0; _i54 < _list52.size; ++_i54)
        {
          {
            org.apache.thrift.protocol.TList _list55 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
            _elem53 = new java.util.ArrayList<TPlanFragmentDestination>(_list55.size);
            @org.apache.thrift.annotation.Nullable TPlanFragmentDestination _elem56;
            for (int _i57 = 0; _i57 < _list55.size; ++_i57)
            {
              _elem56 = new TPlanFragmentDestination();
              _elem56.read(iprot);
              _elem53.add(_elem56);
            }
          }
          struct.destinations.add(_elem53);
        }
      }
      struct.setDestinationsIsSet(true);
    }
