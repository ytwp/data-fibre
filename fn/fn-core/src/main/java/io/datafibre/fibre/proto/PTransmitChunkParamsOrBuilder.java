...
public interface PTransmitChunkParamsOrBuilder extends
   ...
   */
  java.util.List<io.datafibre.fibre.proto.ChunkPB>
      getChunksList();
  /**
   * <pre>
   * The protobuf data structure for column chunk.
   ...
   * <code>repeated .starrocks.ChunkPB chunks = 7;</code>
   */
  io.datafibre.fibre.proto.ChunkPB getChunks(int index);
  /**
   * <pre>
   * The protobuf data structure for column chunk.
   * </pre>
   ...
   * <code>repeated .starrocks.ChunkPB chunks = 7;</code>
   */
  java.util.List<? extends io.datafibre.fibre.proto.ChunkPBOrBuilder>
   ...
   * <code>repeated .starrocks.ChunkPB chunks = 7;</code>
   */
  io.datafibre.fibre.proto.ChunkPBOrBuilder getChunksOrBuilder(
      int index);
