...
public class TUnionNode implements org.apache.thrift.TBase<TUnionNode, TUnionNode._Fields>, java.io.Serializable, Cloneable, Comparable<TUnionNode> {
  ...
  public TUnionNode setResult_expr_lists(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>> result_expr_lists) {
    this.result_expr_lists = result_expr_lists;
    return this;
  }
  ...
  public TUnionNode setConst_expr_lists(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>> const_expr_lists) {
    this.const_expr_lists = const_expr_lists;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(_list674.size);
                @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _elem675;
                for (int _i676 = 0; _i676 < _list674.size; ++_i676)
                {
                  {
                    org.apache.thrift.protocol.TList _list677 = iprot.readListBegin();
                    _elem675 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list677.size);
                    @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem678;
                    for (int _i679 = 0; _i679 < _list677.size; ++_i679)
                    {
                      _elem678 = new io.datafibre.fibre.thrift.TExpr();
                      _elem678.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.const_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(_list680.size);
                @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _elem681;
                for (int _i682 = 0; _i682 < _list680.size; ++_i682)
                {
                  {
                    org.apache.thrift.protocol.TList _list683 = iprot.readListBegin();
                    _elem681 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list683.size);
                    @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem684;
                    for (int _i685 = 0; _i685 < _list683.size; ++_i685)
                    {
                      _elem684 = new io.datafibre.fibre.thrift.TExpr();
                      _elem684.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TUnionNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.result_expr_lists != null) {
        oprot.writeFieldBegin(RESULT_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<io.datafibre.fibre.thrift.TExpr> _iter693 : struct.result_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter693.size()));
              for (io.datafibre.fibre.thrift.TExpr _iter694 : _iter693)
              {
      ...
      if (struct.const_expr_lists != null) {
        oprot.writeFieldBegin(CONST_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<io.datafibre.fibre.thrift.TExpr> _iter695 : struct.const_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter695.size()));
              for (io.datafibre.fibre.thrift.TExpr _iter696 : _iter695)
              {
  ...
  private static class TUnionNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TUnionNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TUnionNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.tuple_id);
      {
        ...
        for (java.util.List<io.datafibre.fibre.thrift.TExpr> _iter699 : struct.result_expr_lists)
        {
          {
            oprot.writeI32(_iter699.size());
            for (io.datafibre.fibre.thrift.TExpr _iter700 : _iter699)
            {
      ...
      }
      {
        ...
        for (java.util.List<io.datafibre.fibre.thrift.TExpr> _iter701 : struct.const_expr_lists)
        {
          {
            oprot.writeI32(_iter701.size());
            for (io.datafibre.fibre.thrift.TExpr _iter702 : _iter701)
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TUnionNode struct) throws org.apache.thrift.TException {
      ...
      struct.setTuple_idIsSet(true);
      {
        ...
        struct.result_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(_list705.size);
        @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _elem706;
        ...
        {
          {
            ...
            _elem706 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list708.size);
            @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem709;
            for (int _i710 = 0; _i710 < _list708.size; ++_i710)
            {
              _elem709 = new io.datafibre.fibre.thrift.TExpr();
              _elem709.read(iprot);
      ...
      struct.setResult_expr_listsIsSet(true);
      {
        ...
        struct.const_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(_list711.size);
        @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _elem712;
        ...
        {
          {
            ...
            _elem712 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list714.size);
            @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem715;
            for (int _i716 = 0; _i716 < _list714.size; ++_i716)
            {
              _elem715 = new io.datafibre.fibre.thrift.TExpr();
              _elem715.read(iprot);
