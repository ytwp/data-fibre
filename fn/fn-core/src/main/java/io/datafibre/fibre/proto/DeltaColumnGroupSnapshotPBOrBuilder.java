...
public interface DeltaColumnGroupSnapshotPBOrBuilder extends
   ...
   */
  java.util.List<io.datafibre.fibre.proto.DeltaColumnGroupListPB>
      getDcgListsList();
  /**
   * <code>repeated .starrocks.DeltaColumnGroupListPB dcg_lists = 4;</code>
   */
  io.datafibre.fibre.proto.DeltaColumnGroupListPB getDcgLists(int index);
  /**
   * <code>repeated .starrocks.DeltaColumnGroupListPB dcg_lists = 4;</code>
   */
   ...
   * <code>repeated .starrocks.DeltaColumnGroupListPB dcg_lists = 4;</code>
   */
  java.util.List<? extends io.datafibre.fibre.proto.DeltaColumnGroupListPBOrBuilder>
      getDcgListsOrBuilderList();
  /**
   * <code>repeated .starrocks.DeltaColumnGroupListPB dcg_lists = 4;</code>
   */
  io.datafibre.fibre.proto.DeltaColumnGroupListPBOrBuilder getDcgListsOrBuilder(
      int index);
}
