            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<com.starrocks.thrift.TColumn>(_list880.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TColumn _elem881;
                for (int _i882 = 0; _i882 < _list880.size; ++_i882)
                {
                  _elem881 = new com.starrocks.thrift.TColumn();
                  _elem881.read(iprot);
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TColumn _iter884 : struct.columns)
            {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (com.starrocks.thrift.TColumn _iter886 : struct.columns)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.columns = new java.util.ArrayList<com.starrocks.thrift.TColumn>(_list891.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TColumn _elem892;
          for (int _i893 = 0; _i893 < _list891.size; ++_i893)
          {
            _elem892 = new com.starrocks.thrift.TColumn();
            _elem892.read(iprot);
