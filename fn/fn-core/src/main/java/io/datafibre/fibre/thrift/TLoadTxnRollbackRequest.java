...
public class TLoadTxnRollbackRequest implements org.apache.thrift.TBase<TLoadTxnRollbackRequest, TLoadTxnRollbackRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TLoadTxnRollbackRequest> {
  ...
  public TLoadTxnRollbackRequest setFailInfos(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TTabletFailInfo> failInfos) {
  ...
  public TLoadTxnRollbackRequest setCommitInfos(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TTabletCommitInfo> commitInfos) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.failInfos = new java.util.ArrayList<com.starrocks.thrift.TTabletFailInfo>(_list356.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTabletFailInfo _elem357;
                for (int _i358 = 0; _i358 < _list356.size; ++_i358)
                {
                  _elem357 = new com.starrocks.thrift.TTabletFailInfo();
                  _elem357.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commitInfos = new java.util.ArrayList<com.starrocks.thrift.TTabletCommitInfo>(_list359.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTabletCommitInfo _elem360;
                for (int _i361 = 0; _i361 < _list359.size; ++_i361)
                {
                  _elem360 = new com.starrocks.thrift.TTabletCommitInfo();
                  _elem360.read(iprot);
      ...
      if (struct.failInfos != null) {
        if (struct.isSetFailInfos()) {
          oprot.writeFieldBegin(FAIL_INFOS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TTabletFailInfo _iter362 : struct.failInfos)
            {
      ...
      if (struct.commitInfos != null) {
        if (struct.isSetCommitInfos()) {
          oprot.writeFieldBegin(COMMIT_INFOS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TTabletCommitInfo _iter363 : struct.commitInfos)
            {
      ...
      if (struct.isSetFailInfos()) {
        {
          ...
          for (com.starrocks.thrift.TTabletFailInfo _iter364 : struct.failInfos)
          {
      ...
      if (struct.isSetCommitInfos()) {
        {
          ...
          for (com.starrocks.thrift.TTabletCommitInfo _iter365 : struct.commitInfos)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.failInfos = new java.util.ArrayList<com.starrocks.thrift.TTabletFailInfo>(_list366.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTabletFailInfo _elem367;
          for (int _i368 = 0; _i368 < _list366.size; ++_i368)
          {
            _elem367 = new com.starrocks.thrift.TTabletFailInfo();
            _elem367.read(iprot);
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.commitInfos = new java.util.ArrayList<com.starrocks.thrift.TTabletCommitInfo>(_list369.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTabletCommitInfo _elem370;
          for (int _i371 = 0; _i371 < _list369.size; ++_i371)
          {
            _elem370 = new com.starrocks.thrift.TTabletCommitInfo();
            _elem370.read(iprot);
