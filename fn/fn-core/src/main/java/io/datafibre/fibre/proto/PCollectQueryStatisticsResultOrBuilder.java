...
public interface PCollectQueryStatisticsResultOrBuilder extends
   ...
   */
  java.util.List<io.datafibre.fibre.proto.PCollectQueryStatistics>
      getQueryStatisticsList();
  /**
   * <code>repeated .starrocks.PCollectQueryStatistics query_statistics = 1;</code>
   */
  io.datafibre.fibre.proto.PCollectQueryStatistics getQueryStatistics(int index);
  /**
   * <code>repeated .starrocks.PCollectQueryStatistics query_statistics = 1;</code>
   */
   ...
   * <code>repeated .starrocks.PCollectQueryStatistics query_statistics = 1;</code>
   */
  java.util.List<? extends io.datafibre.fibre.proto.PCollectQueryStatisticsOrBuilder>
      getQueryStatisticsOrBuilderList();
  /**
   * <code>repeated .starrocks.PCollectQueryStatistics query_statistics = 1;</code>
   */
  io.datafibre.fibre.proto.PCollectQueryStatisticsOrBuilder getQueryStatisticsOrBuilder(
      int index);
}
