...
public class HeartbeatService {
  ...
  public static class heartbeat_args implements org.apache.thrift.TBase<heartbeat_args, heartbeat_args._Fields>, java.io.Serializable, Cloneable, Comparable<heartbeat_args>   {
    ...
    public heartbeat_args setMaster_info(@org.apache.thrift.annotation.Nullable TMasterInfo master_info) {
      this.master_info = master_info;
      return this;
    }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetMaster_info()) ? 131071 : 524287);
      if (isSetMaster_info())
    ...
    public int compareTo(heartbeat_args other) {
      ...
      lastComparison = java.lang.Boolean.compare(isSetMaster_info(), other.isSetMaster_info());
      if (lastComparison != 0) {
