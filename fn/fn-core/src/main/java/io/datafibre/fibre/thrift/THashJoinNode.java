...
public class THashJoinNode implements org.apache.thrift.TBase<THashJoinNode, THashJoinNode._Fields>, java.io.Serializable, Cloneable, Comparable<THashJoinNode> {
  ...
  public THashJoinNode setOther_join_conjuncts(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> other_join_conjuncts) {
  ...
  public THashJoinNode setBuild_runtime_filters(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TRuntimeFilterDescription> build_runtime_filters) {
  ...
  public THashJoinNode setPartition_exprs(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> partition_exprs) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.other_join_conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list365.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem366;
                for (int _i367 = 0; _i367 < _list365.size; ++_i367)
                {
                  _elem366 = new io.datafibre.fibre.thrift.TExpr();
                  _elem366.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.build_runtime_filters = new java.util.ArrayList<io.datafibre.fibre.thrift.TRuntimeFilterDescription>(_list368.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TRuntimeFilterDescription _elem369;
                for (int _i370 = 0; _i370 < _list368.size; ++_i370)
                {
                  _elem369 = new io.datafibre.fibre.thrift.TRuntimeFilterDescription();
                  _elem369.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_exprs = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list371.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem372;
                for (int _i373 = 0; _i373 < _list371.size; ++_i373)
                {
                  _elem372 = new io.datafibre.fibre.thrift.TExpr();
                  _elem372.read(iprot);
      ...
      if (struct.other_join_conjuncts != null) {
        if (struct.isSetOther_join_conjuncts()) {
          oprot.writeFieldBegin(OTHER_JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TExpr _iter378 : struct.other_join_conjuncts)
            {
      ...
      if (struct.build_runtime_filters != null) {
        if (struct.isSetBuild_runtime_filters()) {
          oprot.writeFieldBegin(BUILD_RUNTIME_FILTERS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TRuntimeFilterDescription _iter379 : struct.build_runtime_filters)
            {
      ...
      if (struct.partition_exprs != null) {
        if (struct.isSetPartition_exprs()) {
          oprot.writeFieldBegin(PARTITION_EXPRS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TExpr _iter380 : struct.partition_exprs)
            {
      ...
      if (struct.isSetOther_join_conjuncts()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TExpr _iter383 : struct.other_join_conjuncts)
          {
      ...
      if (struct.isSetBuild_runtime_filters()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TRuntimeFilterDescription _iter384 : struct.build_runtime_filters)
          {
      ...
      if (struct.isSetPartition_exprs()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TExpr _iter385 : struct.partition_exprs)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.other_join_conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list390.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem391;
          for (int _i392 = 0; _i392 < _list390.size; ++_i392)
          {
            _elem391 = new io.datafibre.fibre.thrift.TExpr();
            _elem391.read(iprot);
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.build_runtime_filters = new java.util.ArrayList<io.datafibre.fibre.thrift.TRuntimeFilterDescription>(_list393.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TRuntimeFilterDescription _elem394;
          for (int _i395 = 0; _i395 < _list393.size; ++_i395)
          {
            _elem394 = new io.datafibre.fibre.thrift.TRuntimeFilterDescription();
            _elem394.read(iprot);
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.partition_exprs = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list396.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem397;
          for (int _i398 = 0; _i398 < _list396.size; ++_i398)
          {
            _elem397 = new io.datafibre.fibre.thrift.TExpr();
            _elem397.read(iprot);
