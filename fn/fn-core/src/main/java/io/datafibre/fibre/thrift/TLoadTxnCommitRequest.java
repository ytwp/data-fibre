...
public class TLoadTxnCommitRequest implements org.apache.thrift.TBase<TLoadTxnCommitRequest, TLoadTxnCommitRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TLoadTxnCommitRequest> {
  ...
  public TLoadTxnCommitRequest setCommitInfos(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TTabletCommitInfo> commitInfos) {
  ...
  public TLoadTxnCommitRequest setFailInfos(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TTabletFailInfo> failInfos) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commitInfos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletCommitInfo>(_list340.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletCommitInfo _elem341;
                for (int _i342 = 0; _i342 < _list340.size; ++_i342)
                {
                  _elem341 = new io.datafibre.fibre.thrift.TTabletCommitInfo();
                  _elem341.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.failInfos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletFailInfo>(_list343.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletFailInfo _elem344;
                for (int _i345 = 0; _i345 < _list343.size; ++_i345)
                {
                  _elem344 = new io.datafibre.fibre.thrift.TTabletFailInfo();
                  _elem344.read(iprot);
      ...
      if (struct.commitInfos != null) {
        if (struct.isSetCommitInfos()) {
          oprot.writeFieldBegin(COMMIT_INFOS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TTabletCommitInfo _iter346 : struct.commitInfos)
            {
      ...
      if (struct.failInfos != null) {
        if (struct.isSetFailInfos()) {
          oprot.writeFieldBegin(FAIL_INFOS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TTabletFailInfo _iter347 : struct.failInfos)
            {
      ...
      if (struct.isSetCommitInfos()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TTabletCommitInfo _iter348 : struct.commitInfos)
          {
      ...
      if (struct.isSetFailInfos()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TTabletFailInfo _iter349 : struct.failInfos)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.commitInfos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletCommitInfo>(_list350.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletCommitInfo _elem351;
          for (int _i352 = 0; _i352 < _list350.size; ++_i352)
          {
            _elem351 = new io.datafibre.fibre.thrift.TTabletCommitInfo();
            _elem351.read(iprot);
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.failInfos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletFailInfo>(_list353.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletFailInfo _elem354;
          for (int _i355 = 0; _i355 < _list353.size; ++_i355)
          {
            _elem354 = new io.datafibre.fibre.thrift.TTabletFailInfo();
            _elem354.read(iprot);
