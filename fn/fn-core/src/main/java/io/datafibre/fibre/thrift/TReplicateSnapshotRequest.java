...
public class TReplicateSnapshotRequest implements org.apache.thrift.TBase<TReplicateSnapshotRequest, TReplicateSnapshotRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TReplicateSnapshotRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TReplicateSnapshotRequest");
  ...
  private static final org.apache.thrift.protocol.TField SRC_SNAPSHOT_INFOS_FIELD_DESC = new org.apache.thrift.protocol.TField("src_snapshot_infos", org.apache.thrift.protocol.TType.LIST, (short)13);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TReplicateSnapshotRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TReplicateSnapshotRequestTupleSchemeFactory();
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<TRemoteSnapshotInfo> src_snapshot_infos; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SRC_SNAPSHOT_INFOS((short)13, "src_snapshot_infos");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 13: // SRC_SNAPSHOT_INFOS
          return SRC_SNAPSHOT_INFOS;
        default:
          return null;
      }
    }
  ...
  private static final _Fields optionals[] = {_Fields.TRANSACTION_ID,_Fields.TABLE_ID,_Fields.PARTITION_ID,_Fields.TABLET_ID,_Fields.TABLET_TYPE,_Fields.SCHEMA_HASH,_Fields.VISIBLE_VERSION,_Fields.SRC_TOKEN,_Fields.SRC_TABLET_ID,_Fields.SRC_TABLET_TYPE,_Fields.SRC_SCHEMA_HASH,_Fields.SRC_VISIBLE_VERSION,_Fields.SRC_SNAPSHOT_INFOS};
  ...
  static {
    ...
    tmpMap.put(_Fields.SRC_VISIBLE_VERSION, new org.apache.thrift.meta_data.FieldMetaData("src_visible_version", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64        , "TVersion")));
    tmpMap.put(_Fields.SRC_SNAPSHOT_INFOS, new org.apache.thrift.meta_data.FieldMetaData("src_snapshot_infos", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TRemoteSnapshotInfo.class))));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TReplicateSnapshotRequest.class, metaDataMap);
  }

  public TReplicateSnapshotRequest() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public TReplicateSnapshotRequest(TReplicateSnapshotRequest other) {
    ...
    if (other.isSetSrc_snapshot_infos()) {
      java.util.List<TRemoteSnapshotInfo> __this__src_snapshot_infos = new java.util.ArrayList<TRemoteSnapshotInfo>(other.src_snapshot_infos.size());
      for (TRemoteSnapshotInfo other_element : other.src_snapshot_infos) {
        __this__src_snapshot_infos.add(new TRemoteSnapshotInfo(other_element));
      }
      this.src_snapshot_infos = __this__src_snapshot_infos;
    }
  }

  @Override
  public TReplicateSnapshotRequest deepCopy() {
    return new TReplicateSnapshotRequest(this);
  }
  ...
  public TReplicateSnapshotRequest setTransaction_id(long transaction_id) {
  ...
  public TReplicateSnapshotRequest setTable_id(long table_id) {
  ...
  public TReplicateSnapshotRequest setPartition_id(long partition_id) {
  ...
  public TReplicateSnapshotRequest setTablet_id(long tablet_id) {
   ...
   * @see TTabletType
   */
  public TReplicateSnapshotRequest setTablet_type(@org.apache.thrift.annotation.Nullable TTabletType tablet_type) {
  ...
  public TReplicateSnapshotRequest setSchema_hash(int schema_hash) {
  ...
  public TReplicateSnapshotRequest setVisible_version(long visible_version) {
  ...
  public TReplicateSnapshotRequest setSrc_token(@org.apache.thrift.annotation.Nullable java.lang.String src_token) {
  ...
  public TReplicateSnapshotRequest setSrc_tablet_id(long src_tablet_id) {
   ...
   * @see TTabletType
   */
  public TReplicateSnapshotRequest setSrc_tablet_type(@org.apache.thrift.annotation.Nullable TTabletType src_tablet_type) {
  ...
  public TReplicateSnapshotRequest setSrc_schema_hash(int src_schema_hash) {
  ...
  public TReplicateSnapshotRequest setSrc_visible_version(long src_visible_version) {
  ...
  public int getSrc_snapshot_infosSize() {
    return (this.src_snapshot_infos == null) ? 0 : this.src_snapshot_infos.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<TRemoteSnapshotInfo> getSrc_snapshot_infosIterator() {
    return (this.src_snapshot_infos == null) ? null : this.src_snapshot_infos.iterator();
  }

  public void addToSrc_snapshot_infos(TRemoteSnapshotInfo elem) {
    if (this.src_snapshot_infos == null) {
      this.src_snapshot_infos = new java.util.ArrayList<TRemoteSnapshotInfo>();
    }
    this.src_snapshot_infos.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<TRemoteSnapshotInfo> getSrc_snapshot_infos() {
    return this.src_snapshot_infos;
  }

  public TReplicateSnapshotRequest setSrc_snapshot_infos(@org.apache.thrift.annotation.Nullable java.util.List<TRemoteSnapshotInfo> src_snapshot_infos) {
    this.src_snapshot_infos = src_snapshot_infos;
    return this;
  }

  public void unsetSrc_snapshot_infos() {
    this.src_snapshot_infos = null;
  }

  /** Returns true if field src_snapshot_infos is set (has been assigned a value) and false otherwise */
  public boolean isSetSrc_snapshot_infos() {
    return this.src_snapshot_infos != null;
  }

  public void setSrc_snapshot_infosIsSet(boolean value) {
    if (!value) {
      this.src_snapshot_infos = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case SRC_SNAPSHOT_INFOS:
      if (value == null) {
        unsetSrc_snapshot_infos();
      } else {
        setSrc_snapshot_infos((java.util.List<TRemoteSnapshotInfo>)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case SRC_SNAPSHOT_INFOS:
      return isSetSrc_snapshot_infos();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof TReplicateSnapshotRequest)
      return this.equals((TReplicateSnapshotRequest)that);
    return false;
  }

  public boolean equals(TReplicateSnapshotRequest that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present_src_snapshot_infos = true && this.isSetSrc_snapshot_infos();
    boolean that_present_src_snapshot_infos = true && that.isSetSrc_snapshot_infos();
    if (this_present_src_snapshot_infos || that_present_src_snapshot_infos) {
      if (!(this_present_src_snapshot_infos && that_present_src_snapshot_infos))
        return false;
      if (!this.src_snapshot_infos.equals(that.src_snapshot_infos))
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSrc_snapshot_infos()) ? 131071 : 524287);
    if (isSetSrc_snapshot_infos())
      hashCode = hashCode * 8191 + src_snapshot_infos.hashCode();

    return hashCode;
  }

  @Override
  public int compareTo(TReplicateSnapshotRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSrc_snapshot_infos(), other.isSetSrc_snapshot_infos());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSrc_snapshot_infos()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.src_snapshot_infos, other.src_snapshot_infos);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TReplicateSnapshotRequest(");
    boolean first = true;
    ...
    if (isSetSrc_snapshot_infos()) {
      if (!first) sb.append(", ");
      sb.append("src_snapshot_infos:");
      if (this.src_snapshot_infos == null) {
        sb.append("null");
      } else {
        sb.append(this.src_snapshot_infos);
      }
      first = false;
    }
    sb.append(")");
  ...
  private static class TReplicateSnapshotRequestStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public TReplicateSnapshotRequestStandardScheme getScheme() {
      return new TReplicateSnapshotRequestStandardScheme();
    }
  }

  private static class TReplicateSnapshotRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<TReplicateSnapshotRequest> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, TReplicateSnapshotRequest struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 10: // SRC_TABLET_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.src_tablet_type = io.datafibre.fibre.thrift.TTabletType.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.src_snapshot_infos = new java.util.ArrayList<TRemoteSnapshotInfo>(_list196.size);
                @org.apache.thrift.annotation.Nullable TRemoteSnapshotInfo _elem197;
                for (int _i198 = 0; _i198 < _list196.size; ++_i198)
                {
                  _elem197 = new TRemoteSnapshotInfo();
                  _elem197.read(iprot);
                  struct.src_snapshot_infos.add(_elem197);
                }
                iprot.readListEnd();
              }
              struct.setSrc_snapshot_infosIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, TReplicateSnapshotRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.src_snapshot_infos != null) {
        if (struct.isSetSrc_snapshot_infos()) {
          oprot.writeFieldBegin(SRC_SNAPSHOT_INFOS_FIELD_DESC);
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.src_snapshot_infos.size()));
            for (TRemoteSnapshotInfo _iter199 : struct.src_snapshot_infos)
            {
  ...
  private static class TReplicateSnapshotRequestTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public TReplicateSnapshotRequestTupleScheme getScheme() {
      return new TReplicateSnapshotRequestTupleScheme();
    }
  }

  private static class TReplicateSnapshotRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TReplicateSnapshotRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TReplicateSnapshotRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetSrc_snapshot_infos()) {
        {
          oprot.writeI32(struct.src_snapshot_infos.size());
          for (TRemoteSnapshotInfo _iter200 : struct.src_snapshot_infos)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TReplicateSnapshotRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.src_snapshot_infos = new java.util.ArrayList<TRemoteSnapshotInfo>(_list201.size);
          @org.apache.thrift.annotation.Nullable TRemoteSnapshotInfo _elem202;
          for (int _i203 = 0; _i203 < _list201.size; ++_i203)
          {
            _elem202 = new TRemoteSnapshotInfo();
            _elem202.read(iprot);
            struct.src_snapshot_infos.add(_elem202);
          }
        }
        struct.setSrc_snapshot_infosIsSet(true);
      }
