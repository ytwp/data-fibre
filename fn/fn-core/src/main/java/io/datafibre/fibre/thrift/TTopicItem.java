...
public class TTopicItem implements org.apache.thrift.TBase<TTopicItem, TTopicItem._Fields>, java.io.Serializable, Cloneable, Comparable<TTopicItem> {
  ...
  public TTopicItem setString_value(@org.apache.thrift.annotation.Nullable java.lang.String string_value) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case INT_VALUE:
      if (value == null) {
        ...
        setInt_value((java.lang.Long)value);
      }
      break;
    ...
    case DOUBLE_VALUE:
      if (value == null) {
        ...
        setDouble_value((java.lang.Double)value);
      }
      break;
    ...
    case STRING_VALUE:
      if (value == null) {
        ...
        setString_value((java.lang.String)value);
      }
      break;
  ...
  public int compareTo(TTopicItem other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetInt_value(), other.isSetInt_value());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInt_value()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetDouble_value(), other.isSetDouble_value());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDouble_value()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetString_value(), other.isSetString_value());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetString_value()) {
