...
public class TEqJoinCondition implements org.apache.thrift.TBase<TEqJoinCondition, TEqJoinCondition._Fields>, java.io.Serializable, Cloneable, Comparable<TEqJoinCondition> {
  ...
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr left; // required
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr right; // required
  /**
   * 
  ...
  public TEqJoinCondition(
    io.datafibre.fibre.thrift.TExpr left,
    io.datafibre.fibre.thrift.TExpr right)
  {
    this();
    this.left = left;
    this.right = right;
  ...
  public TEqJoinCondition(TEqJoinCondition other) {
    if (other.isSetLeft()) {
      this.left = new io.datafibre.fibre.thrift.TExpr(other.left);
    }
    if (other.isSetRight()) {
      this.right = new io.datafibre.fibre.thrift.TExpr(other.right);
    }
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TExpr getLeft() {
    return this.left;
  }

  public TEqJoinCondition setLeft(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr left) {
    this.left = left;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TExpr getRight() {
    return this.right;
  }

  public TEqJoinCondition setRight(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr right) {
    this.right = right;
    return this;
  }
   ...
   * @see io.datafibre.fibre.thrift.TExprOpcode
   */
  public TEqJoinCondition setOpcode(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExprOpcode opcode) {
    this.opcode = opcode;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case LEFT:
      if (value == null) {
        ...
        setLeft((io.datafibre.fibre.thrift.TExpr)value);
      }
      break;
    ...
    case RIGHT:
      if (value == null) {
        ...
        setRight((io.datafibre.fibre.thrift.TExpr)value);
      }
      break;
        ...
        switch (schemeField.id) {
          case 1: // LEFT
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.left = new io.datafibre.fibre.thrift.TExpr();
          ...
          case 2: // RIGHT
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.right = new io.datafibre.fibre.thrift.TExpr();
