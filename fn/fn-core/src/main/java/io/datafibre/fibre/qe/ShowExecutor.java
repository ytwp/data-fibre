...
import io.datafibre.fibre.catalog.MetadataViewer;
...
import io.datafibre.fibre.common.proc.BackendsProcDir;
...
import io.datafibre.fibre.common.proc.OptimizeProcDir;
import io.datafibre.fibre.common.proc.PartitionsProcDir;
...
import io.datafibre.fibre.load.routineload.RoutineLoadFunctionalExprProvider;
import io.datafibre.fibre.load.routineload.RoutineLoadJob;
import io.datafibre.fibre.load.streamload.StreamLoadFunctionalExprProvider;
import io.datafibre.fibre.load.streamload.StreamLoadTask;
import io.datafibre.fibre.meta.BlackListSql;
...
import io.datafibre.fibre.proto.PFailPointInfo;
...
import io.datafibre.fibre.rpc.PListFailPointRequest;
...
import io.datafibre.fibre.service.InformationSchemaDataSource;
...
import io.datafibre.fibre.thrift.TTableInfo;
        ...
        for (Map.Entry<ObjectType, List<PrivilegeEntry>> typeToPrivilegeEntry
            ...
            for (PrivilegeEntry privilegeEntry : typeToPrivilegeEntry.getValue()) {
                ...
                try {
                    ...
                    infos.add(info);
                } catch (io.datafibre.fibre.sql.common.MetaNotFoundException e) {
