...
public class TColumn implements org.apache.thrift.TBase<TColumn, TColumn._Fields>, java.io.Serializable, Cloneable, Comparable<TColumn> {
  ...
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TColumnType column_type; // optional
  /**
   * 
   * @see io.datafibre.fibre.thrift.TAggregationType
   */
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TAggregationType aggregation_type; // optional
  ...
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr define_expr; // optional
  ...
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTypeDesc type_desc; // optional
  ...
  public TColumn(TColumn other) {
    ...
    if (other.isSetColumn_type()) {
      this.column_type = new io.datafibre.fibre.thrift.TColumnType(other.column_type);
    }
    ...
    if (other.isSetDefine_expr()) {
      this.define_expr = new io.datafibre.fibre.thrift.TExpr(other.define_expr);
    }
    ...
    if (other.isSetType_desc()) {
      this.type_desc = new io.datafibre.fibre.thrift.TTypeDesc(other.type_desc);
    }
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TColumnType getColumn_type() {
    return this.column_type;
  }

  public TColumn setColumn_type(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TColumnType column_type) {
   ...
   */
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TAggregationType getAggregation_type() {
   ...
   * @see io.datafibre.fibre.thrift.TAggregationType
   */
  public TColumn setAggregation_type(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TAggregationType aggregation_type) {
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TExpr getDefine_expr() {
    return this.define_expr;
  }

  public TColumn setDefine_expr(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr define_expr) {
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TTypeDesc getType_desc() {
    return this.type_desc;
  }

  public TColumn setType_desc(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTypeDesc type_desc) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case COLUMN_TYPE:
      if (value == null) {
        ...
        setColumn_type((io.datafibre.fibre.thrift.TColumnType)value);
      }
      break;
    ...
    case AGGREGATION_TYPE:
      if (value == null) {
        ...
        setAggregation_type((io.datafibre.fibre.thrift.TAggregationType)value);
      }
      break;
    ...
    case DEFINE_EXPR:
      if (value == null) {
        ...
        setDefine_expr((io.datafibre.fibre.thrift.TExpr)value);
      }
      break;
    ...
    case TYPE_DESC:
      if (value == null) {
        ...
        setType_desc((io.datafibre.fibre.thrift.TTypeDesc)value);
      }
      break;
        ...
        switch (schemeField.id) {
          ...
          case 2: // COLUMN_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.column_type = new io.datafibre.fibre.thrift.TColumnType();
          ...
          case 3: // AGGREGATION_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.aggregation_type = io.datafibre.fibre.thrift.TAggregationType.findByValue(iprot.readI32());
          ...
          case 8: // DEFINE_EXPR
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.define_expr = new io.datafibre.fibre.thrift.TExpr();
          ...
          case 21: // TYPE_DESC
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.type_desc = new io.datafibre.fibre.thrift.TTypeDesc();
