...
public class TDataPartition implements org.apache.thrift.TBase<TDataPartition, TDataPartition._Fields>, java.io.Serializable, Cloneable, Comparable<TDataPartition> {
  ...
  public TDataPartition setPartition_exprs(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> partition_exprs) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list8.size);
      ...
      if (struct.partition_exprs != null) {
        if (struct.isSetPartition_exprs()) {
          oprot.writeFieldBegin(PARTITION_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter14 : struct.partition_exprs)
            {
              _iter14.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetPartition_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter16 : struct.partition_exprs)
          {
            _iter16.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list18.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem19;
          for (int _i20 = 0; _i20 < _list18.size; ++_i20)
          {
            _elem19 = new com.starrocks.thrift.TExpr();
            _elem19.read(iprot);
