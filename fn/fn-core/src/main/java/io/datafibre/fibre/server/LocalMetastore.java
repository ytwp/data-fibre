...
import io.datafibre.fibre.alter.AlterJobExecutor;
import io.datafibre.fibre.alter.AlterMVJobExecutor;
...
import io.datafibre.fibre.catalog.MvJoinFilter;
...
import io.datafibre.fibre.common.InvalidOlapTableStateException;
...
import io.datafibre.fibre.common.TimeoutException;
...
import io.datafibre.fibre.common.util.concurrent.CountingLatch;
...
import io.datafibre.fibre.persist.PhysicalPartitionPersistInfoV2;
...
import io.datafibre.fibre.sql.ast.PartitionConvertContext;
...
import static io.datafibre.fibre.server.GlobalStateMgr.NEXT_ID_INIT_VALUE;
import static io.datafibre.fibre.server.GlobalStateMgr.isCheckpointThread;
        ...
        if (expressionPartitionDesc != null) {
            ...
            if ((expr instanceof FunctionCallExpr)) {
                ...
                if (functionCallExpr.getFnName().getFunction().equalsIgnoreCase(FunctionSet.STR2DATE)) {
                    ...
                    partitionColumn.setType(io.datafibre.fibre.catalog.Type.DATE);
