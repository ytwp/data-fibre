...
public class TTabletLocation implements org.apache.thrift.TBase<TTabletLocation, TTabletLocation._Fields>, java.io.Serializable, Cloneable, Comparable<TTabletLocation> {
  ...
  public TTabletLocation setTablet_id(long tablet_id) {
    this.tablet_id = tablet_id;
    setTablet_idIsSet(true);
    return this;
  }
  ...
  public int getNode_idsSize() {
    return (this.node_ids == null) ? 0 : this.node_ids.size();
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.lang.Long> getNode_idsIterator() {
    return (this.node_ids == null) ? null : this.node_ids.iterator();
  }

  public void addToNode_ids(long elem) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.lang.Long> getNode_ids() {
    return this.node_ids;
  }

  public TTabletLocation setNode_ids(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> node_ids) {
    this.node_ids = node_ids;
    return this;
  }

  public void unsetNode_ids() {
    this.node_ids = null;
  }

  /** Returns true if field node_ids is set (has been assigned a value) and false otherwise */
  public boolean isSetNode_ids() {
    return this.node_ids != null;
  }

  public void setNode_idsIsSet(boolean value) {
    if (!value) {
      this.node_ids = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case NODE_IDS:
      if (value == null) {
        ...
        setNode_ids((java.util.List<java.lang.Long>)value);
      }
      break;
  ...
  public boolean equals(TTabletLocation that) {
    ...
    boolean this_present_node_ids = true && this.isSetNode_ids();
    boolean that_present_node_ids = true && that.isSetNode_ids();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetNode_ids()) ? 131071 : 524287);
    if (isSetNode_ids())
  ...
  public int compareTo(TTabletLocation other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetNode_ids(), other.isSetNode_ids());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetNode_ids()) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.node_ids = new java.util.ArrayList<java.lang.Long>(_list168.size);
                long _elem169;
                for (int _i170 = 0; _i170 < _list168.size; ++_i170)
                {
                  _elem169 = iprot.readI64();
                  struct.node_ids.add(_elem169);
                }
                iprot.readListEnd();
              }
              struct.setNode_idsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TTabletLocation struct) throws org.apache.thrift.TException {
      ...
      if (struct.node_ids != null) {
        oprot.writeFieldBegin(NODE_IDS_FIELD_DESC);
        {
          ...
          for (long _iter171 : struct.node_ids)
          {
  ...
  private static class TTabletLocationTupleScheme extends org.apache.thrift.scheme.TupleScheme<TTabletLocation> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TTabletLocation struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.tablet_id);
      {
        ...
        for (long _iter172 : struct.node_ids)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TTabletLocation struct) throws org.apache.thrift.TException {
      ...
      struct.setTablet_idIsSet(true);
      {
        org.apache.thrift.protocol.TList _list173 = iprot.readListBegin(org.apache.thrift.protocol.TType.I64);
        struct.node_ids = new java.util.ArrayList<java.lang.Long>(_list173.size);
        long _elem174;
        for (int _i175 = 0; _i175 < _list173.size; ++_i175)
        {
          _elem174 = iprot.readI64();
          struct.node_ids.add(_elem174);
        }
      }
      struct.setNode_idsIsSet(true);
    }
