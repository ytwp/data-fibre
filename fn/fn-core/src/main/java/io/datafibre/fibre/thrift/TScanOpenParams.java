...
public class TScanOpenParams implements org.apache.thrift.TBase<TScanOpenParams, TScanOpenParams._Fields>, java.io.Serializable, Cloneable, Comparable<TScanOpenParams> {
  ...
  public TScanOpenParams setTablet_ids(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Long> tablet_ids) {
    this.tablet_ids = tablet_ids;
    return this;
  }
  ...
  public int compareTo(TScanOpenParams other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetOpaqued_query_plan(), other.isSetOpaqued_query_plan());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetOpaqued_query_plan()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetKeep_alive_min(), other.isSetKeep_alive_min());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetKeep_alive_min()) {
