...
public class TDecodeNode implements org.apache.thrift.TBase<TDecodeNode, TDecodeNode._Fields>, java.io.Serializable, Cloneable, Comparable<TDecodeNode> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,io.datafibre.fibre.thrift.TExpr> string_functions; // optional
  ...
  public TDecodeNode(TDecodeNode other) {
    ...
    if (other.isSetString_functions()) {
      java.util.Map<java.lang.Integer,io.datafibre.fibre.thrift.TExpr> __this__string_functions = new java.util.HashMap<java.lang.Integer,io.datafibre.fibre.thrift.TExpr>(other.string_functions.size());
      for (java.util.Map.Entry<java.lang.Integer, io.datafibre.fibre.thrift.TExpr> other_element : other.string_functions.entrySet()) {
        ...
        io.datafibre.fibre.thrift.TExpr __this__string_functions_copy_value = new io.datafibre.fibre.thrift.TExpr(other_element_value);
  ...
  public void putToString_functions(int key, io.datafibre.fibre.thrift.TExpr val) {
    if (this.string_functions == null) {
      this.string_functions = new java.util.HashMap<java.lang.Integer,io.datafibre.fibre.thrift.TExpr>();
    }
    this.string_functions.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.Integer,io.datafibre.fibre.thrift.TExpr> getString_functions() {
    return this.string_functions;
  }

  public TDecodeNode setString_functions(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,io.datafibre.fibre.thrift.TExpr> string_functions) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case STRING_FUNCTIONS:
      if (value == null) {
        ...
        setString_functions((java.util.Map<java.lang.Integer,io.datafibre.fibre.thrift.TExpr>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.string_functions = new java.util.HashMap<java.lang.Integer,io.datafibre.fibre.thrift.TExpr>(2*_map898.size);
                int _key899;
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _val900;
                for (int _i901 = 0; _i901 < _map898.size; ++_i901)
                {
                  _key899 = iprot.readI32();
                  _val900 = new io.datafibre.fibre.thrift.TExpr();
                  _val900.read(iprot);
      ...
      if (struct.string_functions != null) {
        if (struct.isSetString_functions()) {
          oprot.writeFieldBegin(STRING_FUNCTIONS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, io.datafibre.fibre.thrift.TExpr> _iter903 : struct.string_functions.entrySet())
            {
      ...
      if (struct.isSetString_functions()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, io.datafibre.fibre.thrift.TExpr> _iter905 : struct.string_functions.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.string_functions = new java.util.HashMap<java.lang.Integer,io.datafibre.fibre.thrift.TExpr>(2*_map910.size);
          int _key911;
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _val912;
          for (int _i913 = 0; _i913 < _map910.size; ++_i913)
          {
            _key911 = iprot.readI32();
            _val912 = new io.datafibre.fibre.thrift.TExpr();
            _val912.read(iprot);
