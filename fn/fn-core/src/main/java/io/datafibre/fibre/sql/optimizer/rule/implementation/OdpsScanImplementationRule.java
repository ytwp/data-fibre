...
public class OdpsScanImplementationRule extends ImplementationRule {
    public OdpsScanImplementationRule() {
        super(RuleType.IMP_ODPS_LSCAN_TO_PSCAN,
                Pattern.create(OperatorType.LOGICAL_ODPS_SCAN));
    }
