...
public class TNormalOlapScanNode implements org.apache.thrift.TBase<TNormalOlapScanNode, TNormalOlapScanNode._Fields>, java.io.Serializable, Cloneable, Comparable<TNormalOlapScanNode> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TPrimitiveType> key_column_types; // optional
  ...
  public TNormalOlapScanNode(TNormalOlapScanNode other) {
    ...
    if (other.isSetKey_column_types()) {
      java.util.List<com.starrocks.thrift.TPrimitiveType> __this__key_column_types = new java.util.ArrayList<com.starrocks.thrift.TPrimitiveType>(other.key_column_types.size());
      for (com.starrocks.thrift.TPrimitiveType other_element : other.key_column_types) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<com.starrocks.thrift.TPrimitiveType> getKey_column_typesIterator() {
    return (this.key_column_types == null) ? null : this.key_column_types.iterator();
  }

  public void addToKey_column_types(com.starrocks.thrift.TPrimitiveType elem) {
    if (this.key_column_types == null) {
      this.key_column_types = new java.util.ArrayList<com.starrocks.thrift.TPrimitiveType>();
    }
    this.key_column_types.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<com.starrocks.thrift.TPrimitiveType> getKey_column_types() {
    return this.key_column_types;
  }

  public TNormalOlapScanNode setKey_column_types(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TPrimitiveType> key_column_types) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case KEY_COLUMN_TYPES:
      if (value == null) {
        ...
        setKey_column_types((java.util.List<com.starrocks.thrift.TPrimitiveType>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.key_column_types = new java.util.ArrayList<com.starrocks.thrift.TPrimitiveType>(_list9.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TPrimitiveType _elem10;
                for (int _i11 = 0; _i11 < _list9.size; ++_i11)
                {
                  _elem10 = com.starrocks.thrift.TPrimitiveType.findByValue(iprot.readI32());
                  if (_elem10 != null)
                  {
      ...
      if (struct.key_column_types != null) {
        if (struct.isSetKey_column_types()) {
          oprot.writeFieldBegin(KEY_COLUMN_TYPES_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TPrimitiveType _iter30 : struct.key_column_types)
            {
      ...
      if (struct.isSetKey_column_types()) {
        {
          ...
          for (com.starrocks.thrift.TPrimitiveType _iter39 : struct.key_column_types)
          {
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.key_column_types = new java.util.ArrayList<com.starrocks.thrift.TPrimitiveType>(_list54.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TPrimitiveType _elem55;
          for (int _i56 = 0; _i56 < _list54.size; ++_i56)
          {
            _elem55 = com.starrocks.thrift.TPrimitiveType.findByValue(iprot.readI32());
            if (_elem55 != null)
            {
