...
public class TMVCommitEpochTask implements org.apache.thrift.TBase<TMVCommitEpochTask, TMVCommitEpochTask._Fields>, java.io.Serializable, Cloneable, Comparable<TMVCommitEpochTask> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TPartitionVersionInfo> partition_version_infos; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.PARTITION_VERSION_INFOS, new org.apache.thrift.meta_data.FieldMetaData("partition_version_infos", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.starrocks.thrift.TPartitionVersionInfo.class))));
  ...
  public TMVCommitEpochTask(TMVCommitEpochTask other) {
    ...
    if (other.isSetPartition_version_infos()) {
      java.util.List<com.starrocks.thrift.TPartitionVersionInfo> __this__partition_version_infos = new java.util.ArrayList<com.starrocks.thrift.TPartitionVersionInfo>(other.partition_version_infos.size());
      for (com.starrocks.thrift.TPartitionVersionInfo other_element : other.partition_version_infos) {
        __this__partition_version_infos.add(new com.starrocks.thrift.TPartitionVersionInfo(other_element));
      }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<com.starrocks.thrift.TPartitionVersionInfo> getPartition_version_infosIterator() {
    return (this.partition_version_infos == null) ? null : this.partition_version_infos.iterator();
  }

  public void addToPartition_version_infos(com.starrocks.thrift.TPartitionVersionInfo elem) {
    if (this.partition_version_infos == null) {
      this.partition_version_infos = new java.util.ArrayList<com.starrocks.thrift.TPartitionVersionInfo>();
    }
    this.partition_version_infos.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<com.starrocks.thrift.TPartitionVersionInfo> getPartition_version_infos() {
    return this.partition_version_infos;
  }

  public TMVCommitEpochTask setPartition_version_infos(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TPartitionVersionInfo> partition_version_infos) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case PARTITION_VERSION_INFOS:
      if (value == null) {
        ...
        setPartition_version_infos((java.util.List<com.starrocks.thrift.TPartitionVersionInfo>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_version_infos = new java.util.ArrayList<com.starrocks.thrift.TPartitionVersionInfo>(_list36.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TPartitionVersionInfo _elem37;
                for (int _i38 = 0; _i38 < _list36.size; ++_i38)
                {
                  _elem37 = new com.starrocks.thrift.TPartitionVersionInfo();
                  _elem37.read(iprot);
      ...
      if (struct.partition_version_infos != null) {
        if (struct.isSetPartition_version_infos()) {
          oprot.writeFieldBegin(PARTITION_VERSION_INFOS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TPartitionVersionInfo _iter39 : struct.partition_version_infos)
            {
              _iter39.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetPartition_version_infos()) {
        {
          ...
          for (com.starrocks.thrift.TPartitionVersionInfo _iter40 : struct.partition_version_infos)
          {
            _iter40.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.partition_version_infos = new java.util.ArrayList<com.starrocks.thrift.TPartitionVersionInfo>(_list41.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TPartitionVersionInfo _elem42;
          for (int _i43 = 0; _i43 < _list41.size; ++_i43)
          {
            _elem42 = new com.starrocks.thrift.TPartitionVersionInfo();
            _elem42.read(iprot);
