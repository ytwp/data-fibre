...
public class TCreateTabletReq implements org.apache.thrift.TBase<TCreateTabletReq, TCreateTabletReq._Fields>, java.io.Serializable, Cloneable, Comparable<TCreateTabletReq> {
  ...
  public TCreateTabletReq() {
    this.compression_type = io.datafibre.fibre.thrift.TCompressionType.LZ4_FRAME;
   ...
   * @see io.datafibre.fibre.thrift.TStorageMedium
   */
  public TCreateTabletReq setStorage_medium(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TStorageMedium storage_medium) {
   ...
   * @see io.datafibre.fibre.thrift.TCompressionType
   */
  public TCreateTabletReq setCompression_type(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TCompressionType compression_type) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TCreateTabletReq struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 13: // STORAGE_FORMAT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.storage_format = io.datafibre.fibre.thrift.TStorageFormat.findByValue(iprot.readI32());
          ...
          case 18: // PERSISTENT_INDEX_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.persistent_index_type = io.datafibre.fibre.thrift.TPersistentIndexType.findByValue(iprot.readI32());
