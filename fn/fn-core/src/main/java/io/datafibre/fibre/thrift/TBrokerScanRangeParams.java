...
public class TBrokerScanRangeParams implements org.apache.thrift.TBase<TBrokerScanRangeParams, TBrokerScanRangeParams._Fields>, java.io.Serializable, Cloneable, Comparable<TBrokerScanRangeParams> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,com.starrocks.thrift.TExpr> expr_of_dest_slot; // optional
  ...
  public TBrokerScanRangeParams(TBrokerScanRangeParams other) {
    ...
    if (other.isSetExpr_of_dest_slot()) {
      java.util.Map<java.lang.Integer,com.starrocks.thrift.TExpr> __this__expr_of_dest_slot = new java.util.HashMap<java.lang.Integer,com.starrocks.thrift.TExpr>(other.expr_of_dest_slot.size());
      for (java.util.Map.Entry<java.lang.Integer, com.starrocks.thrift.TExpr> other_element : other.expr_of_dest_slot.entrySet()) {
        ...
        com.starrocks.thrift.TExpr __this__expr_of_dest_slot_copy_value = new com.starrocks.thrift.TExpr(other_element_value);
  ...
  public void putToExpr_of_dest_slot(int key, com.starrocks.thrift.TExpr val) {
    if (this.expr_of_dest_slot == null) {
      this.expr_of_dest_slot = new java.util.HashMap<java.lang.Integer,com.starrocks.thrift.TExpr>();
    }
    this.expr_of_dest_slot.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.Integer,com.starrocks.thrift.TExpr> getExpr_of_dest_slot() {
    return this.expr_of_dest_slot;
  }

  public TBrokerScanRangeParams setExpr_of_dest_slot(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,com.starrocks.thrift.TExpr> expr_of_dest_slot) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case EXPR_OF_DEST_SLOT:
      if (value == null) {
        ...
        setExpr_of_dest_slot((java.util.Map<java.lang.Integer,com.starrocks.thrift.TExpr>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.expr_of_dest_slot = new java.util.HashMap<java.lang.Integer,com.starrocks.thrift.TExpr>(2*_map35.size);
                int _key36;
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _val37;
                for (int _i38 = 0; _i38 < _map35.size; ++_i38)
                {
                  _key36 = iprot.readI32();
                  _val37 = new com.starrocks.thrift.TExpr();
                  _val37.read(iprot);
      ...
      if (struct.expr_of_dest_slot != null) {
        if (struct.isSetExpr_of_dest_slot()) {
          oprot.writeFieldBegin(EXPR_OF_DEST_SLOT_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, com.starrocks.thrift.TExpr> _iter51 : struct.expr_of_dest_slot.entrySet())
            {
      ...
      if (struct.isSetExpr_of_dest_slot()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, com.starrocks.thrift.TExpr> _iter56 : struct.expr_of_dest_slot.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.expr_of_dest_slot = new java.util.HashMap<java.lang.Integer,com.starrocks.thrift.TExpr>(2*_map63.size);
          int _key64;
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _val65;
          for (int _i66 = 0; _i66 < _map63.size; ++_i66)
          {
            _key64 = iprot.readI32();
            _val65 = new com.starrocks.thrift.TExpr();
            _val65.read(iprot);
