...
public class TRangePartition implements org.apache.thrift.TBase<TRangePartition, TRangePartition._Fields>, java.io.Serializable, Cloneable, Comparable<TRangePartition> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> distributed_exprs; // optional
  ...
  public TRangePartition(TRangePartition other) {
    ...
    if (other.isSetDistributed_exprs()) {
      java.util.List<com.starrocks.thrift.TExpr> __this__distributed_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(other.distributed_exprs.size());
      for (com.starrocks.thrift.TExpr other_element : other.distributed_exprs) {
        __this__distributed_exprs.add(new com.starrocks.thrift.TExpr(other_element));
      }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<com.starrocks.thrift.TExpr> getDistributed_exprsIterator() {
    return (this.distributed_exprs == null) ? null : this.distributed_exprs.iterator();
  }

  public void addToDistributed_exprs(com.starrocks.thrift.TExpr elem) {
    if (this.distributed_exprs == null) {
      this.distributed_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>();
    }
    this.distributed_exprs.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<com.starrocks.thrift.TExpr> getDistributed_exprs() {
    return this.distributed_exprs;
  }

  public TRangePartition setDistributed_exprs(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> distributed_exprs) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case DISTRIBUTED_EXPRS:
      if (value == null) {
        ...
        setDistributed_exprs((java.util.List<com.starrocks.thrift.TExpr>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.distributed_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list0.size);
      ...
      if (struct.distributed_exprs != null) {
        if (struct.isSetDistributed_exprs()) {
          oprot.writeFieldBegin(DISTRIBUTED_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter3 : struct.distributed_exprs)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetDistributed_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter4 : struct.distributed_exprs)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.distributed_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list5.size);
