...
import io.datafibre.fibre.sql.optimizer.operator.scalar.ScalarOperatorUtil;
...
public class LogicalAggregationOperator extends LogicalOperator {
    ...
    public static class Builder
            extends LogicalOperator.Builder<LogicalAggregationOperator, Builder> {
        ...
        @Override
        public Builder withOperator(LogicalAggregationOperator aggregationOperator) {
