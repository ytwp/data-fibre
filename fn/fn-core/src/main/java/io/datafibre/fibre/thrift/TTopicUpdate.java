...
public class TTopicUpdate implements org.apache.thrift.TBase<TTopicUpdate, TTopicUpdate._Fields>, java.io.Serializable, Cloneable, Comparable<TTopicUpdate> {
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = io.datafibre.fibre.thrift.TTopicType.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.updates = new java.util.ArrayList<TTopicItem>(_list212.size);
                @org.apache.thrift.annotation.Nullable TTopicItem _elem213;
                for (int _i214 = 0; _i214 < _list212.size; ++_i214)
                {
                  _elem213 = new TTopicItem();
                  _elem213.read(iprot);
                  struct.updates.add(_elem213);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.deletes = new java.util.ArrayList<java.lang.String>(_list215.size);
      ...
      if (struct.updates != null) {
        if (struct.isSetUpdates()) {
          oprot.writeFieldBegin(UPDATES_FIELD_DESC);
          {
            ...
            for (TTopicItem _iter218 : struct.updates)
            {
      ...
      if (struct.deletes != null) {
        if (struct.isSetDeletes()) {
          oprot.writeFieldBegin(DELETES_FIELD_DESC);
          {
            ...
            for (java.lang.String _iter219 : struct.deletes)
            {
  ...
  private static class TTopicUpdateTupleScheme extends org.apache.thrift.scheme.TupleScheme<TTopicUpdate> {
      ...
      if (struct.isSetUpdates()) {
        {
          ...
          for (TTopicItem _iter220 : struct.updates)
          {
      ...
      if (struct.isSetDeletes()) {
        {
          ...
          for (java.lang.String _iter221 : struct.deletes)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TTopicUpdate struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list222 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.updates = new java.util.ArrayList<TTopicItem>(_list222.size);
          @org.apache.thrift.annotation.Nullable TTopicItem _elem223;
          for (int _i224 = 0; _i224 < _list222.size; ++_i224)
          {
            _elem223 = new TTopicItem();
            _elem223.read(iprot);
            struct.updates.add(_elem223);
          }
        }
        struct.setUpdatesIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list225 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRING);
          struct.deletes = new java.util.ArrayList<java.lang.String>(_list225.size);
          @org.apache.thrift.annotation.Nullable java.lang.String _elem226;
          for (int _i227 = 0; _i227 < _list225.size; ++_i227)
          {
            _elem226 = iprot.readString();
            struct.deletes.add(_elem226);
          }
        }
        struct.setDeletesIsSet(true);
      }
