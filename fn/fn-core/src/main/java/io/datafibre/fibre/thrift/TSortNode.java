...
public class TSortNode implements org.apache.thrift.TBase<TSortNode, TSortNode._Fields>, java.io.Serializable, Cloneable, Comparable<TSortNode> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> ordering_exprs; // optional
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> analytic_partition_exprs; // optional
  ...
  public TSortNode(TSortNode other) {
    ...
    if (other.isSetAnalytic_partition_exprs()) {
      java.util.List<com.starrocks.thrift.TExpr> __this__analytic_partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(other.analytic_partition_exprs.size());
      for (com.starrocks.thrift.TExpr other_element : other.analytic_partition_exprs) {
        __this__analytic_partition_exprs.add(new com.starrocks.thrift.TExpr(other_element));
      }
  ...
  public TSortNode setOrdering_exprs(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> ordering_exprs) {
  ...
  public TSortNode setSort_tuple_slot_exprs(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> sort_tuple_slot_exprs) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<com.starrocks.thrift.TExpr> getAnalytic_partition_exprsIterator() {
    return (this.analytic_partition_exprs == null) ? null : this.analytic_partition_exprs.iterator();
  }

  public void addToAnalytic_partition_exprs(com.starrocks.thrift.TExpr elem) {
    if (this.analytic_partition_exprs == null) {
      this.analytic_partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>();
    }
    this.analytic_partition_exprs.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<com.starrocks.thrift.TExpr> getAnalytic_partition_exprs() {
    return this.analytic_partition_exprs;
  }

  public TSortNode setAnalytic_partition_exprs(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> analytic_partition_exprs) {
  ...
  public TSortNode setPartition_exprs(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> partition_exprs) {
  ...
  public TSortNode setBuild_runtime_filters(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TRuntimeFilterDescription> build_runtime_filters) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case ANALYTIC_PARTITION_EXPRS:
      if (value == null) {
        ...
        setAnalytic_partition_exprs((java.util.List<com.starrocks.thrift.TExpr>)value);
      }
      break;
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.ordering_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list562.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem563;
                for (int _i564 = 0; _i564 < _list562.size; ++_i564)
                {
                  _elem563 = new com.starrocks.thrift.TExpr();
                  _elem563.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sort_tuple_slot_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list571.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem572;
                for (int _i573 = 0; _i573 < _list571.size; ++_i573)
                {
                  _elem572 = new com.starrocks.thrift.TExpr();
                  _elem572.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.analytic_partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list574.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem575;
                for (int _i576 = 0; _i576 < _list574.size; ++_i576)
                {
                  _elem575 = new com.starrocks.thrift.TExpr();
                  _elem575.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list577.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem578;
                for (int _i579 = 0; _i579 < _list577.size; ++_i579)
                {
                  _elem578 = new com.starrocks.thrift.TExpr();
                  _elem578.read(iprot);
          ...
          case 25: // TOPN_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.topn_type = com.starrocks.thrift.TTopNType.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.build_runtime_filters = new java.util.ArrayList<com.starrocks.thrift.TRuntimeFilterDescription>(_list580.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TRuntimeFilterDescription _elem581;
                for (int _i582 = 0; _i582 < _list580.size; ++_i582)
                {
                  _elem581 = new com.starrocks.thrift.TRuntimeFilterDescription();
                  _elem581.read(iprot);
      ...
      if (struct.ordering_exprs != null) {
        if (struct.isSetOrdering_exprs()) {
          oprot.writeFieldBegin(ORDERING_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter583 : struct.ordering_exprs)
            {
      ...
      if (struct.sort_tuple_slot_exprs != null) {
        if (struct.isSetSort_tuple_slot_exprs()) {
          oprot.writeFieldBegin(SORT_TUPLE_SLOT_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter586 : struct.sort_tuple_slot_exprs)
            {
      ...
      if (struct.analytic_partition_exprs != null) {
        if (struct.isSetAnalytic_partition_exprs()) {
          oprot.writeFieldBegin(ANALYTIC_PARTITION_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter587 : struct.analytic_partition_exprs)
            {
      ...
      if (struct.partition_exprs != null) {
        if (struct.isSetPartition_exprs()) {
          oprot.writeFieldBegin(PARTITION_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter588 : struct.partition_exprs)
            {
      ...
      if (struct.build_runtime_filters != null) {
        if (struct.isSetBuild_runtime_filters()) {
          oprot.writeFieldBegin(BUILD_RUNTIME_FILTERS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TRuntimeFilterDescription _iter589 : struct.build_runtime_filters)
            {
      ...
      if (struct.isSetOrdering_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter590 : struct.ordering_exprs)
          {
      ...
      if (struct.isSetSort_tuple_slot_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter593 : struct.sort_tuple_slot_exprs)
          {
      ...
      if (struct.isSetAnalytic_partition_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter594 : struct.analytic_partition_exprs)
          {
      ...
      if (struct.isSetPartition_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter595 : struct.partition_exprs)
          {
      ...
      if (struct.isSetBuild_runtime_filters()) {
        {
          ...
          for (com.starrocks.thrift.TRuntimeFilterDescription _iter596 : struct.build_runtime_filters)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.ordering_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list597.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem598;
          for (int _i599 = 0; _i599 < _list597.size; ++_i599)
          {
            _elem598 = new com.starrocks.thrift.TExpr();
            _elem598.read(iprot);
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.sort_tuple_slot_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list606.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem607;
          for (int _i608 = 0; _i608 < _list606.size; ++_i608)
          {
            _elem607 = new com.starrocks.thrift.TExpr();
            _elem607.read(iprot);
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.analytic_partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list609.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem610;
          for (int _i611 = 0; _i611 < _list609.size; ++_i611)
          {
            _elem610 = new com.starrocks.thrift.TExpr();
            _elem610.read(iprot);
      ...
      if (incoming.get(9)) {
        {
          ...
          struct.partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list612.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem613;
          for (int _i614 = 0; _i614 < _list612.size; ++_i614)
          {
            _elem613 = new com.starrocks.thrift.TExpr();
            _elem613.read(iprot);
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.build_runtime_filters = new java.util.ArrayList<com.starrocks.thrift.TRuntimeFilterDescription>(_list615.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TRuntimeFilterDescription _elem616;
          for (int _i617 = 0; _i617 < _list615.size; ++_i617)
          {
            _elem616 = new com.starrocks.thrift.TRuntimeFilterDescription();
            _elem616.read(iprot);
