...
public class TMergeNode implements org.apache.thrift.TBase<TMergeNode, TMergeNode._Fields>, java.io.Serializable, Cloneable, Comparable<TMergeNode> {
  ...
  public TMergeNode setResult_expr_lists(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>> result_expr_lists) {
    this.result_expr_lists = result_expr_lists;
    return this;
  }
  ...
  public TMergeNode setConst_expr_lists(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>> const_expr_lists) {
    this.const_expr_lists = const_expr_lists;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(_list642.size);
                @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _elem643;
                for (int _i644 = 0; _i644 < _list642.size; ++_i644)
                {
                  {
                    org.apache.thrift.protocol.TList _list645 = iprot.readListBegin();
                    _elem643 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list645.size);
                    @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem646;
                    for (int _i647 = 0; _i647 < _list645.size; ++_i647)
                    {
                      _elem646 = new io.datafibre.fibre.thrift.TExpr();
                      _elem646.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.const_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(_list648.size);
                @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _elem649;
                for (int _i650 = 0; _i650 < _list648.size; ++_i650)
                {
                  {
                    org.apache.thrift.protocol.TList _list651 = iprot.readListBegin();
                    _elem649 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list651.size);
                    @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem652;
                    for (int _i653 = 0; _i653 < _list651.size; ++_i653)
                    {
                      _elem652 = new io.datafibre.fibre.thrift.TExpr();
                      _elem652.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TMergeNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.result_expr_lists != null) {
        oprot.writeFieldBegin(RESULT_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<io.datafibre.fibre.thrift.TExpr> _iter654 : struct.result_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter654.size()));
              for (io.datafibre.fibre.thrift.TExpr _iter655 : _iter654)
              {
      ...
      if (struct.const_expr_lists != null) {
        oprot.writeFieldBegin(CONST_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<io.datafibre.fibre.thrift.TExpr> _iter656 : struct.const_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter656.size()));
              for (io.datafibre.fibre.thrift.TExpr _iter657 : _iter656)
              {
  ...
  private static class TMergeNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TMergeNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TMergeNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.tuple_id);
      {
        ...
        for (java.util.List<io.datafibre.fibre.thrift.TExpr> _iter658 : struct.result_expr_lists)
        {
          {
            oprot.writeI32(_iter658.size());
            for (io.datafibre.fibre.thrift.TExpr _iter659 : _iter658)
            {
      ...
      }
      {
        ...
        for (java.util.List<io.datafibre.fibre.thrift.TExpr> _iter660 : struct.const_expr_lists)
        {
          {
            oprot.writeI32(_iter660.size());
            for (io.datafibre.fibre.thrift.TExpr _iter661 : _iter660)
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TMergeNode struct) throws org.apache.thrift.TException {
      ...
      struct.setTuple_idIsSet(true);
      {
        ...
        struct.result_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(_list662.size);
        @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _elem663;
        ...
        {
          {
            ...
            _elem663 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list665.size);
            @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem666;
            for (int _i667 = 0; _i667 < _list665.size; ++_i667)
            {
              _elem666 = new io.datafibre.fibre.thrift.TExpr();
              _elem666.read(iprot);
      ...
      struct.setResult_expr_listsIsSet(true);
      {
        ...
        struct.const_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(_list668.size);
        @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _elem669;
        ...
        {
          {
            ...
            _elem669 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list671.size);
            @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem672;
            for (int _i673 = 0; _i673 < _list671.size; ++_i673)
            {
              _elem672 = new io.datafibre.fibre.thrift.TExpr();
              _elem672.read(iprot);
