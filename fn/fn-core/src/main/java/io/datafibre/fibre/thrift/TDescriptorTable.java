            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.slotDescriptors = new java.util.ArrayList<TSlotDescriptor>(_list388.size);
                @org.apache.thrift.annotation.Nullable TSlotDescriptor _elem389;
                for (int _i390 = 0; _i390 < _list388.size; ++_i390)
                {
                  _elem389 = new TSlotDescriptor();
                  _elem389.read(iprot);
                  struct.slotDescriptors.add(_elem389);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tupleDescriptors = new java.util.ArrayList<TTupleDescriptor>(_list391.size);
                @org.apache.thrift.annotation.Nullable TTupleDescriptor _elem392;
                for (int _i393 = 0; _i393 < _list391.size; ++_i393)
                {
                  _elem392 = new TTupleDescriptor();
                  _elem392.read(iprot);
                  struct.tupleDescriptors.add(_elem392);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tableDescriptors = new java.util.ArrayList<TTableDescriptor>(_list394.size);
                @org.apache.thrift.annotation.Nullable TTableDescriptor _elem395;
                for (int _i396 = 0; _i396 < _list394.size; ++_i396)
                {
                  _elem395 = new TTableDescriptor();
                  _elem395.read(iprot);
                  struct.tableDescriptors.add(_elem395);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDescriptorTable struct) throws org.apache.thrift.TException {
      ...
      if (struct.slotDescriptors != null) {
        if (struct.isSetSlotDescriptors()) {
          oprot.writeFieldBegin(SLOT_DESCRIPTORS_FIELD_DESC);
          {
            ...
            for (TSlotDescriptor _iter397 : struct.slotDescriptors)
            {
      ...
      if (struct.tupleDescriptors != null) {
        oprot.writeFieldBegin(TUPLE_DESCRIPTORS_FIELD_DESC);
        {
          ...
          for (TTupleDescriptor _iter398 : struct.tupleDescriptors)
          {
      ...
      if (struct.tableDescriptors != null) {
        if (struct.isSetTableDescriptors()) {
          oprot.writeFieldBegin(TABLE_DESCRIPTORS_FIELD_DESC);
          {
            ...
            for (TTableDescriptor _iter399 : struct.tableDescriptors)
            {
  ...
  private static class TDescriptorTableTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDescriptorTable> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TDescriptorTable struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (TTupleDescriptor _iter400 : struct.tupleDescriptors)
        {
      ...
      if (struct.isSetSlotDescriptors()) {
        {
          ...
          for (TSlotDescriptor _iter401 : struct.slotDescriptors)
          {
      ...
      if (struct.isSetTableDescriptors()) {
        {
          ...
          for (TTableDescriptor _iter402 : struct.tableDescriptors)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDescriptorTable struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.tupleDescriptors = new java.util.ArrayList<TTupleDescriptor>(_list403.size);
        @org.apache.thrift.annotation.Nullable TTupleDescriptor _elem404;
        for (int _i405 = 0; _i405 < _list403.size; ++_i405)
        {
          _elem404 = new TTupleDescriptor();
          _elem404.read(iprot);
          struct.tupleDescriptors.add(_elem404);
        }
      }
      struct.setTupleDescriptorsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.slotDescriptors = new java.util.ArrayList<TSlotDescriptor>(_list406.size);
          @org.apache.thrift.annotation.Nullable TSlotDescriptor _elem407;
          for (int _i408 = 0; _i408 < _list406.size; ++_i408)
          {
            _elem407 = new TSlotDescriptor();
            _elem407.read(iprot);
            struct.slotDescriptors.add(_elem407);
          }
        }
        struct.setSlotDescriptorsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.tableDescriptors = new java.util.ArrayList<TTableDescriptor>(_list409.size);
          @org.apache.thrift.annotation.Nullable TTableDescriptor _elem410;
          for (int _i411 = 0; _i411 < _list409.size; ++_i411)
          {
            _elem410 = new TTableDescriptor();
            _elem410.read(iprot);
            struct.tableDescriptors.add(_elem410);
          }
        }
        struct.setTableDescriptorsIsSet(true);
      }
