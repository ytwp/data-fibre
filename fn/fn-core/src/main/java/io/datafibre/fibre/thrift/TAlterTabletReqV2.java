...
public class TAlterTabletReqV2 implements org.apache.thrift.TBase<TAlterTabletReqV2, TAlterTabletReqV2._Fields>, java.io.Serializable, Cloneable, Comparable<TAlterTabletReqV2> {
  ...
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr where_expr; // optional
  ...
  public TAlterTabletReqV2() {
    this.alter_job_type = io.datafibre.fibre.thrift.TAlterJobType.SCHEMA_CHANGE;
  ...
  public TAlterTabletReqV2(TAlterTabletReqV2 other) {
    ...
    if (other.isSetWhere_expr()) {
      this.where_expr = new io.datafibre.fibre.thrift.TExpr(other.where_expr);
    }
  ...
  public TAlterTabletReqV2 setQuery_globals(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TQueryGlobals query_globals) {
  ...
  public TAlterTabletReqV2 setQuery_options(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TQueryOptions query_options) {
  ...
  public TAlterTabletReqV2 setColumns(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TColumn> columns) {
  ...
  public TAlterTabletReqV2 setDesc_tbl(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TDescriptorTable desc_tbl) {
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TExpr getWhere_expr() {
    return this.where_expr;
  }

  public TAlterTabletReqV2 setWhere_expr(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr where_expr) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case WHERE_EXPR:
      if (value == null) {
        ...
        setWhere_expr((io.datafibre.fibre.thrift.TExpr)value);
      }
      break;
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TAlterTabletReqV2 struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<io.datafibre.fibre.thrift.TColumn>(_list45.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TColumn _elem46;
                for (int _i47 = 0; _i47 < _list45.size; ++_i47)
                {
                  _elem46 = new io.datafibre.fibre.thrift.TColumn();
                  _elem46.read(iprot);
          ...
          case 15: // ALTER_JOB_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.alter_job_type = io.datafibre.fibre.thrift.TAlterJobType.findByValue(iprot.readI32());
          ...
          case 17: // WHERE_EXPR
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.where_expr = new io.datafibre.fibre.thrift.TExpr();
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TColumn _iter52 : struct.columns)
            {
              _iter52.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TColumn _iter55 : struct.columns)
          {
            _iter55.write(oprot);
          }
        }
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.columns = new java.util.ArrayList<io.datafibre.fibre.thrift.TColumn>(_list60.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TColumn _elem61;
          for (int _i62 = 0; _i62 < _list60.size; ++_i62)
          {
            _elem61 = new io.datafibre.fibre.thrift.TColumn();
            _elem61.read(iprot);
