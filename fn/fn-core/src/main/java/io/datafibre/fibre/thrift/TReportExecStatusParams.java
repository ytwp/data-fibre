...
public class TReportExecStatusParams implements org.apache.thrift.TBase<TReportExecStatusParams, TReportExecStatusParams._Fields>, java.io.Serializable, Cloneable, Comparable<TReportExecStatusParams> {
  ...
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TRuntimeProfileTree profile; // optional
  ...
  /**
   * 
   * @see io.datafibre.fibre.thrift.TLoadJobType
   */
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TLoadJobType load_type; // optional
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TSinkCommitInfo> sink_commit_infos; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.PROFILE, new org.apache.thrift.meta_data.FieldMetaData("profile", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, io.datafibre.fibre.thrift.TRuntimeProfileTree.class)));
    ...
    tmpMap.put(_Fields.LOAD_TYPE, new org.apache.thrift.meta_data.FieldMetaData("load_type", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, io.datafibre.fibre.thrift.TLoadJobType.class)));
    ...
    tmpMap.put(_Fields.SINK_COMMIT_INFOS, new org.apache.thrift.meta_data.FieldMetaData("sink_commit_infos", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, io.datafibre.fibre.thrift.TSinkCommitInfo.class))));
  ...
  public TReportExecStatusParams(TReportExecStatusParams other) {
    ...
    if (other.isSetProfile()) {
      this.profile = new io.datafibre.fibre.thrift.TRuntimeProfileTree(other.profile);
    }
    ...
    if (other.isSetSink_commit_infos()) {
      java.util.List<io.datafibre.fibre.thrift.TSinkCommitInfo> __this__sink_commit_infos = new java.util.ArrayList<io.datafibre.fibre.thrift.TSinkCommitInfo>(other.sink_commit_infos.size());
      for (io.datafibre.fibre.thrift.TSinkCommitInfo other_element : other.sink_commit_infos) {
        __this__sink_commit_infos.add(new io.datafibre.fibre.thrift.TSinkCommitInfo(other_element));
      }
  ...
  public TReportExecStatusParams setQuery_id(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TUniqueId query_id) {
  ...
  public TReportExecStatusParams setFragment_instance_id(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TUniqueId fragment_instance_id) {
  ...
  public TReportExecStatusParams setStatus(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TStatus status) {
    this.status = status;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TRuntimeProfileTree getProfile() {
    return this.profile;
  }

  public TReportExecStatusParams setProfile(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TRuntimeProfileTree profile) {
  ...
  public TReportExecStatusParams setCommitInfos(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TTabletCommitInfo> commitInfos) {
   ...
   */
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TLoadJobType getLoad_type() {
   ...
   * @see io.datafibre.fibre.thrift.TLoadJobType
   */
  public TReportExecStatusParams setLoad_type(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TLoadJobType load_type) {
  ...
  public TReportExecStatusParams setFailInfos(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TTabletFailInfo> failInfos) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TSinkCommitInfo> getSink_commit_infosIterator() {
    return (this.sink_commit_infos == null) ? null : this.sink_commit_infos.iterator();
  }

  public void addToSink_commit_infos(io.datafibre.fibre.thrift.TSinkCommitInfo elem) {
    if (this.sink_commit_infos == null) {
      this.sink_commit_infos = new java.util.ArrayList<io.datafibre.fibre.thrift.TSinkCommitInfo>();
    }
    this.sink_commit_infos.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TSinkCommitInfo> getSink_commit_infos() {
    return this.sink_commit_infos;
  }

  public TReportExecStatusParams setSink_commit_infos(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TSinkCommitInfo> sink_commit_infos) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case PROFILE:
      if (value == null) {
        ...
        setProfile((io.datafibre.fibre.thrift.TRuntimeProfileTree)value);
      }
      break;
    ...
    case LOAD_TYPE:
      if (value == null) {
        ...
        setLoad_type((io.datafibre.fibre.thrift.TLoadJobType)value);
      }
      break;
    ...
    case SINK_COMMIT_INFOS:
      if (value == null) {
        ...
        setSink_commit_infos((java.util.List<io.datafibre.fibre.thrift.TSinkCommitInfo>)value);
      }
      break;
        ...
        switch (schemeField.id) {
          case 1: // PROTOCOL_VERSION
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.protocol_version = io.datafibre.fibre.thrift.FrontendServiceVersion.findByValue(iprot.readI32());
          ...
          case 7: // PROFILE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.profile = new io.datafibre.fibre.thrift.TRuntimeProfileTree();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commitInfos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletCommitInfo>(_list225.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletCommitInfo _elem226;
                for (int _i227 = 0; _i227 < _list225.size; ++_i227)
                {
                  _elem226 = new io.datafibre.fibre.thrift.TTabletCommitInfo();
                  _elem226.read(iprot);
          ...
          case 20: // LOAD_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.load_type = io.datafibre.fibre.thrift.TLoadJobType.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.failInfos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletFailInfo>(_list228.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletFailInfo _elem229;
                for (int _i230 = 0; _i230 < _list228.size; ++_i230)
                {
                  _elem229 = new io.datafibre.fibre.thrift.TTabletFailInfo();
                  _elem229.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sink_commit_infos = new java.util.ArrayList<io.datafibre.fibre.thrift.TSinkCommitInfo>(_list231.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TSinkCommitInfo _elem232;
                for (int _i233 = 0; _i233 < _list231.size; ++_i233)
                {
                  _elem232 = new io.datafibre.fibre.thrift.TSinkCommitInfo();
                  _elem232.read(iprot);
      ...
      if (struct.commitInfos != null) {
        if (struct.isSetCommitInfos()) {
          oprot.writeFieldBegin(COMMIT_INFOS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TTabletCommitInfo _iter238 : struct.commitInfos)
            {
      ...
      if (struct.failInfos != null) {
        if (struct.isSetFailInfos()) {
          oprot.writeFieldBegin(FAIL_INFOS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TTabletFailInfo _iter239 : struct.failInfos)
            {
      ...
      if (struct.sink_commit_infos != null) {
        if (struct.isSetSink_commit_infos()) {
          oprot.writeFieldBegin(SINK_COMMIT_INFOS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TSinkCommitInfo _iter240 : struct.sink_commit_infos)
            {
      ...
      if (struct.isSetCommitInfos()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TTabletCommitInfo _iter245 : struct.commitInfos)
          {
      ...
      if (struct.isSetFailInfos()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TTabletFailInfo _iter246 : struct.failInfos)
          {
      ...
      if (struct.isSetSink_commit_infos()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TSinkCommitInfo _iter247 : struct.sink_commit_infos)
          {
      ...
      if (incoming.get(11)) {
        {
          ...
          struct.commitInfos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletCommitInfo>(_list261.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletCommitInfo _elem262;
          for (int _i263 = 0; _i263 < _list261.size; ++_i263)
          {
            _elem262 = new io.datafibre.fibre.thrift.TTabletCommitInfo();
            _elem262.read(iprot);
      ...
      if (incoming.get(18)) {
        {
          ...
          struct.failInfos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletFailInfo>(_list264.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletFailInfo _elem265;
          for (int _i266 = 0; _i266 < _list264.size; ++_i266)
          {
            _elem265 = new io.datafibre.fibre.thrift.TTabletFailInfo();
            _elem265.read(iprot);
      ...
      if (incoming.get(22)) {
        {
          ...
          struct.sink_commit_infos = new java.util.ArrayList<io.datafibre.fibre.thrift.TSinkCommitInfo>(_list267.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TSinkCommitInfo _elem268;
          for (int _i269 = 0; _i269 < _list267.size; ++_i269)
          {
            _elem268 = new io.datafibre.fibre.thrift.TSinkCommitInfo();
            _elem268.read(iprot);
