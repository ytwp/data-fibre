...
public interface BitmapIndexPBOrBuilder extends
   ...
   */
  io.datafibre.fibre.proto.BitmapIndexPB.BitmapType getBitmapType();
   ...
   */
  io.datafibre.fibre.proto.IndexedColumnMetaPB getDictColumn();
  /**
   * <pre>
   * required: meta for ordered dictionary part
   * </pre>
   ...
   * <code>optional .starrocks.IndexedColumnMetaPB dict_column = 3;</code>
   */
  io.datafibre.fibre.proto.IndexedColumnMetaPBOrBuilder getDictColumnOrBuilder();
   ...
   */
  io.datafibre.fibre.proto.IndexedColumnMetaPB getBitmapColumn();
  /**
   * <pre>
   * required: meta for bitmaps part
   * </pre>
   ...
   * <code>optional .starrocks.IndexedColumnMetaPB bitmap_column = 4;</code>
   */
  io.datafibre.fibre.proto.IndexedColumnMetaPBOrBuilder getBitmapColumnOrBuilder();
}
