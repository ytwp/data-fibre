...
public class TKafkaMetaProxyResult implements org.apache.thrift.TBase<TKafkaMetaProxyResult, TKafkaMetaProxyResult._Fields>, java.io.Serializable, Cloneable, Comparable<TKafkaMetaProxyResult> {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.lang.Integer> getPartition_idsIterator() {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.lang.Integer> getPartition_ids() {
    return this.partition_ids;
  }

  public TKafkaMetaProxyResult setPartition_ids(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> partition_ids) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case PARTITION_IDS:
      if (value == null) {
        ...
        setPartition_ids((java.util.List<java.lang.Integer>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_ids = new java.util.ArrayList<java.lang.Integer>(_list58.size);
                int _elem59;
      ...
      if (struct.partition_ids != null) {
        if (struct.isSetPartition_ids()) {
          oprot.writeFieldBegin(PARTITION_IDS_FIELD_DESC);
          {
            ...
            for (int _iter61 : struct.partition_ids)
            {
      ...
      if (struct.isSetPartition_ids()) {
        {
          ...
          for (int _iter62 : struct.partition_ids)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.partition_ids = new java.util.ArrayList<java.lang.Integer>(_list63.size);
          int _elem64;
          for (int _i65 = 0; _i65 < _list63.size; ++_i65)
          {
            _elem64 = iprot.readI32();
            struct.partition_ids.add(_elem64);
          }
        }
        struct.setPartition_idsIsSet(true);
      }
