...
public class TAssertNumRowsNode implements org.apache.thrift.TBase<TAssertNumRowsNode, TAssertNumRowsNode._Fields>, java.io.Serializable, Cloneable, Comparable<TAssertNumRowsNode> {
  ...
  public TAssertNumRowsNode setDesired_num_rows(long desired_num_rows) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.lang.String getSubquery_string() {
    return this.subquery_string;
  }

  public TAssertNumRowsNode setSubquery_string(@org.apache.thrift.annotation.Nullable java.lang.String subquery_string) {
    this.subquery_string = subquery_string;
    return this;
  }

  public void unsetSubquery_string() {
    this.subquery_string = null;
  }

  /** Returns true if field subquery_string is set (has been assigned a value) and false otherwise */
  public boolean isSetSubquery_string() {
    return this.subquery_string != null;
  }

  public void setSubquery_stringIsSet(boolean value) {
    if (!value) {
      this.subquery_string = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case SUBQUERY_STRING:
      if (value == null) {
        unsetSubquery_string();
      } else {
        setSubquery_string((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(TAssertNumRowsNode that) {
    ...
    boolean this_present_subquery_string = true && this.isSetSubquery_string();
    boolean that_present_subquery_string = true && that.isSetSubquery_string();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSubquery_string()) ? 131071 : 524287);
    if (isSetSubquery_string())
  ...
  public int compareTo(TAssertNumRowsNode other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSubquery_string(), other.isSetSubquery_string());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSubquery_string()) {
  ...
  private static class TAssertNumRowsNodeStandardScheme extends org.apache.thrift.scheme.StandardScheme<TAssertNumRowsNode> {
        ...
        switch (schemeField.id) {
          ...
          case 2: // SUBQUERY_STRING
            if (schemeField.type == org.apache.thrift.protocol.TType.STRING) {
              ...
              struct.setSubquery_stringIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAssertNumRowsNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.subquery_string != null) {
        if (struct.isSetSubquery_string()) {
