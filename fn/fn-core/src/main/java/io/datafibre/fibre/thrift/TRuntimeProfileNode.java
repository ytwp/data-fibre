...
public class TRuntimeProfileNode implements org.apache.thrift.TBase<TRuntimeProfileNode, TRuntimeProfileNode._Fields>, java.io.Serializable, Cloneable, Comparable<TRuntimeProfileNode> {
  ...
  public int compareTo(TRuntimeProfileNode other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetInfo_strings(), other.isSetInfo_strings());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInfo_strings()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetInfo_strings_display_order(), other.isSetInfo_strings_display_order());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetInfo_strings_display_order()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetChild_counters_map(), other.isSetChild_counters_map());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetChild_counters_map()) {
