...
public class TAnalyticWindow implements org.apache.thrift.TBase<TAnalyticWindow, TAnalyticWindow._Fields>, java.io.Serializable, Cloneable, Comparable<TAnalyticWindow> {
  ...
  public TAnalyticWindow setWindow_start(@org.apache.thrift.annotation.Nullable TAnalyticWindowBoundary window_start) {
  ...
  public TAnalyticWindow setWindow_end(@org.apache.thrift.annotation.Nullable TAnalyticWindowBoundary window_end) {
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetWindow_start()) ? 131071 : 524287);
    if (isSetWindow_start())
      hashCode = hashCode * 8191 + window_start.hashCode();

    hashCode = hashCode * 8191 + ((isSetWindow_end()) ? 131071 : 524287);
    if (isSetWindow_end())
  ...
  public int compareTo(TAnalyticWindow other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetWindow_start(), other.isSetWindow_start());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWindow_start()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetWindow_end(), other.isSetWindow_end());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetWindow_end()) {
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = io.datafibre.fibre.thrift.TAnalyticWindowType.findByValue(iprot.readI32());
