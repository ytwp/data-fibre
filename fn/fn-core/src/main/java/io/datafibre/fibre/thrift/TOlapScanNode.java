            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.key_column_type = new java.util.ArrayList<com.starrocks.thrift.TPrimitiveType>(_list225.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TPrimitiveType _elem226;
                for (int _i227 = 0; _i227 < _list225.size; ++_i227)
                {
                  _elem226 = com.starrocks.thrift.TPrimitiveType.findByValue(iprot.readI32());
                  if (_elem226 != null)
                  {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.bucket_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list235.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem236;
                for (int _i237 = 0; _i237 < _list235.size; ++_i237)
                {
                  _elem236 = new com.starrocks.thrift.TExpr();
                  _elem236.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns_desc = new java.util.ArrayList<com.starrocks.thrift.TColumn>(_list244.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TColumn _elem245;
                for (int _i246 = 0; _i246 < _list244.size; ++_i246)
                {
                  _elem245 = new com.starrocks.thrift.TColumn();
                  _elem245.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TOlapScanNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.key_column_type != null) {
        oprot.writeFieldBegin(KEY_COLUMN_TYPE_FIELD_DESC);
        {
          ...
          for (com.starrocks.thrift.TPrimitiveType _iter248 : struct.key_column_type)
          {
      ...
      if (struct.bucket_exprs != null) {
        if (struct.isSetBucket_exprs()) {
          oprot.writeFieldBegin(BUCKET_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter251 : struct.bucket_exprs)
            {
      ...
      if (struct.columns_desc != null) {
        if (struct.isSetColumns_desc()) {
          oprot.writeFieldBegin(COLUMNS_DESC_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TColumn _iter254 : struct.columns_desc)
            {
  ...
  private static class TOlapScanNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TOlapScanNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TOlapScanNode struct) throws org.apache.thrift.TException {
      ...
      }
      {
        ...
        for (com.starrocks.thrift.TPrimitiveType _iter256 : struct.key_column_type)
        {
      ...
      if (struct.isSetBucket_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter259 : struct.bucket_exprs)
          {
      ...
      if (struct.isSetColumns_desc()) {
        {
          ...
          for (com.starrocks.thrift.TColumn _iter262 : struct.columns_desc)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TOlapScanNode struct) throws org.apache.thrift.TException {
      ...
      struct.setKey_column_nameIsSet(true);
      {
        ...
        struct.key_column_type = new java.util.ArrayList<com.starrocks.thrift.TPrimitiveType>(_list266.size);
        @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TPrimitiveType _elem267;
        for (int _i268 = 0; _i268 < _list266.size; ++_i268)
        {
          _elem267 = com.starrocks.thrift.TPrimitiveType.findByValue(iprot.readI32());
          if (_elem267 != null)
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.bucket_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list276.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem277;
          for (int _i278 = 0; _i278 < _list276.size; ++_i278)
          {
            _elem277 = new com.starrocks.thrift.TExpr();
            _elem277.read(iprot);
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.columns_desc = new java.util.ArrayList<com.starrocks.thrift.TColumn>(_list285.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TColumn _elem286;
          for (int _i287 = 0; _i287 < _list285.size; ++_i287)
          {
            _elem286 = new com.starrocks.thrift.TColumn();
            _elem286.read(iprot);
