...
public class TFetchDataResult implements org.apache.thrift.TBase<TFetchDataResult, TFetchDataResult._Fields>, java.io.Serializable, Cloneable, Comparable<TFetchDataResult> {
  ...
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TResultBatch result_batch; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.RESULT_BATCH, new org.apache.thrift.meta_data.FieldMetaData("result_batch", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, io.datafibre.fibre.thrift.TResultBatch.class)));
  ...
  public TFetchDataResult(
    io.datafibre.fibre.thrift.TResultBatch result_batch,
    boolean eos,
    int packet_num)
  {
    this();
  ...
  public TFetchDataResult(TFetchDataResult other) {
    ...
    if (other.isSetResult_batch()) {
      this.result_batch = new io.datafibre.fibre.thrift.TResultBatch(other.result_batch);
    }
    this.eos = other.eos;
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TResultBatch getResult_batch() {
    return this.result_batch;
  }

  public TFetchDataResult setResult_batch(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TResultBatch result_batch) {
    this.result_batch = result_batch;
    return this;
  }
  ...
  public TFetchDataResult setStatus(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TStatus status) {
    this.status = status;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case RESULT_BATCH:
      if (value == null) {
        ...
        setResult_batch((io.datafibre.fibre.thrift.TResultBatch)value);
      }
      break;
    ...
    case PACKET_NUM:
      if (value == null) {
        ...
        setPacket_num((java.lang.Integer)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetResult_batch()) ? 131071 : 524287);
  ...
  public int compareTo(TFetchDataResult other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetResult_batch(), other.isSetResult_batch());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetPacket_num(), other.isSetPacket_num());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPacket_num()) {
        ...
        switch (schemeField.id) {
          case 1: // RESULT_BATCH
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.result_batch = new io.datafibre.fibre.thrift.TResultBatch();
