...
public class THiveTableSink implements org.apache.thrift.TBase<THiveTableSink, THiveTableSink._Fields>, java.io.Serializable, Cloneable, Comparable<THiveTableSink> {
  ...
  public @org.apache.thrift.annotation.Nullable String staging_dir; // optional
  public @org.apache.thrift.annotation.Nullable String file_format; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<String> data_column_names; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<String> partition_column_names; // optional
  /**
   * 
  ...
  private static final _Fields optionals[] = {_Fields.STAGING_DIR,_Fields.FILE_FORMAT,_Fields.DATA_COLUMN_NAMES,_Fields.PARTITION_COLUMN_NAMES,_Fields.COMPRESSION_TYPE,_Fields.IS_STATIC_PARTITION_SINK,_Fields.CLOUD_CONFIGURATION};
  ...
  public THiveTableSink(THiveTableSink other) {
    ...
    if (other.isSetData_column_names()) {
      java.util.List<String> __this__data_column_names = new java.util.ArrayList<String>(other.data_column_names);
      this.data_column_names = __this__data_column_names;
    }
    if (other.isSetPartition_column_names()) {
      java.util.List<String> __this__partition_column_names = new java.util.ArrayList<String>(other.partition_column_names);
  ...
  public THiveTableSink setStaging_dir(@org.apache.thrift.annotation.Nullable String staging_dir) {
  ...
  public THiveTableSink setFile_format(@org.apache.thrift.annotation.Nullable String file_format) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<String> getData_column_namesIterator() {
    return (this.data_column_names == null) ? null : this.data_column_names.iterator();
  }

  public void addToData_column_names(String elem) {
    if (this.data_column_names == null) {
      this.data_column_names = new java.util.ArrayList<String>();
    }
    this.data_column_names.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<String> getData_column_names() {
    return this.data_column_names;
  }

  public THiveTableSink setData_column_names(@org.apache.thrift.annotation.Nullable java.util.List<String> data_column_names) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<String> getPartition_column_namesIterator() {
    return (this.partition_column_names == null) ? null : this.partition_column_names.iterator();
  }

  public void addToPartition_column_names(String elem) {
    if (this.partition_column_names == null) {
      this.partition_column_names = new java.util.ArrayList<String>();
    }
    this.partition_column_names.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<String> getPartition_column_names() {
    return this.partition_column_names;
  }

  public THiveTableSink setPartition_column_names(@org.apache.thrift.annotation.Nullable java.util.List<String> partition_column_names) {
   ...
   * @see TCompressionType
   */
  public THiveTableSink setCompression_type(@org.apache.thrift.annotation.Nullable TCompressionType compression_type) {
  ...
  public THiveTableSink setCloud_configuration(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TCloudConfiguration cloud_configuration) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case DATA_COLUMN_NAMES:
      if (value == null) {
        ...
        setData_column_names((java.util.List<String>)value);
      }
      break;
    ...
    case PARTITION_COLUMN_NAMES:
      if (value == null) {
        ...
        setPartition_column_names((java.util.List<String>)value);
      }
      break;
  ...
  public int compareTo(THiveTableSink other) {
    ...
    lastComparison = Boolean.compare(isSetStaging_dir(), other.isSetStaging_dir());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.compare(isSetData_column_names(), other.isSetData_column_names());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetData_column_names()) {
    ...
    lastComparison = Boolean.compare(isSetPartition_column_names(), other.isSetPartition_column_names());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetPartition_column_names()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("THiveTableSink(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.data_column_names = new java.util.ArrayList<String>(_list84.size);
                @org.apache.thrift.annotation.Nullable String _elem85;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_column_names = new java.util.ArrayList<String>(_list87.size);
                @org.apache.thrift.annotation.Nullable String _elem88;
      ...
      if (struct.data_column_names != null) {
        if (struct.isSetData_column_names()) {
          oprot.writeFieldBegin(DATA_COLUMN_NAMES_FIELD_DESC);
          {
            ...
            for (String _iter90 : struct.data_column_names)
            {
      ...
      if (struct.partition_column_names != null) {
        if (struct.isSetPartition_column_names()) {
          oprot.writeFieldBegin(PARTITION_COLUMN_NAMES_FIELD_DESC);
          {
            ...
            for (String _iter91 : struct.partition_column_names)
            {
      ...
      if (struct.isSetData_column_names()) {
        {
          ...
          for (String _iter92 : struct.data_column_names)
          {
      ...
      if (struct.isSetPartition_column_names()) {
        {
          ...
          for (String _iter93 : struct.partition_column_names)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.data_column_names = new java.util.ArrayList<String>(_list94.size);
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.partition_column_names = new java.util.ArrayList<String>(_list97.size);
