...
public interface SegmentFooterPBOrBuilder extends
   ...
   * <code>repeated .starrocks.ColumnMetaPB columns = 2;</code>
   */
  io.datafibre.fibre.proto.ColumnMetaPB getColumns(int index);
  /**
   * <pre>
   * tablet schema
   * </pre>
   ...
   * <code>repeated .starrocks.ColumnMetaPB columns = 2;</code>
   */
  io.datafibre.fibre.proto.ColumnMetaPBOrBuilder getColumnsOrBuilder(
      int index);
   ...
   */
  java.util.List<io.datafibre.fibre.proto.MetadataPairPB>
   ...
   * <code>repeated .starrocks.MetadataPairPB file_meta_datas = 8;</code>
   */
  io.datafibre.fibre.proto.MetadataPairPB getFileMetaDatas(int index);
  /**
   * <pre>
   * Deprecated
   * </pre>
   ...
   * <code>repeated .starrocks.MetadataPairPB file_meta_datas = 8;</code>
   */
  java.util.List<? extends io.datafibre.fibre.proto.MetadataPairPBOrBuilder>
   ...
   * <code>repeated .starrocks.MetadataPairPB file_meta_datas = 8;</code>
   */
  io.datafibre.fibre.proto.MetadataPairPBOrBuilder getFileMetaDatasOrBuilder(
      int index);
   ...
   */
  io.datafibre.fibre.proto.PagePointerPB getShortKeyIndexPage();
  /**
   * <pre>
   * Short key index's page
   * </pre>
   ...
   * <code>optional .starrocks.PagePointerPB short_key_index_page = 9;</code>
   */
  io.datafibre.fibre.proto.PagePointerPBOrBuilder getShortKeyIndexPageOrBuilder();
}
