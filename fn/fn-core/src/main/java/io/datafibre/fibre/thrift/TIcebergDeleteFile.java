...
public class TIcebergDeleteFile implements org.apache.thrift.TBase<TIcebergDeleteFile, TIcebergDeleteFile._Fields>, java.io.Serializable, Cloneable, Comparable<TIcebergDeleteFile> {
   ...
   * @see io.datafibre.fibre.thrift.THdfsFileFormat
   */
  public TIcebergDeleteFile setFile_format(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.THdfsFileFormat file_format) {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TIcebergDeleteFile struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // FILE_CONTENT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.file_content = io.datafibre.fibre.thrift.TIcebergFileContent.findByValue(iprot.readI32());
