...
public class THeartbeatResult implements org.apache.thrift.TBase<THeartbeatResult, THeartbeatResult._Fields>, java.io.Serializable, Cloneable, Comparable<THeartbeatResult> {
  ...
  public THeartbeatResult setStatus(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TStatus status) {
    this.status = status;
    return this;
  }
  ...
  public THeartbeatResult setBackend_info(@org.apache.thrift.annotation.Nullable TBackendInfo backend_info) {
    this.backend_info = backend_info;
    return this;
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetBackend_info()) ? 131071 : 524287);
  ...
  public int compareTo(THeartbeatResult other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetBackend_info(), other.isSetBackend_info());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBackend_info()) {
