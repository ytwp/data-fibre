...
public interface RowsetMetaPBOrBuilder extends
   ...
   */
  io.datafibre.fibre.proto.RowsetTypePB getRowsetType();
   ...
   */
  io.datafibre.fibre.proto.RowsetStatePB getRowsetState();
   ...
   */
  @java.lang.Deprecated java.util.List<io.datafibre.fibre.proto.ZoneMapOfRowset>
      getZoneMapsList();
  /**
   * <pre>
   * rowset level column min/max/null statistics, not not used currently
   ...
   * <code>repeated .starrocks.ZoneMapOfRowset zone_maps = 15 [deprecated = true];</code>
   */
  @java.lang.Deprecated io.datafibre.fibre.proto.ZoneMapOfRowset getZoneMaps(int index);
  /**
   * <pre>
   * rowset level column min/max/null statistics, not not used currently
   * </pre>
   ...
   * <code>repeated .starrocks.ZoneMapOfRowset zone_maps = 15 [deprecated = true];</code>
   */
  @java.lang.Deprecated java.util.List<? extends io.datafibre.fibre.proto.ZoneMapOfRowsetOrBuilder>
   ...
   * <code>repeated .starrocks.ZoneMapOfRowset zone_maps = 15 [deprecated = true];</code>
   */
  @java.lang.Deprecated io.datafibre.fibre.proto.ZoneMapOfRowsetOrBuilder getZoneMapsOrBuilder(
      int index);
   ...
   * @return The loadId.
   */
  io.datafibre.fibre.proto.PUniqueId getLoadId();
  /**
   * <pre>
   * only for pending rowset
   * </pre>
   ...
   * <code>optional .starrocks.PUniqueId load_id = 18;</code>
   */
  io.datafibre.fibre.proto.PUniqueIdOrBuilder getLoadIdOrBuilder();
   ...
   */
  io.datafibre.fibre.proto.SegmentsOverlapPB getSegmentsOverlapPb();
   ...
   */
  io.datafibre.fibre.proto.TabletSchemaPB getTabletSchema();
  /**
   * <pre>
   * tablet meta pb, for compaction
   * </pre>
   ...
   * <code>optional .starrocks.TabletSchemaPB tablet_schema = 60;</code>
   */
  io.datafibre.fibre.proto.TabletSchemaPBOrBuilder getTabletSchemaOrBuilder();
