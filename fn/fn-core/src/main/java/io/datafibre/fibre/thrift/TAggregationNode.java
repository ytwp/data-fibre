...
public class TAggregationNode implements org.apache.thrift.TBase<TAggregationNode, TAggregationNode._Fields>, java.io.Serializable, Cloneable, Comparable<TAggregationNode> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> aggregate_functions; // required
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> intermediate_aggr_exprs; // optional
  ...
  public TAggregationNode(
    java.util.List<com.starrocks.thrift.TExpr> aggregate_functions,
  ...
  public TAggregationNode(TAggregationNode other) {
    ...
    if (other.isSetIntermediate_aggr_exprs()) {
      java.util.List<com.starrocks.thrift.TExpr> __this__intermediate_aggr_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(other.intermediate_aggr_exprs.size());
      for (com.starrocks.thrift.TExpr other_element : other.intermediate_aggr_exprs) {
        __this__intermediate_aggr_exprs.add(new com.starrocks.thrift.TExpr(other_element));
      }
  ...
  public TAggregationNode setGrouping_exprs(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> grouping_exprs) {
  ...
  public TAggregationNode setAggregate_functions(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> aggregate_functions) {
    this.aggregate_functions = aggregate_functions;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<com.starrocks.thrift.TExpr> getIntermediate_aggr_exprsIterator() {
    return (this.intermediate_aggr_exprs == null) ? null : this.intermediate_aggr_exprs.iterator();
  }

  public void addToIntermediate_aggr_exprs(com.starrocks.thrift.TExpr elem) {
    if (this.intermediate_aggr_exprs == null) {
      this.intermediate_aggr_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>();
    }
    this.intermediate_aggr_exprs.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<com.starrocks.thrift.TExpr> getIntermediate_aggr_exprs() {
    return this.intermediate_aggr_exprs;
  }

  public TAggregationNode setIntermediate_aggr_exprs(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> intermediate_aggr_exprs) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case INTERMEDIATE_AGGR_EXPRS:
      if (value == null) {
        ...
        setIntermediate_aggr_exprs((java.util.List<com.starrocks.thrift.TExpr>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.grouping_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list458.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem459;
                for (int _i460 = 0; _i460 < _list458.size; ++_i460)
                {
                  _elem459 = new com.starrocks.thrift.TExpr();
                  _elem459.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.aggregate_functions = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list461.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem462;
                for (int _i463 = 0; _i463 < _list461.size; ++_i463)
                {
                  _elem462 = new com.starrocks.thrift.TExpr();
                  _elem462.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.intermediate_aggr_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list464.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem465;
                for (int _i466 = 0; _i466 < _list464.size; ++_i466)
                {
                  _elem465 = new com.starrocks.thrift.TExpr();
                  _elem465.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAggregationNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.grouping_exprs != null) {
        if (struct.isSetGrouping_exprs()) {
          oprot.writeFieldBegin(GROUPING_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter467 : struct.grouping_exprs)
            {
      ...
      if (struct.aggregate_functions != null) {
        oprot.writeFieldBegin(AGGREGATE_FUNCTIONS_FIELD_DESC);
        {
          ...
          for (com.starrocks.thrift.TExpr _iter468 : struct.aggregate_functions)
          {
      ...
      if (struct.intermediate_aggr_exprs != null) {
        if (struct.isSetIntermediate_aggr_exprs()) {
          oprot.writeFieldBegin(INTERMEDIATE_AGGR_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter469 : struct.intermediate_aggr_exprs)
            {
  ...
  private static class TAggregationNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TAggregationNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TAggregationNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (com.starrocks.thrift.TExpr _iter470 : struct.aggregate_functions)
        {
      ...
      if (struct.isSetGrouping_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter471 : struct.grouping_exprs)
          {
      ...
      if (struct.isSetIntermediate_aggr_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter472 : struct.intermediate_aggr_exprs)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TAggregationNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.aggregate_functions = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list473.size);
        @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem474;
        for (int _i475 = 0; _i475 < _list473.size; ++_i475)
        {
          _elem474 = new com.starrocks.thrift.TExpr();
          _elem474.read(iprot);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.grouping_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list476.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem477;
          for (int _i478 = 0; _i478 < _list476.size; ++_i478)
          {
            _elem477 = new com.starrocks.thrift.TExpr();
            _elem477.read(iprot);
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.intermediate_aggr_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list479.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem480;
          for (int _i481 = 0; _i481 < _list479.size; ++_i481)
          {
            _elem480 = new com.starrocks.thrift.TExpr();
            _elem480.read(iprot);
