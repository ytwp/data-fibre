...
public class TExceptNode implements org.apache.thrift.TBase<TExceptNode, TExceptNode._Fields>, java.io.Serializable, Cloneable, Comparable<TExceptNode> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>> result_expr_lists; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>> const_expr_lists; // required
  ...
  public TExceptNode(
    int tuple_id,
    java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>> result_expr_lists,
    java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>> const_expr_lists,
  ...
  public TExceptNode(TExceptNode other) {
    ...
    if (other.isSetResult_expr_lists()) {
      java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>> __this__result_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(other.result_expr_lists.size());
      for (java.util.List<io.datafibre.fibre.thrift.TExpr> other_element : other.result_expr_lists) {
        java.util.List<io.datafibre.fibre.thrift.TExpr> __this__result_expr_lists_copy = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(other_element.size());
        for (io.datafibre.fibre.thrift.TExpr other_element_element : other_element) {
          __this__result_expr_lists_copy.add(new io.datafibre.fibre.thrift.TExpr(other_element_element));
        }
    ...
    if (other.isSetConst_expr_lists()) {
      java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>> __this__const_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(other.const_expr_lists.size());
      for (java.util.List<io.datafibre.fibre.thrift.TExpr> other_element : other.const_expr_lists) {
        java.util.List<io.datafibre.fibre.thrift.TExpr> __this__const_expr_lists_copy = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(other_element.size());
        for (io.datafibre.fibre.thrift.TExpr other_element_element : other_element) {
          __this__const_expr_lists_copy.add(new io.datafibre.fibre.thrift.TExpr(other_element_element));
        }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.util.List<io.datafibre.fibre.thrift.TExpr>> getResult_expr_listsIterator() {
    return (this.result_expr_lists == null) ? null : this.result_expr_lists.iterator();
  }

  public void addToResult_expr_lists(java.util.List<io.datafibre.fibre.thrift.TExpr> elem) {
    if (this.result_expr_lists == null) {
      this.result_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>();
    }
    this.result_expr_lists.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>> getResult_expr_lists() {
    return this.result_expr_lists;
  }

  public TExceptNode setResult_expr_lists(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>> result_expr_lists) {
    this.result_expr_lists = result_expr_lists;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.util.List<io.datafibre.fibre.thrift.TExpr>> getConst_expr_listsIterator() {
    return (this.const_expr_lists == null) ? null : this.const_expr_lists.iterator();
  }

  public void addToConst_expr_lists(java.util.List<io.datafibre.fibre.thrift.TExpr> elem) {
    if (this.const_expr_lists == null) {
      this.const_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>();
    }
    this.const_expr_lists.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>> getConst_expr_lists() {
    return this.const_expr_lists;
  }

  public TExceptNode setConst_expr_lists(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>> const_expr_lists) {
    this.const_expr_lists = const_expr_lists;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case RESULT_EXPR_LISTS:
      if (value == null) {
        ...
        setResult_expr_lists((java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>>)value);
      }
      break;
    ...
    case CONST_EXPR_LISTS:
      if (value == null) {
        ...
        setConst_expr_lists((java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(_list756.size);
                @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _elem757;
                for (int _i758 = 0; _i758 < _list756.size; ++_i758)
                {
                  {
                    org.apache.thrift.protocol.TList _list759 = iprot.readListBegin();
                    _elem757 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list759.size);
                    @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem760;
                    for (int _i761 = 0; _i761 < _list759.size; ++_i761)
                    {
                      _elem760 = new io.datafibre.fibre.thrift.TExpr();
                      _elem760.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.const_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(_list762.size);
                @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _elem763;
                for (int _i764 = 0; _i764 < _list762.size; ++_i764)
                {
                  {
                    org.apache.thrift.protocol.TList _list765 = iprot.readListBegin();
                    _elem763 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list765.size);
                    @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem766;
                    for (int _i767 = 0; _i767 < _list765.size; ++_i767)
                    {
                      _elem766 = new io.datafibre.fibre.thrift.TExpr();
                      _elem766.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TExceptNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.result_expr_lists != null) {
        oprot.writeFieldBegin(RESULT_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<io.datafibre.fibre.thrift.TExpr> _iter768 : struct.result_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter768.size()));
              for (io.datafibre.fibre.thrift.TExpr _iter769 : _iter768)
              {
      ...
      if (struct.const_expr_lists != null) {
        oprot.writeFieldBegin(CONST_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<io.datafibre.fibre.thrift.TExpr> _iter770 : struct.const_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter770.size()));
              for (io.datafibre.fibre.thrift.TExpr _iter771 : _iter770)
              {
  ...
  private static class TExceptNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TExceptNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TExceptNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.tuple_id);
      {
        ...
        for (java.util.List<io.datafibre.fibre.thrift.TExpr> _iter772 : struct.result_expr_lists)
        {
          {
            oprot.writeI32(_iter772.size());
            for (io.datafibre.fibre.thrift.TExpr _iter773 : _iter772)
            {
      ...
      }
      {
        ...
        for (java.util.List<io.datafibre.fibre.thrift.TExpr> _iter774 : struct.const_expr_lists)
        {
          {
            oprot.writeI32(_iter774.size());
            for (io.datafibre.fibre.thrift.TExpr _iter775 : _iter774)
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TExceptNode struct) throws org.apache.thrift.TException {
      ...
      struct.setTuple_idIsSet(true);
      {
        ...
        struct.result_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(_list776.size);
        @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _elem777;
        ...
        {
          {
            ...
            _elem777 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list779.size);
            @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem780;
            for (int _i781 = 0; _i781 < _list779.size; ++_i781)
            {
              _elem780 = new io.datafibre.fibre.thrift.TExpr();
              _elem780.read(iprot);
      ...
      struct.setResult_expr_listsIsSet(true);
      {
        ...
        struct.const_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(_list782.size);
        @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _elem783;
        ...
        {
          {
            ...
            _elem783 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list785.size);
            @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem786;
            for (int _i787 = 0; _i787 < _list785.size; ++_i787)
            {
              _elem786 = new io.datafibre.fibre.thrift.TExpr();
              _elem786.read(iprot);
