...
public class TRuntimeFilterDestination implements org.apache.thrift.TBase<TRuntimeFilterDestination, TRuntimeFilterDestination._Fields>, java.io.Serializable, Cloneable, Comparable<TRuntimeFilterDestination> {
  ...
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TNetworkAddress address; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TUniqueId> finstance_ids; // optional
  ...
  public TRuntimeFilterDestination(TRuntimeFilterDestination other) {
    if (other.isSetAddress()) {
      this.address = new io.datafibre.fibre.thrift.TNetworkAddress(other.address);
    }
    if (other.isSetFinstance_ids()) {
      java.util.List<io.datafibre.fibre.thrift.TUniqueId> __this__finstance_ids = new java.util.ArrayList<io.datafibre.fibre.thrift.TUniqueId>(other.finstance_ids.size());
      for (io.datafibre.fibre.thrift.TUniqueId other_element : other.finstance_ids) {
        __this__finstance_ids.add(new io.datafibre.fibre.thrift.TUniqueId(other_element));
      }
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TNetworkAddress getAddress() {
    return this.address;
  }

  public TRuntimeFilterDestination setAddress(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TNetworkAddress address) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TUniqueId> getFinstance_idsIterator() {
    return (this.finstance_ids == null) ? null : this.finstance_ids.iterator();
  }

  public void addToFinstance_ids(io.datafibre.fibre.thrift.TUniqueId elem) {
    if (this.finstance_ids == null) {
      this.finstance_ids = new java.util.ArrayList<io.datafibre.fibre.thrift.TUniqueId>();
    }
    this.finstance_ids.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TUniqueId> getFinstance_ids() {
    return this.finstance_ids;
  }

  public TRuntimeFilterDestination setFinstance_ids(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TUniqueId> finstance_ids) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case ADDRESS:
      if (value == null) {
        ...
        setAddress((io.datafibre.fibre.thrift.TNetworkAddress)value);
      }
      break;
    ...
    case FINSTANCE_IDS:
      if (value == null) {
        ...
        setFinstance_ids((java.util.List<io.datafibre.fibre.thrift.TUniqueId>)value);
      }
      break;
        ...
        switch (schemeField.id) {
          case 1: // ADDRESS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.address = new io.datafibre.fibre.thrift.TNetworkAddress();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.finstance_ids = new java.util.ArrayList<io.datafibre.fibre.thrift.TUniqueId>(_list0.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TUniqueId _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new io.datafibre.fibre.thrift.TUniqueId();
                  _elem1.read(iprot);
      ...
      if (struct.finstance_ids != null) {
        if (struct.isSetFinstance_ids()) {
          oprot.writeFieldBegin(FINSTANCE_IDS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TUniqueId _iter3 : struct.finstance_ids)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetFinstance_ids()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TUniqueId _iter4 : struct.finstance_ids)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.finstance_ids = new java.util.ArrayList<io.datafibre.fibre.thrift.TUniqueId>(_list5.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TUniqueId _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = new io.datafibre.fibre.thrift.TUniqueId();
            _elem6.read(iprot);
