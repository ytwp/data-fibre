...
public class TExplainResult implements org.apache.thrift.TBase<TExplainResult, TExplainResult._Fields>, java.io.Serializable, Cloneable, Comparable<TExplainResult> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TResultRow> results; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.RESULTS, new org.apache.thrift.meta_data.FieldMetaData("results", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, io.datafibre.fibre.thrift.TResultRow.class))));
  ...
  public TExplainResult(
    java.util.List<io.datafibre.fibre.thrift.TResultRow> results)
  {
    this();
  ...
  public TExplainResult(TExplainResult other) {
    if (other.isSetResults()) {
      java.util.List<io.datafibre.fibre.thrift.TResultRow> __this__results = new java.util.ArrayList<io.datafibre.fibre.thrift.TResultRow>(other.results.size());
      for (io.datafibre.fibre.thrift.TResultRow other_element : other.results) {
        __this__results.add(new io.datafibre.fibre.thrift.TResultRow(other_element));
      }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TResultRow> getResultsIterator() {
    return (this.results == null) ? null : this.results.iterator();
  }

  public void addToResults(io.datafibre.fibre.thrift.TResultRow elem) {
    if (this.results == null) {
      this.results = new java.util.ArrayList<io.datafibre.fibre.thrift.TResultRow>();
    }
    this.results.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TResultRow> getResults() {
    return this.results;
  }

  public TExplainResult setResults(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TResultRow> results) {
    this.results = results;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case RESULTS:
      if (value == null) {
        ...
        setResults((java.util.List<io.datafibre.fibre.thrift.TResultRow>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.results = new java.util.ArrayList<io.datafibre.fibre.thrift.TResultRow>(_list84.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TResultRow _elem85;
                for (int _i86 = 0; _i86 < _list84.size; ++_i86)
                {
                  _elem85 = new io.datafibre.fibre.thrift.TResultRow();
                  _elem85.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TExplainResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.results != null) {
        oprot.writeFieldBegin(RESULTS_FIELD_DESC);
        {
          ...
          for (io.datafibre.fibre.thrift.TResultRow _iter87 : struct.results)
          {
            _iter87.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TExplainResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TExplainResult> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TExplainResult struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (io.datafibre.fibre.thrift.TResultRow _iter88 : struct.results)
        {
          _iter88.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TExplainResult struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.results = new java.util.ArrayList<io.datafibre.fibre.thrift.TResultRow>(_list89.size);
        @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TResultRow _elem90;
        for (int _i91 = 0; _i91 < _list89.size; ++_i91)
        {
          _elem90 = new io.datafibre.fibre.thrift.TResultRow();
          _elem90.read(iprot);
