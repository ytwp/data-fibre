...
public class TNodeInfo implements org.apache.thrift.TBase<TNodeInfo, TNodeInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TNodeInfo> {
    ...
    int async_internal_port)
  {
    ...
    setAsync_internal_portIsSet(true);
  }
  ...
  public void clear() {
    ...
    this.option = 0;
    this.host = null;
    setAsync_internal_portIsSet(false);
  ...
  public int getAsync_internal_port() {
    return this.async_internal_port;
  }

  public TNodeInfo setAsync_internal_port(int async_internal_port) {
    this.async_internal_port = async_internal_port;
    setAsync_internal_portIsSet(true);
    return this;
  }

  public void unsetAsync_internal_port() {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case ASYNC_INTERNAL_PORT:
      if (value == null) {
        unsetAsync_internal_port();
      } else {
        setAsync_internal_port((java.lang.Integer)value);
      }
      break;
  ...
  public boolean isSet(_Fields field) {
    ...
    case HOST:
      return isSetHost();
    case ASYNC_INTERNAL_PORT:
      return isSetAsync_internal_port();
    }
    throw new java.lang.IllegalStateException();
  }
  ...
  public int compareTo(TNodeInfo other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetAsync_internal_port(), other.isSetAsync_internal_port());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAsync_internal_port()) {
  ...
  private static class TNodeInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<TNodeInfo> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TNodeInfo struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 4: // ASYNC_INTERNAL_PORT
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              ...
              struct.setAsync_internal_portIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
      ...
      if (!struct.isSetAsync_internal_port()) {
