...
public class TOlapTablePartitionParam implements org.apache.thrift.TBase<TOlapTablePartitionParam, TOlapTablePartitionParam._Fields>, java.io.Serializable, Cloneable, Comparable<TOlapTablePartitionParam> {
  ...
  public TOlapTablePartitionParam setPartition_exprs(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> partition_exprs) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_exprs = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list57.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem58;
                for (int _i59 = 0; _i59 < _list57.size; ++_i59)
                {
                  _elem58 = new io.datafibre.fibre.thrift.TExpr();
                  _elem58.read(iprot);
      ...
      if (struct.partition_exprs != null) {
        if (struct.isSetPartition_exprs()) {
          oprot.writeFieldBegin(PARTITION_EXPRS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TExpr _iter63 : struct.partition_exprs)
            {
              _iter63.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetPartition_exprs()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TExpr _iter67 : struct.partition_exprs)
          {
            _iter67.write(oprot);
          }
        }
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.partition_exprs = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list77.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem78;
          for (int _i79 = 0; _i79 < _list77.size; ++_i79)
          {
            _elem78 = new io.datafibre.fibre.thrift.TExpr();
            _elem78.read(iprot);
