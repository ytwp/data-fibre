...
public enum ByteSizeUnit {
    ...
    KB {
        @Override
        public long toBytes(long size) {
            return check(size, C1 / C0, MAX / (C1 / C0));
        }
    ...
    MB {
        @Override
        public long toBytes(long size) {
            return check(size, C2 / C0, MAX / (C2 / C0));
        }

        @Override
        public long toKB(long size) {
            return check(size, C2 / C1, MAX / (C2 / C1));
        }
    ...
    GB {
        @Override
        public long toBytes(long size) {
            return check(size, C3 / C0, MAX / (C3 / C0));
        }

        @Override
        public long toKB(long size) {
            return check(size, C3 / C1, MAX / (C3 / C1));
        }

        @Override
        public long toMB(long size) {
            return check(size, C3 / C2, MAX / (C3 / C2));
        }
    ...
    TB {
        @Override
        public long toBytes(long size) {
            return check(size, C4 / C0, MAX / (C4 / C0));
        }

        @Override
        public long toKB(long size) {
            return check(size, C4 / C1, MAX / (C4 / C1));
        }

        @Override
        public long toMB(long size) {
            return check(size, C4 / C2, MAX / (C4 / C2));
        }

        @Override
        public long toGB(long size) {
            return check(size, C4 / C3, MAX / (C4 / C3));
        }
    ...
    PB {
        @Override
        public long toBytes(long size) {
            return check(size, C5 / C0, MAX / (C5 / C0));
        }

        @Override
        public long toKB(long size) {
            return check(size, C5 / C1, MAX / (C5 / C1));
        }

        @Override
        public long toMB(long size) {
            return check(size, C5 / C2, MAX / (C5 / C2));
        }

        @Override
        public long toGB(long size) {
            return check(size, C5 / C3, MAX / (C5 / C3));
        }

        @Override
        public long toTB(long size) {
            return check(size, C5 / C4, MAX / (C5 / C4));
        }
     ...
     */
    static long check(long d, long m, long over) {
        if (d > over) {
