...
public class TPluginMetaInfo implements org.apache.thrift.TBase<TPluginMetaInfo, TPluginMetaInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TPluginMetaInfo> {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.lang.String getSo_name() {
    return this.so_name;
  }

  public TPluginMetaInfo setSo_name(@org.apache.thrift.annotation.Nullable java.lang.String so_name) {
    this.so_name = so_name;
    return this;
  }

  public void unsetSo_name() {
    this.so_name = null;
  }

  /** Returns true if field so_name is set (has been assigned a value) and false otherwise */
  public boolean isSetSo_name() {
    return this.so_name != null;
  }

  public void setSo_nameIsSet(boolean value) {
    if (!value) {
      this.so_name = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case SO_NAME:
      if (value == null) {
        ...
        setSo_name((java.lang.String)value);
      }
      break;
  ...
  public boolean equals(TPluginMetaInfo that) {
    ...
    boolean this_present_so_name = true && this.isSetSo_name();
    boolean that_present_so_name = true && that.isSetSo_name();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetSo_name()) ? 131071 : 524287);
    if (isSetSo_name())
  ...
  public int compareTo(TPluginMetaInfo other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetSo_name(), other.isSetSo_name());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSo_name()) {
