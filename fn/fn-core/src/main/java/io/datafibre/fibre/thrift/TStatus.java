...
public class TStatus implements org.apache.thrift.TBase<TStatus, TStatus._Fields>, java.io.Serializable, Cloneable, Comparable<TStatus> {
  ...
  /**
   * 
   * @see io.datafibre.fibre.thrift.TStatusCode
   */
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TStatusCode status_code; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.STATUS_CODE, new org.apache.thrift.meta_data.FieldMetaData("status_code", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, io.datafibre.fibre.thrift.TStatusCode.class)));
  ...
  public TStatus(
    io.datafibre.fibre.thrift.TStatusCode status_code)
  {
    this();
   ...
   */
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TStatusCode getStatus_code() {
   ...
   * @see io.datafibre.fibre.thrift.TStatusCode
   */
  public TStatus setStatus_code(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TStatusCode status_code) {
    this.status_code = status_code;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.lang.String> getError_msgsIterator() {
    return (this.error_msgs == null) ? null : this.error_msgs.iterator();
  }

  public void addToError_msgs(java.lang.String elem) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.lang.String> getError_msgs() {
    return this.error_msgs;
  }

  public TStatus setError_msgs(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.String> error_msgs) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case STATUS_CODE:
      if (value == null) {
        ...
        setStatus_code((io.datafibre.fibre.thrift.TStatusCode)value);
      }
      break;
    ...
    case ERROR_MSGS:
      if (value == null) {
        ...
        setError_msgs((java.util.List<java.lang.String>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetError_msgs()) ? 131071 : 524287);
    if (isSetError_msgs())
  ...
  public int compareTo(TStatus other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetError_msgs(), other.isSetError_msgs());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetError_msgs()) {
        ...
        switch (schemeField.id) {
          case 1: // STATUS_CODE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.status_code = io.datafibre.fibre.thrift.TStatusCode.findByValue(iprot.readI32());
