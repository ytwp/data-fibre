...
public class TRemoteSnapshotRequest implements org.apache.thrift.TBase<TRemoteSnapshotRequest, TRemoteSnapshotRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TRemoteSnapshotRequest> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TBackend> src_backends; // optional
  ...
  public TRemoteSnapshotRequest setSrc_backends(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TBackend> src_backends) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.src_backends = new java.util.ArrayList<io.datafibre.fibre.thrift.TBackend>(_list188.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TBackend _elem189;
                for (int _i190 = 0; _i190 < _list188.size; ++_i190)
                {
                  _elem189 = new io.datafibre.fibre.thrift.TBackend();
                  _elem189.read(iprot);
      ...
      if (struct.src_backends != null) {
        if (struct.isSetSrc_backends()) {
          oprot.writeFieldBegin(SRC_BACKENDS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TBackend _iter191 : struct.src_backends)
            {
      ...
      if (struct.isSetSrc_backends()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TBackend _iter192 : struct.src_backends)
          {
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.src_backends = new java.util.ArrayList<io.datafibre.fibre.thrift.TBackend>(_list193.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TBackend _elem194;
          for (int _i195 = 0; _i195 < _list193.size; ++_i195)
          {
            _elem194 = new io.datafibre.fibre.thrift.TBackend();
            _elem194.read(iprot);
