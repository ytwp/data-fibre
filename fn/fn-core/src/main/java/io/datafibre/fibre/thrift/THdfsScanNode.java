...
public class THdfsScanNode implements org.apache.thrift.TBase<THdfsScanNode, THdfsScanNode._Fields>, java.io.Serializable, Cloneable, Comparable<THdfsScanNode> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>> DEPRECATED_collection_conjuncts; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> min_max_conjuncts; // optional
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> partition_conjuncts; // optional
  ...
  public THdfsScanNode(THdfsScanNode other) {
    ...
    if (other.isSetDEPRECATED_collection_conjuncts()) {
      java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>> __this__DEPRECATED_collection_conjuncts = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>>(other.DEPRECATED_collection_conjuncts.size());
      for (java.util.Map.Entry<java.lang.Integer, java.util.List<io.datafibre.fibre.thrift.TExpr>> other_element : other.DEPRECATED_collection_conjuncts.entrySet()) {
        ...
        java.util.List<io.datafibre.fibre.thrift.TExpr> __this__DEPRECATED_collection_conjuncts_copy_value = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(other_element_value.size());
        for (io.datafibre.fibre.thrift.TExpr other_element_value_element : other_element_value) {
          __this__DEPRECATED_collection_conjuncts_copy_value.add(new io.datafibre.fibre.thrift.TExpr(other_element_value_element));
        }
    ...
    if (other.isSetMin_max_conjuncts()) {
      java.util.List<io.datafibre.fibre.thrift.TExpr> __this__min_max_conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(other.min_max_conjuncts.size());
      for (io.datafibre.fibre.thrift.TExpr other_element : other.min_max_conjuncts) {
        __this__min_max_conjuncts.add(new io.datafibre.fibre.thrift.TExpr(other_element));
      }
    ...
    if (other.isSetPartition_conjuncts()) {
      java.util.List<io.datafibre.fibre.thrift.TExpr> __this__partition_conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(other.partition_conjuncts.size());
      for (io.datafibre.fibre.thrift.TExpr other_element : other.partition_conjuncts) {
        __this__partition_conjuncts.add(new io.datafibre.fibre.thrift.TExpr(other_element));
      }
  ...
  public void putToDEPRECATED_collection_conjuncts(int key, java.util.List<io.datafibre.fibre.thrift.TExpr> val) {
    if (this.DEPRECATED_collection_conjuncts == null) {
      this.DEPRECATED_collection_conjuncts = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>>();
    }
    this.DEPRECATED_collection_conjuncts.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>> getDEPRECATED_collection_conjuncts() {
    return this.DEPRECATED_collection_conjuncts;
  }

  public THdfsScanNode setDEPRECATED_collection_conjuncts(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>> DEPRECATED_collection_conjuncts) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TExpr> getMin_max_conjunctsIterator() {
    return (this.min_max_conjuncts == null) ? null : this.min_max_conjuncts.iterator();
  }

  public void addToMin_max_conjuncts(io.datafibre.fibre.thrift.TExpr elem) {
    if (this.min_max_conjuncts == null) {
      this.min_max_conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>();
    }
    this.min_max_conjuncts.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TExpr> getMin_max_conjuncts() {
    return this.min_max_conjuncts;
  }

  public THdfsScanNode setMin_max_conjuncts(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> min_max_conjuncts) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TExpr> getPartition_conjunctsIterator() {
    return (this.partition_conjuncts == null) ? null : this.partition_conjuncts.iterator();
  }

  public void addToPartition_conjuncts(io.datafibre.fibre.thrift.TExpr elem) {
    if (this.partition_conjuncts == null) {
      this.partition_conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>();
    }
    this.partition_conjuncts.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TExpr> getPartition_conjuncts() {
    return this.partition_conjuncts;
  }

  public THdfsScanNode setPartition_conjuncts(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> partition_conjuncts) {
  ...
  public THdfsScanNode setCloud_configuration(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TCloudConfiguration cloud_configuration) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case DEPRECATED_COLLECTION_CONJUNCTS:
      if (value == null) {
        ...
        setDEPRECATED_collection_conjuncts((java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>>)value);
      }
      break;
    ...
    case MIN_MAX_CONJUNCTS:
      if (value == null) {
        ...
        setMin_max_conjuncts((java.util.List<io.datafibre.fibre.thrift.TExpr>)value);
      }
      break;
    ...
    case PARTITION_CONJUNCTS:
      if (value == null) {
        ...
        setPartition_conjuncts((java.util.List<io.datafibre.fibre.thrift.TExpr>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.DEPRECATED_collection_conjuncts = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>>(2*_map796.size);
                int _key797;
                @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _val798;
                for (int _i799 = 0; _i799 < _map796.size; ++_i799)
                {
                  _key797 = iprot.readI32();
                  {
                    ...
                    _val798 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list800.size);
                    @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem801;
                    for (int _i802 = 0; _i802 < _list800.size; ++_i802)
                    {
                      _elem801 = new io.datafibre.fibre.thrift.TExpr();
                      _elem801.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.min_max_conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list803.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem804;
                for (int _i805 = 0; _i805 < _list803.size; ++_i805)
                {
                  _elem804 = new io.datafibre.fibre.thrift.TExpr();
                  _elem804.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list813.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem814;
                for (int _i815 = 0; _i815 < _list813.size; ++_i815)
                {
                  _elem814 = new io.datafibre.fibre.thrift.TExpr();
                  _elem814.read(iprot);
      ...
      if (struct.DEPRECATED_collection_conjuncts != null) {
        if (struct.isSetDEPRECATED_collection_conjuncts()) {
          oprot.writeFieldBegin(DEPRECATED_COLLECTION_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, java.util.List<io.datafibre.fibre.thrift.TExpr>> _iter819 : struct.DEPRECATED_collection_conjuncts.entrySet())
            {
              oprot.writeI32(_iter819.getKey());
              {
                ...
                for (io.datafibre.fibre.thrift.TExpr _iter820 : _iter819.getValue())
                {
      ...
      if (struct.min_max_conjuncts != null) {
        if (struct.isSetMin_max_conjuncts()) {
          oprot.writeFieldBegin(MIN_MAX_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TExpr _iter821 : struct.min_max_conjuncts)
            {
      ...
      if (struct.partition_conjuncts != null) {
        if (struct.isSetPartition_conjuncts()) {
          oprot.writeFieldBegin(PARTITION_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TExpr _iter824 : struct.partition_conjuncts)
            {
      ...
      if (struct.isSetDEPRECATED_collection_conjuncts()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.util.List<io.datafibre.fibre.thrift.TExpr>> _iter826 : struct.DEPRECATED_collection_conjuncts.entrySet())
          {
            oprot.writeI32(_iter826.getKey());
            {
              oprot.writeI32(_iter826.getValue().size());
              for (io.datafibre.fibre.thrift.TExpr _iter827 : _iter826.getValue())
              {
      ...
      if (struct.isSetMin_max_conjuncts()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TExpr _iter828 : struct.min_max_conjuncts)
          {
      ...
      if (struct.isSetPartition_conjuncts()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TExpr _iter831 : struct.partition_conjuncts)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.DEPRECATED_collection_conjuncts = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TExpr>>(2*_map833.size);
          int _key834;
          @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _val835;
          for (int _i836 = 0; _i836 < _map833.size; ++_i836)
          {
            _key834 = iprot.readI32();
            {
              ...
              _val835 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list837.size);
              @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem838;
              for (int _i839 = 0; _i839 < _list837.size; ++_i839)
              {
                _elem838 = new io.datafibre.fibre.thrift.TExpr();
                _elem838.read(iprot);
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.min_max_conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list840.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem841;
          for (int _i842 = 0; _i842 < _list840.size; ++_i842)
          {
            _elem841 = new io.datafibre.fibre.thrift.TExpr();
            _elem841.read(iprot);
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.partition_conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list850.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem851;
          for (int _i852 = 0; _i852 < _list850.size; ++_i852)
          {
            _elem851 = new io.datafibre.fibre.thrift.TExpr();
            _elem851.read(iprot);
