...
public class TMergeJoinNode implements org.apache.thrift.TBase<TMergeJoinNode, TMergeJoinNode._Fields>, java.io.Serializable, Cloneable, Comparable<TMergeJoinNode> {
  ...
  public TMergeJoinNode setOther_join_conjuncts(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> other_join_conjuncts) {
  ...
  public TMergeJoinNode setBuild_runtime_filters(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TRuntimeFilterDescription> build_runtime_filters) {
  ...
  public TMergeJoinNode setPartition_exprs(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> partition_exprs) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.other_join_conjuncts = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list405.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem406;
                for (int _i407 = 0; _i407 < _list405.size; ++_i407)
                {
                  _elem406 = new com.starrocks.thrift.TExpr();
                  _elem406.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.build_runtime_filters = new java.util.ArrayList<com.starrocks.thrift.TRuntimeFilterDescription>(_list408.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TRuntimeFilterDescription _elem409;
                for (int _i410 = 0; _i410 < _list408.size; ++_i410)
                {
                  _elem409 = new com.starrocks.thrift.TRuntimeFilterDescription();
                  _elem409.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list411.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem412;
                for (int _i413 = 0; _i413 < _list411.size; ++_i413)
                {
                  _elem412 = new com.starrocks.thrift.TExpr();
                  _elem412.read(iprot);
      ...
      if (struct.other_join_conjuncts != null) {
        if (struct.isSetOther_join_conjuncts()) {
          oprot.writeFieldBegin(OTHER_JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter418 : struct.other_join_conjuncts)
            {
      ...
      if (struct.build_runtime_filters != null) {
        if (struct.isSetBuild_runtime_filters()) {
          oprot.writeFieldBegin(BUILD_RUNTIME_FILTERS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TRuntimeFilterDescription _iter419 : struct.build_runtime_filters)
            {
      ...
      if (struct.partition_exprs != null) {
        if (struct.isSetPartition_exprs()) {
          oprot.writeFieldBegin(PARTITION_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter420 : struct.partition_exprs)
            {
      ...
      if (struct.isSetOther_join_conjuncts()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter423 : struct.other_join_conjuncts)
          {
      ...
      if (struct.isSetBuild_runtime_filters()) {
        {
          ...
          for (com.starrocks.thrift.TRuntimeFilterDescription _iter424 : struct.build_runtime_filters)
          {
      ...
      if (struct.isSetPartition_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter425 : struct.partition_exprs)
          {
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.other_join_conjuncts = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list430.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem431;
          for (int _i432 = 0; _i432 < _list430.size; ++_i432)
          {
            _elem431 = new com.starrocks.thrift.TExpr();
            _elem431.read(iprot);
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.build_runtime_filters = new java.util.ArrayList<com.starrocks.thrift.TRuntimeFilterDescription>(_list433.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TRuntimeFilterDescription _elem434;
          for (int _i435 = 0; _i435 < _list433.size; ++_i435)
          {
            _elem434 = new com.starrocks.thrift.TRuntimeFilterDescription();
            _elem434.read(iprot);
      ...
      if (incoming.get(11)) {
        {
          ...
          struct.partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list436.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem437;
          for (int _i438 = 0; _i438 < _list436.size; ++_i438)
          {
            _elem437 = new com.starrocks.thrift.TExpr();
            _elem437.read(iprot);
