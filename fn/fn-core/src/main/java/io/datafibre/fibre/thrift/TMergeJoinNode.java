...
public class TMergeJoinNode implements org.apache.thrift.TBase<TMergeJoinNode, TMergeJoinNode._Fields>, java.io.Serializable, Cloneable, Comparable<TMergeJoinNode> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<TEqJoinCondition> eq_join_conjuncts; // optional
  ...
  private static final _Fields optionals[] = {_Fields.JOIN_OP,_Fields.EQ_JOIN_CONJUNCTS,_Fields.OTHER_JOIN_CONJUNCTS,_Fields.IS_PUSH_DOWN,_Fields.ADD_PROBE_FILTERS,_Fields.IS_REWRITTEN_FROM_NOT_IN,_Fields.SQL_JOIN_PREDICATES,_Fields.SQL_PREDICATES,_Fields.BUILD_RUNTIME_FILTERS,_Fields.BUILD_RUNTIME_FILTERS_FROM_PLANNER,_Fields.DISTRIBUTION_MODE,_Fields.PARTITION_EXPRS,_Fields.OUTPUT_COLUMNS};
   ...
   * @see TJoinOp
   */
  public TMergeJoinNode setJoin_op(@org.apache.thrift.annotation.Nullable TJoinOp join_op) {
  ...
  public TMergeJoinNode setEq_join_conjuncts(@org.apache.thrift.annotation.Nullable java.util.List<TEqJoinCondition> eq_join_conjuncts) {
  ...
  public TMergeJoinNode setOther_join_conjuncts(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> other_join_conjuncts) {
  ...
  public TMergeJoinNode setIs_push_down(boolean is_push_down) {
  ...
  public TMergeJoinNode setAdd_probe_filters(boolean add_probe_filters) {
  ...
  public TMergeJoinNode setIs_rewritten_from_not_in(boolean is_rewritten_from_not_in) {
  ...
  public TMergeJoinNode setSql_join_predicates(@org.apache.thrift.annotation.Nullable java.lang.String sql_join_predicates) {
  ...
  public TMergeJoinNode setSql_predicates(@org.apache.thrift.annotation.Nullable java.lang.String sql_predicates) {
  ...
  public TMergeJoinNode setBuild_runtime_filters(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TRuntimeFilterDescription> build_runtime_filters) {
  ...
  public TMergeJoinNode setBuild_runtime_filters_from_planner(boolean build_runtime_filters_from_planner) {
   ...
   * @see TJoinDistributionMode
   */
  public TMergeJoinNode setDistribution_mode(@org.apache.thrift.annotation.Nullable TJoinDistributionMode distribution_mode) {
  ...
  public TMergeJoinNode setPartition_exprs(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> partition_exprs) {
  ...
  public TMergeJoinNode setOutput_columns(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> output_columns) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.eq_join_conjuncts = new java.util.ArrayList<TEqJoinCondition>(_list402.size);
                @org.apache.thrift.annotation.Nullable TEqJoinCondition _elem403;
                for (int _i404 = 0; _i404 < _list402.size; ++_i404)
                {
                  _elem403 = new TEqJoinCondition();
                  _elem403.read(iprot);
                  struct.eq_join_conjuncts.add(_elem403);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.other_join_conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list405.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem406;
                for (int _i407 = 0; _i407 < _list405.size; ++_i407)
                {
                  _elem406 = new io.datafibre.fibre.thrift.TExpr();
                  _elem406.read(iprot);
                  struct.other_join_conjuncts.add(_elem406);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.build_runtime_filters = new java.util.ArrayList<io.datafibre.fibre.thrift.TRuntimeFilterDescription>(_list408.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TRuntimeFilterDescription _elem409;
                for (int _i410 = 0; _i410 < _list408.size; ++_i410)
                {
                  _elem409 = new io.datafibre.fibre.thrift.TRuntimeFilterDescription();
                  _elem409.read(iprot);
                  struct.build_runtime_filters.add(_elem409);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_exprs = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list411.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem412;
                for (int _i413 = 0; _i413 < _list411.size; ++_i413)
                {
                  _elem412 = new io.datafibre.fibre.thrift.TExpr();
                  _elem412.read(iprot);
                  struct.partition_exprs.add(_elem412);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.output_columns = new java.util.ArrayList<java.lang.Integer>(_list414.size);
                int _elem415;
                for (int _i416 = 0; _i416 < _list414.size; ++_i416)
                {
                  _elem415 = iprot.readI32();
                  struct.output_columns.add(_elem415);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.eq_join_conjuncts != null) {
        if (struct.isSetEq_join_conjuncts()) {
          oprot.writeFieldBegin(EQ_JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (TEqJoinCondition _iter417 : struct.eq_join_conjuncts)
            {
      ...
      if (struct.other_join_conjuncts != null) {
        if (struct.isSetOther_join_conjuncts()) {
          oprot.writeFieldBegin(OTHER_JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TExpr _iter418 : struct.other_join_conjuncts)
            {
      ...
      if (struct.build_runtime_filters != null) {
        if (struct.isSetBuild_runtime_filters()) {
          oprot.writeFieldBegin(BUILD_RUNTIME_FILTERS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TRuntimeFilterDescription _iter419 : struct.build_runtime_filters)
            {
      ...
      if (struct.partition_exprs != null) {
        if (struct.isSetPartition_exprs()) {
          oprot.writeFieldBegin(PARTITION_EXPRS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TExpr _iter420 : struct.partition_exprs)
            {
      ...
      if (struct.output_columns != null) {
        if (struct.isSetOutput_columns()) {
          oprot.writeFieldBegin(OUTPUT_COLUMNS_FIELD_DESC);
          {
            ...
            for (int _iter421 : struct.output_columns)
            {
  ...
  private static class TMergeJoinNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TMergeJoinNode> {
      ...
      if (struct.isSetEq_join_conjuncts()) {
        {
          ...
          for (TEqJoinCondition _iter422 : struct.eq_join_conjuncts)
          {
      ...
      if (struct.isSetOther_join_conjuncts()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TExpr _iter423 : struct.other_join_conjuncts)
          {
      ...
      if (struct.isSetBuild_runtime_filters()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TRuntimeFilterDescription _iter424 : struct.build_runtime_filters)
          {
      ...
      if (struct.isSetPartition_exprs()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TExpr _iter425 : struct.partition_exprs)
          {
      ...
      if (struct.isSetOutput_columns()) {
        {
          ...
          for (int _iter426 : struct.output_columns)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TMergeJoinNode struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.eq_join_conjuncts = new java.util.ArrayList<TEqJoinCondition>(_list427.size);
          @org.apache.thrift.annotation.Nullable TEqJoinCondition _elem428;
          for (int _i429 = 0; _i429 < _list427.size; ++_i429)
          {
            _elem428 = new TEqJoinCondition();
            _elem428.read(iprot);
            struct.eq_join_conjuncts.add(_elem428);
          }
        }
        struct.setEq_join_conjunctsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.other_join_conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list430.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem431;
          for (int _i432 = 0; _i432 < _list430.size; ++_i432)
          {
            _elem431 = new io.datafibre.fibre.thrift.TExpr();
            _elem431.read(iprot);
            struct.other_join_conjuncts.add(_elem431);
          }
        }
        struct.setOther_join_conjunctsIsSet(true);
      }
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.build_runtime_filters = new java.util.ArrayList<io.datafibre.fibre.thrift.TRuntimeFilterDescription>(_list433.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TRuntimeFilterDescription _elem434;
          for (int _i435 = 0; _i435 < _list433.size; ++_i435)
          {
            _elem434 = new io.datafibre.fibre.thrift.TRuntimeFilterDescription();
            _elem434.read(iprot);
            struct.build_runtime_filters.add(_elem434);
          }
        }
        struct.setBuild_runtime_filtersIsSet(true);
      }
      ...
      if (incoming.get(11)) {
        {
          org.apache.thrift.protocol.TList _list436 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.partition_exprs = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list436.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem437;
          for (int _i438 = 0; _i438 < _list436.size; ++_i438)
          {
            _elem437 = new io.datafibre.fibre.thrift.TExpr();
            _elem437.read(iprot);
            struct.partition_exprs.add(_elem437);
          }
        }
        struct.setPartition_exprsIsSet(true);
      }
      if (incoming.get(12)) {
        {
          ...
          struct.output_columns = new java.util.ArrayList<java.lang.Integer>(_list439.size);
          int _elem440;
          for (int _i441 = 0; _i441 < _list439.size; ++_i441)
          {
            _elem440 = iprot.readI32();
            struct.output_columns.add(_elem440);
          }
        }
        struct.setOutput_columnsIsSet(true);
      }
