...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/main/java/org/apache/doris/mysql/MysqlColType.java
...
public enum MysqlColType {
    ...
    MYSQL_TYPE_VAR_STRING(253, "VAR STRING"),
