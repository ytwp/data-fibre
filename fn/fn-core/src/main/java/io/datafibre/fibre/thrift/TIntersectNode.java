...
public class TIntersectNode implements org.apache.thrift.TBase<TIntersectNode, TIntersectNode._Fields>, java.io.Serializable, Cloneable, Comparable<TIntersectNode> {
  ...
  public TIntersectNode setResult_expr_lists(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>> result_expr_lists) {
    this.result_expr_lists = result_expr_lists;
    return this;
  }
  ...
  public TIntersectNode setConst_expr_lists(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<io.datafibre.fibre.thrift.TExpr>> const_expr_lists) {
    this.const_expr_lists = const_expr_lists;
    return this;
  }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.result_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(_list724.size);
                @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _elem725;
                for (int _i726 = 0; _i726 < _list724.size; ++_i726)
                {
                  {
                    org.apache.thrift.protocol.TList _list727 = iprot.readListBegin();
                    _elem725 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list727.size);
                    @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem728;
                    for (int _i729 = 0; _i729 < _list727.size; ++_i729)
                    {
                      _elem728 = new io.datafibre.fibre.thrift.TExpr();
                      _elem728.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.const_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(_list730.size);
                @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _elem731;
                for (int _i732 = 0; _i732 < _list730.size; ++_i732)
                {
                  {
                    org.apache.thrift.protocol.TList _list733 = iprot.readListBegin();
                    _elem731 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list733.size);
                    @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem734;
                    for (int _i735 = 0; _i735 < _list733.size; ++_i735)
                    {
                      _elem734 = new io.datafibre.fibre.thrift.TExpr();
                      _elem734.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TIntersectNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.result_expr_lists != null) {
        oprot.writeFieldBegin(RESULT_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<io.datafibre.fibre.thrift.TExpr> _iter736 : struct.result_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter736.size()));
              for (io.datafibre.fibre.thrift.TExpr _iter737 : _iter736)
              {
      ...
      if (struct.const_expr_lists != null) {
        oprot.writeFieldBegin(CONST_EXPR_LISTS_FIELD_DESC);
        {
          ...
          for (java.util.List<io.datafibre.fibre.thrift.TExpr> _iter738 : struct.const_expr_lists)
          {
            {
              oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter738.size()));
              for (io.datafibre.fibre.thrift.TExpr _iter739 : _iter738)
              {
  ...
  private static class TIntersectNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TIntersectNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TIntersectNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.tuple_id);
      {
        ...
        for (java.util.List<io.datafibre.fibre.thrift.TExpr> _iter740 : struct.result_expr_lists)
        {
          {
            oprot.writeI32(_iter740.size());
            for (io.datafibre.fibre.thrift.TExpr _iter741 : _iter740)
            {
      ...
      }
      {
        ...
        for (java.util.List<io.datafibre.fibre.thrift.TExpr> _iter742 : struct.const_expr_lists)
        {
          {
            oprot.writeI32(_iter742.size());
            for (io.datafibre.fibre.thrift.TExpr _iter743 : _iter742)
            {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TIntersectNode struct) throws org.apache.thrift.TException {
      ...
      struct.setTuple_idIsSet(true);
      {
        ...
        struct.result_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(_list744.size);
        @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _elem745;
        ...
        {
          {
            ...
            _elem745 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list747.size);
            @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem748;
            for (int _i749 = 0; _i749 < _list747.size; ++_i749)
            {
              _elem748 = new io.datafibre.fibre.thrift.TExpr();
              _elem748.read(iprot);
      ...
      struct.setResult_expr_listsIsSet(true);
      {
        ...
        struct.const_expr_lists = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExpr>>(_list750.size);
        @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> _elem751;
        ...
        {
          {
            ...
            _elem751 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list753.size);
            @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem754;
            for (int _i755 = 0; _i755 < _list753.size; ++_i755)
            {
              _elem754 = new io.datafibre.fibre.thrift.TExpr();
              _elem754.read(iprot);
