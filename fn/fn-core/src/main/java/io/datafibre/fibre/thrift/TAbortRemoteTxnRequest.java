...
public class TAbortRemoteTxnRequest implements org.apache.thrift.TBase<TAbortRemoteTxnRequest, TAbortRemoteTxnRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TAbortRemoteTxnRequest> {
  ...
  public TAbortRemoteTxnRequest setCommit_infos(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TTabletCommitInfo> commit_infos) {
  ...
  public TAbortRemoteTxnRequest setFail_infos(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TTabletFailInfo> fail_infos) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commit_infos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletCommitInfo>(_list566.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletCommitInfo _elem567;
                for (int _i568 = 0; _i568 < _list566.size; ++_i568)
                {
                  _elem567 = new io.datafibre.fibre.thrift.TTabletCommitInfo();
                  _elem567.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fail_infos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletFailInfo>(_list569.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletFailInfo _elem570;
                for (int _i571 = 0; _i571 < _list569.size; ++_i571)
                {
                  _elem570 = new io.datafibre.fibre.thrift.TTabletFailInfo();
                  _elem570.read(iprot);
      ...
      if (struct.commit_infos != null) {
        if (struct.isSetCommit_infos()) {
          oprot.writeFieldBegin(COMMIT_INFOS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TTabletCommitInfo _iter572 : struct.commit_infos)
            {
      ...
      if (struct.fail_infos != null) {
        if (struct.isSetFail_infos()) {
          oprot.writeFieldBegin(FAIL_INFOS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TTabletFailInfo _iter573 : struct.fail_infos)
            {
      ...
      if (struct.isSetCommit_infos()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TTabletCommitInfo _iter574 : struct.commit_infos)
          {
      ...
      if (struct.isSetFail_infos()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TTabletFailInfo _iter575 : struct.fail_infos)
          {
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.commit_infos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletCommitInfo>(_list576.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletCommitInfo _elem577;
          for (int _i578 = 0; _i578 < _list576.size; ++_i578)
          {
            _elem577 = new io.datafibre.fibre.thrift.TTabletCommitInfo();
            _elem577.read(iprot);
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.fail_infos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletFailInfo>(_list579.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletFailInfo _elem580;
          for (int _i581 = 0; _i581 < _list579.size; ++_i581)
          {
            _elem580 = new io.datafibre.fibre.thrift.TTabletFailInfo();
            _elem580.read(iprot);
