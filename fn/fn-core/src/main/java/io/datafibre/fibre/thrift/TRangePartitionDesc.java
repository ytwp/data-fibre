...
public class TRangePartitionDesc implements org.apache.thrift.TBase<TRangePartitionDesc, TRangePartitionDesc._Fields>, java.io.Serializable, Cloneable, Comparable<TRangePartitionDesc> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Long,TRange> ranges; // optional
  ...
  private static final _Fields optionals[] = {_Fields.COLUMNS,_Fields.RANGES};
  ...
  static {
    ...
    tmpMap.put(_Fields.RANGES, new org.apache.thrift.meta_data.FieldMetaData("ranges", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            ...
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TRange.class))));
  ...
  public TRangePartitionDesc(TRangePartitionDesc other) {
    ...
    if (other.isSetRanges()) {
      java.util.Map<java.lang.Long,TRange> __this__ranges = new java.util.HashMap<java.lang.Long,TRange>(other.ranges.size());
      for (java.util.Map.Entry<java.lang.Long, TRange> other_element : other.ranges.entrySet()) {

        java.lang.Long other_element_key = other_element.getKey();
        TRange other_element_value = other_element.getValue();

        java.lang.Long __this__ranges_copy_key = other_element_key;

        TRange __this__ranges_copy_value = new TRange(other_element_value);
  ...
  public TRangePartitionDesc setColumns(@org.apache.thrift.annotation.Nullable java.util.List<TColumnMeta> columns) {
  ...
  public void putToRanges(long key, TRange val) {
    if (this.ranges == null) {
      this.ranges = new java.util.HashMap<java.lang.Long,TRange>();
    }
    this.ranges.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.Long,TRange> getRanges() {
    return this.ranges;
  }

  public TRangePartitionDesc setRanges(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Long,TRange> ranges) {
    this.ranges = ranges;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case RANGES:
      if (value == null) {
        ...
        setRanges((java.util.Map<java.lang.Long,TRange>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<TColumnMeta>(_list466.size);
                @org.apache.thrift.annotation.Nullable TColumnMeta _elem467;
                for (int _i468 = 0; _i468 < _list466.size; ++_i468)
                {
                  _elem467 = new TColumnMeta();
                  _elem467.read(iprot);
                  struct.columns.add(_elem467);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.ranges = new java.util.HashMap<java.lang.Long,TRange>(2*_map469.size);
                long _key470;
                @org.apache.thrift.annotation.Nullable TRange _val471;
                for (int _i472 = 0; _i472 < _map469.size; ++_i472)
                {
                  _key470 = iprot.readI64();
                  _val471 = new TRange();
                  _val471.read(iprot);
                  struct.ranges.put(_key470, _val471);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRangePartitionDesc struct) throws org.apache.thrift.TException {
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (TColumnMeta _iter473 : struct.columns)
            {
      ...
      if (struct.ranges != null) {
        if (struct.isSetRanges()) {
          ...
          {
            oprot.writeMapBegin(new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT, struct.ranges.size()));
            for (java.util.Map.Entry<java.lang.Long, TRange> _iter474 : struct.ranges.entrySet())
            {
              oprot.writeI64(_iter474.getKey());
  ...
  private static class TRangePartitionDescTupleScheme extends org.apache.thrift.scheme.TupleScheme<TRangePartitionDesc> {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (TColumnMeta _iter475 : struct.columns)
          {
      ...
      if (struct.isSetRanges()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Long, TRange> _iter476 : struct.ranges.entrySet())
          {
            oprot.writeI64(_iter476.getKey());
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TRangePartitionDesc struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.columns = new java.util.ArrayList<TColumnMeta>(_list477.size);
          @org.apache.thrift.annotation.Nullable TColumnMeta _elem478;
          for (int _i479 = 0; _i479 < _list477.size; ++_i479)
          {
            _elem478 = new TColumnMeta();
            _elem478.read(iprot);
      ...
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TMap _map480 = iprot.readMapBegin(org.apache.thrift.protocol.TType.I64, org.apache.thrift.protocol.TType.STRUCT); 
          struct.ranges = new java.util.HashMap<java.lang.Long,TRange>(2*_map480.size);
          long _key481;
          @org.apache.thrift.annotation.Nullable TRange _val482;
          for (int _i483 = 0; _i483 < _map480.size; ++_i483)
          {
            _key481 = iprot.readI64();
            _val482 = new TRange();
            _val482.read(iprot);
            struct.ranges.put(_key481, _val482);
          }
        }
        struct.setRangesIsSet(true);
      }
