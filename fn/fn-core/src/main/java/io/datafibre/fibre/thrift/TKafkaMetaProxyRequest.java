...
public class TKafkaMetaProxyRequest implements org.apache.thrift.TBase<TKafkaMetaProxyRequest, TKafkaMetaProxyRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TKafkaMetaProxyRequest> {
  ...
  @org.apache.thrift.annotation.Nullable
  public TKafkaLoadInfo getKafka_info() {
    return this.kafka_info;
  }

  public TKafkaMetaProxyRequest setKafka_info(@org.apache.thrift.annotation.Nullable TKafkaLoadInfo kafka_info) {
    this.kafka_info = kafka_info;
    return this;
  }

  public void unsetKafka_info() {
    this.kafka_info = null;
  }

  /** Returns true if field kafka_info is set (has been assigned a value) and false otherwise */
  public boolean isSetKafka_info() {
    return this.kafka_info != null;
  }

  public void setKafka_infoIsSet(boolean value) {
    if (!value) {
      this.kafka_info = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case KAFKA_INFO:
      if (value == null) {
        ...
        setKafka_info((TKafkaLoadInfo)value);
      }
      break;
  ...
  public boolean equals(TKafkaMetaProxyRequest that) {
    ...
    boolean this_present_kafka_info = true && this.isSetKafka_info();
    boolean that_present_kafka_info = true && that.isSetKafka_info();
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetKafka_info()) ? 131071 : 524287);
    if (isSetKafka_info())
  ...
  public int compareTo(TKafkaMetaProxyRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetKafka_info(), other.isSetKafka_info());
    if (lastComparison != 0) {
        ...
        switch (schemeField.id) {
          case 1: // KAFKA_INFO
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              ...
              struct.setKafka_infoIsSet(true);
            } else { 
