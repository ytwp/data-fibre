...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/main/java/org/apache/doris/plugin/PluginInfo.java
...
public class PluginInfo implements Writable {
    ...
    public static PluginInfo readFromProperties(final Path propertiesPath, final String source) throws IOException {
        ...
        // version check
        if (version.before(DigitalVersion.CURRENT_STARROCKS_VERSION)) {
