...
public class TDownloadReq implements org.apache.thrift.TBase<TDownloadReq, TDownloadReq._Fields>, java.io.Serializable, Cloneable, Comparable<TDownloadReq> {
  ...
  private static final org.apache.thrift.protocol.TField HDFS_READ_BUFFER_SIZE_KB_FIELD_DESC = new org.apache.thrift.protocol.TField("hdfs_read_buffer_size_kb", org.apache.thrift.protocol.TType.I32, (short)6);
  ...
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TNetworkAddress broker_addr; // required
  ...
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.THdfsProperties hdfs_properties; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    HDFS_READ_BUFFER_SIZE_KB((short)6, "hdfs_read_buffer_size_kb"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 5: // USE_BROKER
          return USE_BROKER;
        case 6: // HDFS_READ_BUFFER_SIZE_KB
  ...
  private static final int __HDFS_READ_BUFFER_SIZE_KB_ISSET_ID = 2;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.BROKER_PROP,_Fields.USE_BROKER,_Fields.HDFS_READ_BUFFER_SIZE_KB,_Fields.HDFS_PROPERTIES};
  ...
  static {
    ...
    tmpMap.put(_Fields.HDFS_PROPERTIES, new org.apache.thrift.meta_data.FieldMetaData("hdfs_properties", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, io.datafibre.fibre.thrift.THdfsProperties.class)));
  ...
  public TDownloadReq(
    ...
    io.datafibre.fibre.thrift.TNetworkAddress broker_addr)
  {
    this();
    this.job_id = job_id;
    setJob_idIsSet(true);
  ...
  public TDownloadReq(TDownloadReq other) {
    ...
    if (other.isSetBroker_addr()) {
      this.broker_addr = new io.datafibre.fibre.thrift.TNetworkAddress(other.broker_addr);
    }
    ...
    if (other.isSetHdfs_properties()) {
      this.hdfs_properties = new io.datafibre.fibre.thrift.THdfsProperties(other.hdfs_properties);
    }
  }
  ...
  public TDownloadReq setJob_id(long job_id) {
    this.job_id = job_id;
    setJob_idIsSet(true);
    return this;
  }
  ...
  public TDownloadReq setSrc_dest_map(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> src_dest_map) {
    this.src_dest_map = src_dest_map;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TNetworkAddress getBroker_addr() {
    return this.broker_addr;
  }

  public TDownloadReq setBroker_addr(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TNetworkAddress broker_addr) {
    this.broker_addr = broker_addr;
    return this;
  }
  ...
  public TDownloadReq setBroker_prop(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.String> broker_prop) {
  ...
  public TDownloadReq setUse_broker(boolean use_broker) {
  ...
  public TDownloadReq setHdfs_read_buffer_size_kb(int hdfs_read_buffer_size_kb) {
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.THdfsProperties getHdfs_properties() {
    return this.hdfs_properties;
  }

  public TDownloadReq setHdfs_properties(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.THdfsProperties hdfs_properties) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case BROKER_ADDR:
      if (value == null) {
        ...
        setBroker_addr((io.datafibre.fibre.thrift.TNetworkAddress)value);
      }
      break;
    ...
    case HDFS_PROPERTIES:
      if (value == null) {
        ...
        setHdfs_properties((io.datafibre.fibre.thrift.THdfsProperties)value);
      }
      break;
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.src_dest_map = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map126.size);
                ...
                for (int _i129 = 0; _i129 < _map126.size; ++_i129)
                {
                  ...
                  struct.src_dest_map.put(_key127, _val128);
                }
                iprot.readMapEnd();
              }
          ...
          case 3: // BROKER_ADDR
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.broker_addr = new io.datafibre.fibre.thrift.TNetworkAddress();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.broker_prop = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map130.size);
                ...
                for (int _i133 = 0; _i133 < _map130.size; ++_i133)
                {
                  ...
                  struct.broker_prop.put(_key131, _val132);
                }
                iprot.readMapEnd();
              }
          ...
          case 7: // HDFS_PROPERTIES
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.hdfs_properties = new io.datafibre.fibre.thrift.THdfsProperties();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TDownloadReq struct) throws org.apache.thrift.TException {
      ...
      if (struct.src_dest_map != null) {
        oprot.writeFieldBegin(SRC_DEST_MAP_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter134 : struct.src_dest_map.entrySet())
          {
      ...
      if (struct.broker_prop != null) {
        if (struct.isSetBroker_prop()) {
          oprot.writeFieldBegin(BROKER_PROP_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter135 : struct.broker_prop.entrySet())
            {
  ...
  private static class TDownloadReqTupleScheme extends org.apache.thrift.scheme.TupleScheme<TDownloadReq> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TDownloadReq struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.job_id);
      {
        ...
        for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter136 : struct.src_dest_map.entrySet())
        {
      ...
      if (struct.isSetBroker_prop()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter137 : struct.broker_prop.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TDownloadReq struct) throws org.apache.thrift.TException {
      ...
      struct.setJob_idIsSet(true);
      {
        org.apache.thrift.protocol.TMap _map138 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
        struct.src_dest_map = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map138.size);
        ...
        for (int _i141 = 0; _i141 < _map138.size; ++_i141)
        {
          ...
          struct.src_dest_map.put(_key139, _val140);
        }
      }
      struct.setSrc_dest_mapIsSet(true);
      struct.broker_addr = new io.datafibre.fibre.thrift.TNetworkAddress();
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map142 = iprot.readMapBegin(org.apache.thrift.protocol.TType.STRING, org.apache.thrift.protocol.TType.STRING); 
          struct.broker_prop = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map142.size);
          ...
          for (int _i145 = 0; _i145 < _map142.size; ++_i145)
          {
            ...
            struct.broker_prop.put(_key143, _val144);
          }
        }
        struct.setBroker_propIsSet(true);
      }
