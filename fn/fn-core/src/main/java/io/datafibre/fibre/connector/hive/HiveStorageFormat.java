...
import static io.datafibre.fibre.connector.hive.HiveClassNames.AVRO_OUTPUT_FORMAT_CLASS;
import static io.datafibre.fibre.connector.hive.HiveClassNames.AVRO_SERDE_CLASS;
import static io.datafibre.fibre.connector.hive.HiveClassNames.COLUMNAR_SERDE_CLASS;
import static io.datafibre.fibre.connector.hive.HiveClassNames.HIVE_IGNORE_KEY_OUTPUT_FORMAT_CLASS;
import static io.datafibre.fibre.connector.hive.HiveClassNames.LAZY_BINARY_COLUMNAR_SERDE_CLASS;
import static io.datafibre.fibre.connector.hive.HiveClassNames.LAZY_SIMPLE_SERDE_CLASS;
import static io.datafibre.fibre.connector.hive.HiveClassNames.MAPRED_PARQUET_INPUT_FORMAT_CLASS;
import static io.datafibre.fibre.connector.hive.HiveClassNames.MAPRED_PARQUET_OUTPUT_FORMAT_CLASS;
import static io.datafibre.fibre.connector.hive.HiveClassNames.ORC_INPUT_FORMAT_CLASS;
import static io.datafibre.fibre.connector.hive.HiveClassNames.ORC_OUTPUT_FORMAT_CLASS;
import static io.datafibre.fibre.connector.hive.HiveClassNames.ORC_SERDE_CLASS;
import static io.datafibre.fibre.connector.hive.HiveClassNames.PARQUET_HIVE_SERDE_CLASS;
import static io.datafibre.fibre.connector.hive.HiveClassNames.RCFILE_INPUT_FORMAT_CLASS;
import static io.datafibre.fibre.connector.hive.HiveClassNames.RCFILE_OUTPUT_FORMAT_CLASS;
import static io.datafibre.fibre.connector.hive.HiveClassNames.SEQUENCE_INPUT_FORMAT_CLASS;
import static io.datafibre.fibre.connector.hive.HiveClassNames.SEQUENCE_OUTPUT_FORMAT_CLASS;
import static io.datafibre.fibre.connector.hive.HiveClassNames.TEXT_INPUT_FORMAT_CLASS;
import static io.datafibre.fibre.connector.hive.HiveMetastoreOperations.FILE_FORMAT;
