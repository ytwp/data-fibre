...
public class TMVReportEpochTask implements org.apache.thrift.TBase<TMVReportEpochTask, TMVReportEpochTask._Fields>, java.io.Serializable, Cloneable, Comparable<TMVReportEpochTask> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>> binlog_consume_state; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TTabletCommitInfo> txn_commit_info; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TTabletFailInfo> txn_fail_info; // optional
  ...
  public TMVReportEpochTask(TMVReportEpochTask other) {
    ...
    if (other.isSetBinlog_consume_state()) {
      java.util.Map<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>> __this__binlog_consume_state = new java.util.HashMap<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>>(other.binlog_consume_state.size());
      for (java.util.Map.Entry<io.datafibre.fibre.thrift.TUniqueId, java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>> other_element : other.binlog_consume_state.entrySet()) {

        io.datafibre.fibre.thrift.TUniqueId other_element_key = other_element.getKey();
        java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>> other_element_value = other_element.getValue();

        io.datafibre.fibre.thrift.TUniqueId __this__binlog_consume_state_copy_key = new io.datafibre.fibre.thrift.TUniqueId(other_element_key);

        java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>> __this__binlog_consume_state_copy_value = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>(other_element_value.size());
        for (java.util.Map.Entry<java.lang.Integer, java.util.List<io.datafibre.fibre.thrift.TScanRange>> other_element_value_element : other_element_value.entrySet()) {

          java.lang.Integer other_element_value_element_key = other_element_value_element.getKey();
          java.util.List<io.datafibre.fibre.thrift.TScanRange> other_element_value_element_value = other_element_value_element.getValue();

          java.lang.Integer __this__binlog_consume_state_copy_value_copy_key = other_element_value_element_key;

          java.util.List<io.datafibre.fibre.thrift.TScanRange> __this__binlog_consume_state_copy_value_copy_value = new java.util.ArrayList<io.datafibre.fibre.thrift.TScanRange>(other_element_value_element_value.size());
          for (io.datafibre.fibre.thrift.TScanRange other_element_value_element_value_element : other_element_value_element_value) {
            __this__binlog_consume_state_copy_value_copy_value.add(new io.datafibre.fibre.thrift.TScanRange(other_element_value_element_value_element));
          }
    ...
    if (other.isSetTxn_commit_info()) {
      java.util.List<io.datafibre.fibre.thrift.TTabletCommitInfo> __this__txn_commit_info = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletCommitInfo>(other.txn_commit_info.size());
      for (io.datafibre.fibre.thrift.TTabletCommitInfo other_element : other.txn_commit_info) {
        __this__txn_commit_info.add(new io.datafibre.fibre.thrift.TTabletCommitInfo(other_element));
      }
      this.txn_commit_info = __this__txn_commit_info;
    }
    if (other.isSetTxn_fail_info()) {
      java.util.List<io.datafibre.fibre.thrift.TTabletFailInfo> __this__txn_fail_info = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletFailInfo>(other.txn_fail_info.size());
      for (io.datafibre.fibre.thrift.TTabletFailInfo other_element : other.txn_fail_info) {
        __this__txn_fail_info.add(new io.datafibre.fibre.thrift.TTabletFailInfo(other_element));
      }
  ...
  public void putToBinlog_consume_state(io.datafibre.fibre.thrift.TUniqueId key, java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>> val) {
    if (this.binlog_consume_state == null) {
      this.binlog_consume_state = new java.util.HashMap<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>>();
    }
    this.binlog_consume_state.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>> getBinlog_consume_state() {
    return this.binlog_consume_state;
  }

  public TMVReportEpochTask setBinlog_consume_state(@org.apache.thrift.annotation.Nullable java.util.Map<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>> binlog_consume_state) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TTabletCommitInfo> getTxn_commit_infoIterator() {
    return (this.txn_commit_info == null) ? null : this.txn_commit_info.iterator();
  }

  public void addToTxn_commit_info(io.datafibre.fibre.thrift.TTabletCommitInfo elem) {
    if (this.txn_commit_info == null) {
      this.txn_commit_info = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletCommitInfo>();
    }
    this.txn_commit_info.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TTabletCommitInfo> getTxn_commit_info() {
    return this.txn_commit_info;
  }

  public TMVReportEpochTask setTxn_commit_info(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TTabletCommitInfo> txn_commit_info) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TTabletFailInfo> getTxn_fail_infoIterator() {
    return (this.txn_fail_info == null) ? null : this.txn_fail_info.iterator();
  }

  public void addToTxn_fail_info(io.datafibre.fibre.thrift.TTabletFailInfo elem) {
    if (this.txn_fail_info == null) {
      this.txn_fail_info = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletFailInfo>();
    }
    this.txn_fail_info.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TTabletFailInfo> getTxn_fail_info() {
    return this.txn_fail_info;
  }

  public TMVReportEpochTask setTxn_fail_info(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TTabletFailInfo> txn_fail_info) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case BINLOG_CONSUME_STATE:
      if (value == null) {
        ...
        setBinlog_consume_state((java.util.Map<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>>)value);
      }
      break;
    ...
    case TXN_COMMIT_INFO:
      if (value == null) {
        ...
        setTxn_commit_info((java.util.List<io.datafibre.fibre.thrift.TTabletCommitInfo>)value);
      }
      break;
    ...
    case TXN_FAIL_INFO:
      if (value == null) {
        ...
        setTxn_fail_info((java.util.List<io.datafibre.fibre.thrift.TTabletFailInfo>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.binlog_consume_state = new java.util.HashMap<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>>(2*_map44.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TUniqueId _key45;
                @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>> _val46;
                for (int _i47 = 0; _i47 < _map44.size; ++_i47)
                {
                  _key45 = new io.datafibre.fibre.thrift.TUniqueId();
                  _key45.read(iprot);
                  {
                    org.apache.thrift.protocol.TMap _map48 = iprot.readMapBegin();
                    _val46 = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>(2*_map48.size);
                    int _key49;
                    @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TScanRange> _val50;
                    for (int _i51 = 0; _i51 < _map48.size; ++_i51)
                    {
                      _key49 = iprot.readI32();
                      {
                        org.apache.thrift.protocol.TList _list52 = iprot.readListBegin();
                        _val50 = new java.util.ArrayList<io.datafibre.fibre.thrift.TScanRange>(_list52.size);
                        @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TScanRange _elem53;
                        for (int _i54 = 0; _i54 < _list52.size; ++_i54)
                        {
                          _elem53 = new io.datafibre.fibre.thrift.TScanRange();
                          _elem53.read(iprot);
                          _val50.add(_elem53);
                        }
                        iprot.readListEnd();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.txn_commit_info = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletCommitInfo>(_list55.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletCommitInfo _elem56;
                for (int _i57 = 0; _i57 < _list55.size; ++_i57)
                {
                  _elem56 = new io.datafibre.fibre.thrift.TTabletCommitInfo();
                  _elem56.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.txn_fail_info = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletFailInfo>(_list58.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletFailInfo _elem59;
                for (int _i60 = 0; _i60 < _list58.size; ++_i60)
                {
                  _elem59 = new io.datafibre.fibre.thrift.TTabletFailInfo();
                  _elem59.read(iprot);
      ...
      if (struct.binlog_consume_state != null) {
        if (struct.isSetBinlog_consume_state()) {
          oprot.writeFieldBegin(BINLOG_CONSUME_STATE_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<io.datafibre.fibre.thrift.TUniqueId, java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>> _iter61 : struct.binlog_consume_state.entrySet())
            {
              _iter61.getKey().write(oprot);
              {
                ...
                for (java.util.Map.Entry<java.lang.Integer, java.util.List<io.datafibre.fibre.thrift.TScanRange>> _iter62 : _iter61.getValue().entrySet())
                {
                  oprot.writeI32(_iter62.getKey());
                  {
                    ...
                    for (io.datafibre.fibre.thrift.TScanRange _iter63 : _iter62.getValue())
                    {
                      _iter63.write(oprot);
                    }
                    oprot.writeListEnd();
      ...
      if (struct.txn_commit_info != null) {
        if (struct.isSetTxn_commit_info()) {
          oprot.writeFieldBegin(TXN_COMMIT_INFO_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TTabletCommitInfo _iter64 : struct.txn_commit_info)
            {
              _iter64.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.txn_fail_info != null) {
        if (struct.isSetTxn_fail_info()) {
          oprot.writeFieldBegin(TXN_FAIL_INFO_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TTabletFailInfo _iter65 : struct.txn_fail_info)
            {
              _iter65.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetBinlog_consume_state()) {
        {
          ...
          for (java.util.Map.Entry<io.datafibre.fibre.thrift.TUniqueId, java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>> _iter66 : struct.binlog_consume_state.entrySet())
          {
            _iter66.getKey().write(oprot);
            {
              oprot.writeI32(_iter66.getValue().size());
              for (java.util.Map.Entry<java.lang.Integer, java.util.List<io.datafibre.fibre.thrift.TScanRange>> _iter67 : _iter66.getValue().entrySet())
              {
                oprot.writeI32(_iter67.getKey());
                {
                  oprot.writeI32(_iter67.getValue().size());
                  for (io.datafibre.fibre.thrift.TScanRange _iter68 : _iter67.getValue())
                  {
                    _iter68.write(oprot);
                  }
                }
      ...
      if (struct.isSetTxn_commit_info()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TTabletCommitInfo _iter69 : struct.txn_commit_info)
          {
            _iter69.write(oprot);
          }
        }
      ...
      if (struct.isSetTxn_fail_info()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TTabletFailInfo _iter70 : struct.txn_fail_info)
          {
            _iter70.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.binlog_consume_state = new java.util.HashMap<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>>(2*_map71.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TUniqueId _key72;
          @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>> _val73;
          for (int _i74 = 0; _i74 < _map71.size; ++_i74)
          {
            _key72 = new io.datafibre.fibre.thrift.TUniqueId();
            _key72.read(iprot);
            {
              ...
              _val73 = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>(2*_map75.size);
              int _key76;
              @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TScanRange> _val77;
              for (int _i78 = 0; _i78 < _map75.size; ++_i78)
              {
                _key76 = iprot.readI32();
                {
                  ...
                  _val77 = new java.util.ArrayList<io.datafibre.fibre.thrift.TScanRange>(_list79.size);
                  @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TScanRange _elem80;
                  for (int _i81 = 0; _i81 < _list79.size; ++_i81)
                  {
                    _elem80 = new io.datafibre.fibre.thrift.TScanRange();
                    _elem80.read(iprot);
                    _val77.add(_elem80);
                  }
                }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.txn_commit_info = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletCommitInfo>(_list82.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletCommitInfo _elem83;
          for (int _i84 = 0; _i84 < _list82.size; ++_i84)
          {
            _elem83 = new io.datafibre.fibre.thrift.TTabletCommitInfo();
            _elem83.read(iprot);
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.txn_fail_info = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletFailInfo>(_list85.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletFailInfo _elem86;
          for (int _i87 = 0; _i87 < _list85.size; ++_i87)
          {
            _elem86 = new io.datafibre.fibre.thrift.TTabletFailInfo();
            _elem86.read(iprot);
