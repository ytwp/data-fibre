...
public class TScanRangeLocation implements org.apache.thrift.TBase<TScanRangeLocation, TScanRangeLocation._Fields>, java.io.Serializable, Cloneable, Comparable<TScanRangeLocation> {
  ...
  public @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TNetworkAddress server; // required
  ...
  public TScanRangeLocation(
    com.starrocks.thrift.TNetworkAddress server)
  {
    this();
    this.server = server;
  }
  ...
  public TScanRangeLocation(TScanRangeLocation other) {
    ...
    if (other.isSetServer()) {
      this.server = new com.starrocks.thrift.TNetworkAddress(other.server);
    }
  ...
  @org.apache.thrift.annotation.Nullable
  public com.starrocks.thrift.TNetworkAddress getServer() {
    return this.server;
  }

  public TScanRangeLocation setServer(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TNetworkAddress server) {
    this.server = server;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case SERVER:
      if (value == null) {
        ...
        setServer((com.starrocks.thrift.TNetworkAddress)value);
      }
      break;
        ...
        switch (schemeField.id) {
          case 1: // SERVER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.server = new com.starrocks.thrift.TNetworkAddress();
