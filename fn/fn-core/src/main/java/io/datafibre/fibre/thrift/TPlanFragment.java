...
public class TPlanFragment implements org.apache.thrift.TBase<TPlanFragment, TPlanFragment._Fields>, java.io.Serializable, Cloneable, Comparable<TPlanFragment> {
  ...
  public @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TPlan plan; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> output_exprs; // optional
  public @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TDataSink output_sink; // optional
  public @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TDataPartition partition; // required
  public long min_reservation_bytes; // optional
  public long initial_reservation_total_claims; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TGlobalDict> query_global_dicts; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TGlobalDict> load_global_dicts; // optional
  public @org.apache.thrift.annotation.Nullable TCacheParam cache_param; // optional
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,com.starrocks.thrift.TExpr> query_global_dict_exprs; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.PLAN, new org.apache.thrift.meta_data.FieldMetaData("plan", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.starrocks.thrift.TPlan.class)));
    ...
    tmpMap.put(_Fields.OUTPUT_SINK, new org.apache.thrift.meta_data.FieldMetaData("output_sink", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.starrocks.thrift.TDataSink.class)));
    tmpMap.put(_Fields.PARTITION, new org.apache.thrift.meta_data.FieldMetaData("partition", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.starrocks.thrift.TDataPartition.class)));
    ...
    tmpMap.put(_Fields.QUERY_GLOBAL_DICTS, new org.apache.thrift.meta_data.FieldMetaData("query_global_dicts", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.starrocks.thrift.TGlobalDict.class))));
  ...
  public TPlanFragment(
    com.starrocks.thrift.TDataPartition partition)
  {
    this();
  ...
  public TPlanFragment(TPlanFragment other) {
    ...
    if (other.isSetPlan()) {
      this.plan = new com.starrocks.thrift.TPlan(other.plan);
    }
    if (other.isSetOutput_exprs()) {
      java.util.List<com.starrocks.thrift.TExpr> __this__output_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(other.output_exprs.size());
      for (com.starrocks.thrift.TExpr other_element : other.output_exprs) {
        __this__output_exprs.add(new com.starrocks.thrift.TExpr(other_element));
      }
      this.output_exprs = __this__output_exprs;
    }
    if (other.isSetOutput_sink()) {
      this.output_sink = new com.starrocks.thrift.TDataSink(other.output_sink);
    }
    if (other.isSetPartition()) {
      this.partition = new com.starrocks.thrift.TDataPartition(other.partition);
    }
    ...
    if (other.isSetQuery_global_dicts()) {
      java.util.List<com.starrocks.thrift.TGlobalDict> __this__query_global_dicts = new java.util.ArrayList<com.starrocks.thrift.TGlobalDict>(other.query_global_dicts.size());
      for (com.starrocks.thrift.TGlobalDict other_element : other.query_global_dicts) {
        __this__query_global_dicts.add(new com.starrocks.thrift.TGlobalDict(other_element));
      }
      this.query_global_dicts = __this__query_global_dicts;
    }
    if (other.isSetLoad_global_dicts()) {
      java.util.List<com.starrocks.thrift.TGlobalDict> __this__load_global_dicts = new java.util.ArrayList<com.starrocks.thrift.TGlobalDict>(other.load_global_dicts.size());
      for (com.starrocks.thrift.TGlobalDict other_element : other.load_global_dicts) {
        __this__load_global_dicts.add(new com.starrocks.thrift.TGlobalDict(other_element));
      }
    ...
    if (other.isSetQuery_global_dict_exprs()) {
      java.util.Map<java.lang.Integer,com.starrocks.thrift.TExpr> __this__query_global_dict_exprs = new java.util.HashMap<java.lang.Integer,com.starrocks.thrift.TExpr>(other.query_global_dict_exprs.size());
      for (java.util.Map.Entry<java.lang.Integer, com.starrocks.thrift.TExpr> other_element : other.query_global_dict_exprs.entrySet()) {
        ...
        com.starrocks.thrift.TExpr __this__query_global_dict_exprs_copy_value = new com.starrocks.thrift.TExpr(other_element_value);
  ...
  @org.apache.thrift.annotation.Nullable
  public com.starrocks.thrift.TPlan getPlan() {
    return this.plan;
  }

  public TPlanFragment setPlan(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TPlan plan) {
    this.plan = plan;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<com.starrocks.thrift.TExpr> getOutput_exprsIterator() {
    return (this.output_exprs == null) ? null : this.output_exprs.iterator();
  }

  public void addToOutput_exprs(com.starrocks.thrift.TExpr elem) {
    if (this.output_exprs == null) {
      this.output_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>();
    }
    this.output_exprs.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<com.starrocks.thrift.TExpr> getOutput_exprs() {
    return this.output_exprs;
  }

  public TPlanFragment setOutput_exprs(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> output_exprs) {
  ...
  @org.apache.thrift.annotation.Nullable
  public com.starrocks.thrift.TDataSink getOutput_sink() {
    return this.output_sink;
  }

  public TPlanFragment setOutput_sink(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TDataSink output_sink) {
  ...
  @org.apache.thrift.annotation.Nullable
  public com.starrocks.thrift.TDataPartition getPartition() {
    return this.partition;
  }

  public TPlanFragment setPartition(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TDataPartition partition) {
    this.partition = partition;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<com.starrocks.thrift.TGlobalDict> getQuery_global_dictsIterator() {
    return (this.query_global_dicts == null) ? null : this.query_global_dicts.iterator();
  }

  public void addToQuery_global_dicts(com.starrocks.thrift.TGlobalDict elem) {
    if (this.query_global_dicts == null) {
      this.query_global_dicts = new java.util.ArrayList<com.starrocks.thrift.TGlobalDict>();
    }
    this.query_global_dicts.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<com.starrocks.thrift.TGlobalDict> getQuery_global_dicts() {
    return this.query_global_dicts;
  }

  public TPlanFragment setQuery_global_dicts(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TGlobalDict> query_global_dicts) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<com.starrocks.thrift.TGlobalDict> getLoad_global_dictsIterator() {
    return (this.load_global_dicts == null) ? null : this.load_global_dicts.iterator();
  }

  public void addToLoad_global_dicts(com.starrocks.thrift.TGlobalDict elem) {
    if (this.load_global_dicts == null) {
      this.load_global_dicts = new java.util.ArrayList<com.starrocks.thrift.TGlobalDict>();
    }
    this.load_global_dicts.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<com.starrocks.thrift.TGlobalDict> getLoad_global_dicts() {
    return this.load_global_dicts;
  }

  public TPlanFragment setLoad_global_dicts(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TGlobalDict> load_global_dicts) {
  ...
  public void putToQuery_global_dict_exprs(int key, com.starrocks.thrift.TExpr val) {
    if (this.query_global_dict_exprs == null) {
      this.query_global_dict_exprs = new java.util.HashMap<java.lang.Integer,com.starrocks.thrift.TExpr>();
    }
    this.query_global_dict_exprs.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.Integer,com.starrocks.thrift.TExpr> getQuery_global_dict_exprs() {
    return this.query_global_dict_exprs;
  }

  public TPlanFragment setQuery_global_dict_exprs(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,com.starrocks.thrift.TExpr> query_global_dict_exprs) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case PLAN:
      if (value == null) {
        ...
        setPlan((com.starrocks.thrift.TPlan)value);
      }
      break;
    ...
    case OUTPUT_EXPRS:
      if (value == null) {
        ...
        setOutput_exprs((java.util.List<com.starrocks.thrift.TExpr>)value);
      }
      break;
    ...
    case OUTPUT_SINK:
      if (value == null) {
        ...
        setOutput_sink((com.starrocks.thrift.TDataSink)value);
      }
      break;
    ...
    case PARTITION:
      if (value == null) {
        ...
        setPartition((com.starrocks.thrift.TDataPartition)value);
      }
      break;
    ...
    case QUERY_GLOBAL_DICTS:
      if (value == null) {
        ...
        setQuery_global_dicts((java.util.List<com.starrocks.thrift.TGlobalDict>)value);
      }
      break;
    ...
    case LOAD_GLOBAL_DICTS:
      if (value == null) {
        ...
        setLoad_global_dicts((java.util.List<com.starrocks.thrift.TGlobalDict>)value);
      }
      break;
    ...
    case QUERY_GLOBAL_DICT_EXPRS:
      if (value == null) {
        ...
        setQuery_global_dict_exprs((java.util.Map<java.lang.Integer,com.starrocks.thrift.TExpr>)value);
      }
      break;
        ...
        switch (schemeField.id) {
          case 2: // PLAN
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.plan = new com.starrocks.thrift.TPlan();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.output_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list28.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem29;
                for (int _i30 = 0; _i30 < _list28.size; ++_i30)
                {
                  _elem29 = new com.starrocks.thrift.TExpr();
                  _elem29.read(iprot);
          ...
          case 5: // OUTPUT_SINK
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.output_sink = new com.starrocks.thrift.TDataSink();
          ...
          case 6: // PARTITION
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.partition = new com.starrocks.thrift.TDataPartition();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.query_global_dicts = new java.util.ArrayList<com.starrocks.thrift.TGlobalDict>(_list31.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TGlobalDict _elem32;
                for (int _i33 = 0; _i33 < _list31.size; ++_i33)
                {
                  _elem32 = new com.starrocks.thrift.TGlobalDict();
                  _elem32.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.load_global_dicts = new java.util.ArrayList<com.starrocks.thrift.TGlobalDict>(_list34.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TGlobalDict _elem35;
                for (int _i36 = 0; _i36 < _list34.size; ++_i36)
                {
                  _elem35 = new com.starrocks.thrift.TGlobalDict();
                  _elem35.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.query_global_dict_exprs = new java.util.HashMap<java.lang.Integer,com.starrocks.thrift.TExpr>(2*_map37.size);
                int _key38;
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _val39;
                for (int _i40 = 0; _i40 < _map37.size; ++_i40)
                {
                  _key38 = iprot.readI32();
                  _val39 = new com.starrocks.thrift.TExpr();
                  _val39.read(iprot);
      ...
      if (struct.output_exprs != null) {
        if (struct.isSetOutput_exprs()) {
          oprot.writeFieldBegin(OUTPUT_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter41 : struct.output_exprs)
            {
              _iter41.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.query_global_dicts != null) {
        if (struct.isSetQuery_global_dicts()) {
          oprot.writeFieldBegin(QUERY_GLOBAL_DICTS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TGlobalDict _iter42 : struct.query_global_dicts)
            {
              _iter42.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.load_global_dicts != null) {
        if (struct.isSetLoad_global_dicts()) {
          oprot.writeFieldBegin(LOAD_GLOBAL_DICTS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TGlobalDict _iter43 : struct.load_global_dicts)
            {
              _iter43.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.query_global_dict_exprs != null) {
        if (struct.isSetQuery_global_dict_exprs()) {
          oprot.writeFieldBegin(QUERY_GLOBAL_DICT_EXPRS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, com.starrocks.thrift.TExpr> _iter44 : struct.query_global_dict_exprs.entrySet())
            {
      ...
      if (struct.isSetOutput_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter45 : struct.output_exprs)
          {
            _iter45.write(oprot);
          }
        }
      ...
      if (struct.isSetQuery_global_dicts()) {
        {
          ...
          for (com.starrocks.thrift.TGlobalDict _iter46 : struct.query_global_dicts)
          {
            _iter46.write(oprot);
          }
        }
      ...
      if (struct.isSetLoad_global_dicts()) {
        {
          ...
          for (com.starrocks.thrift.TGlobalDict _iter47 : struct.load_global_dicts)
          {
            _iter47.write(oprot);
          }
        }
      ...
      if (struct.isSetQuery_global_dict_exprs()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, com.starrocks.thrift.TExpr> _iter48 : struct.query_global_dict_exprs.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.output_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list49.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem50;
          for (int _i51 = 0; _i51 < _list49.size; ++_i51)
          {
            _elem50 = new com.starrocks.thrift.TExpr();
            _elem50.read(iprot);
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.query_global_dicts = new java.util.ArrayList<com.starrocks.thrift.TGlobalDict>(_list52.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TGlobalDict _elem53;
          for (int _i54 = 0; _i54 < _list52.size; ++_i54)
          {
            _elem53 = new com.starrocks.thrift.TGlobalDict();
            _elem53.read(iprot);
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.load_global_dicts = new java.util.ArrayList<com.starrocks.thrift.TGlobalDict>(_list55.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TGlobalDict _elem56;
          for (int _i57 = 0; _i57 < _list55.size; ++_i57)
          {
            _elem56 = new com.starrocks.thrift.TGlobalDict();
            _elem56.read(iprot);
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.query_global_dict_exprs = new java.util.HashMap<java.lang.Integer,com.starrocks.thrift.TExpr>(2*_map58.size);
          int _key59;
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _val60;
          for (int _i61 = 0; _i61 < _map58.size; ++_i61)
          {
            _key59 = iprot.readI32();
            _val60 = new com.starrocks.thrift.TExpr();
            _val60.read(iprot);
