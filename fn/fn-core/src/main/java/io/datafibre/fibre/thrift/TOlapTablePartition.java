...
public class TOlapTablePartition implements org.apache.thrift.TBase<TOlapTablePartition, TOlapTablePartition._Fields>, java.io.Serializable, Cloneable, Comparable<TOlapTablePartition> {
  ...
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExprNode start_key; // optional
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExprNode end_key; // optional
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExprNode> start_keys; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExprNode> end_keys; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<java.util.List<io.datafibre.fibre.thrift.TExprNode>> in_keys; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.START_KEY, new org.apache.thrift.meta_data.FieldMetaData("start_key", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, io.datafibre.fibre.thrift.TExprNode.class)));
  ...
  public TOlapTablePartition(TOlapTablePartition other) {
    ...
    if (other.isSetStart_key()) {
      this.start_key = new io.datafibre.fibre.thrift.TExprNode(other.start_key);
    }
    if (other.isSetEnd_key()) {
      this.end_key = new io.datafibre.fibre.thrift.TExprNode(other.end_key);
    }
    ...
    if (other.isSetStart_keys()) {
      java.util.List<io.datafibre.fibre.thrift.TExprNode> __this__start_keys = new java.util.ArrayList<io.datafibre.fibre.thrift.TExprNode>(other.start_keys.size());
      for (io.datafibre.fibre.thrift.TExprNode other_element : other.start_keys) {
        __this__start_keys.add(new io.datafibre.fibre.thrift.TExprNode(other_element));
      }
      this.start_keys = __this__start_keys;
    }
    if (other.isSetEnd_keys()) {
      java.util.List<io.datafibre.fibre.thrift.TExprNode> __this__end_keys = new java.util.ArrayList<io.datafibre.fibre.thrift.TExprNode>(other.end_keys.size());
      for (io.datafibre.fibre.thrift.TExprNode other_element : other.end_keys) {
        __this__end_keys.add(new io.datafibre.fibre.thrift.TExprNode(other_element));
      }
      this.end_keys = __this__end_keys;
    }
    if (other.isSetIn_keys()) {
      java.util.List<java.util.List<io.datafibre.fibre.thrift.TExprNode>> __this__in_keys = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExprNode>>(other.in_keys.size());
      for (java.util.List<io.datafibre.fibre.thrift.TExprNode> other_element : other.in_keys) {
        java.util.List<io.datafibre.fibre.thrift.TExprNode> __this__in_keys_copy = new java.util.ArrayList<io.datafibre.fibre.thrift.TExprNode>(other_element.size());
        for (io.datafibre.fibre.thrift.TExprNode other_element_element : other_element) {
          __this__in_keys_copy.add(new io.datafibre.fibre.thrift.TExprNode(other_element_element));
        }
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TExprNode getStart_key() {
    return this.start_key;
  }

  public TOlapTablePartition setStart_key(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExprNode start_key) {
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TExprNode getEnd_key() {
    return this.end_key;
  }

  public TOlapTablePartition setEnd_key(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExprNode end_key) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TExprNode> getStart_keysIterator() {
    return (this.start_keys == null) ? null : this.start_keys.iterator();
  }

  public void addToStart_keys(io.datafibre.fibre.thrift.TExprNode elem) {
    if (this.start_keys == null) {
      this.start_keys = new java.util.ArrayList<io.datafibre.fibre.thrift.TExprNode>();
    }
    this.start_keys.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TExprNode> getStart_keys() {
    return this.start_keys;
  }

  public TOlapTablePartition setStart_keys(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExprNode> start_keys) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TExprNode> getEnd_keysIterator() {
    return (this.end_keys == null) ? null : this.end_keys.iterator();
  }

  public void addToEnd_keys(io.datafibre.fibre.thrift.TExprNode elem) {
    if (this.end_keys == null) {
      this.end_keys = new java.util.ArrayList<io.datafibre.fibre.thrift.TExprNode>();
    }
    this.end_keys.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TExprNode> getEnd_keys() {
    return this.end_keys;
  }

  public TOlapTablePartition setEnd_keys(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExprNode> end_keys) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<java.util.List<io.datafibre.fibre.thrift.TExprNode>> getIn_keysIterator() {
    return (this.in_keys == null) ? null : this.in_keys.iterator();
  }

  public void addToIn_keys(java.util.List<io.datafibre.fibre.thrift.TExprNode> elem) {
    if (this.in_keys == null) {
      this.in_keys = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExprNode>>();
    }
    this.in_keys.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<java.util.List<io.datafibre.fibre.thrift.TExprNode>> getIn_keys() {
    return this.in_keys;
  }

  public TOlapTablePartition setIn_keys(@org.apache.thrift.annotation.Nullable java.util.List<java.util.List<io.datafibre.fibre.thrift.TExprNode>> in_keys) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case START_KEY:
      if (value == null) {
        ...
        setStart_key((io.datafibre.fibre.thrift.TExprNode)value);
      }
      break;
    ...
    case END_KEY:
      if (value == null) {
        ...
        setEnd_key((io.datafibre.fibre.thrift.TExprNode)value);
      }
      break;
    ...
    case START_KEYS:
      if (value == null) {
        ...
        setStart_keys((java.util.List<io.datafibre.fibre.thrift.TExprNode>)value);
      }
      break;
    ...
    case END_KEYS:
      if (value == null) {
        ...
        setEnd_keys((java.util.List<io.datafibre.fibre.thrift.TExprNode>)value);
      }
      break;
    ...
    case IN_KEYS:
      if (value == null) {
        ...
        setIn_keys((java.util.List<java.util.List<io.datafibre.fibre.thrift.TExprNode>>)value);
      }
      break;
        ...
        switch (schemeField.id) {
          ...
          case 2: // START_KEY
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.start_key = new io.datafibre.fibre.thrift.TExprNode();
          ...
          case 3: // END_KEY
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.end_key = new io.datafibre.fibre.thrift.TExprNode();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.start_keys = new java.util.ArrayList<io.datafibre.fibre.thrift.TExprNode>(_list11.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExprNode _elem12;
                for (int _i13 = 0; _i13 < _list11.size; ++_i13)
                {
                  _elem12 = new io.datafibre.fibre.thrift.TExprNode();
                  _elem12.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.end_keys = new java.util.ArrayList<io.datafibre.fibre.thrift.TExprNode>(_list14.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExprNode _elem15;
                for (int _i16 = 0; _i16 < _list14.size; ++_i16)
                {
                  _elem15 = new io.datafibre.fibre.thrift.TExprNode();
                  _elem15.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.in_keys = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExprNode>>(_list17.size);
                @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExprNode> _elem18;
                for (int _i19 = 0; _i19 < _list17.size; ++_i19)
                {
                  {
                    org.apache.thrift.protocol.TList _list20 = iprot.readListBegin();
                    _elem18 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExprNode>(_list20.size);
                    @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExprNode _elem21;
                    for (int _i22 = 0; _i22 < _list20.size; ++_i22)
                    {
                      _elem21 = new io.datafibre.fibre.thrift.TExprNode();
                      _elem21.read(iprot);
                      _elem18.add(_elem21);
                    }
                    iprot.readListEnd();
      ...
      if (struct.start_keys != null) {
        if (struct.isSetStart_keys()) {
          oprot.writeFieldBegin(START_KEYS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TExprNode _iter24 : struct.start_keys)
            {
              _iter24.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.end_keys != null) {
        if (struct.isSetEnd_keys()) {
          oprot.writeFieldBegin(END_KEYS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TExprNode _iter25 : struct.end_keys)
            {
              _iter25.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.in_keys != null) {
        if (struct.isSetIn_keys()) {
          oprot.writeFieldBegin(IN_KEYS_FIELD_DESC);
          {
            ...
            for (java.util.List<io.datafibre.fibre.thrift.TExprNode> _iter26 : struct.in_keys)
            {
              {
                oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, _iter26.size()));
                for (io.datafibre.fibre.thrift.TExprNode _iter27 : _iter26)
                {
                  _iter27.write(oprot);
                }
                oprot.writeListEnd();
      ...
      if (struct.isSetStart_keys()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TExprNode _iter29 : struct.start_keys)
          {
            _iter29.write(oprot);
          }
        }
      ...
      if (struct.isSetEnd_keys()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TExprNode _iter30 : struct.end_keys)
          {
            _iter30.write(oprot);
          }
        }
      ...
      if (struct.isSetIn_keys()) {
        {
          ...
          for (java.util.List<io.datafibre.fibre.thrift.TExprNode> _iter31 : struct.in_keys)
          {
            {
              oprot.writeI32(_iter31.size());
              for (io.datafibre.fibre.thrift.TExprNode _iter32 : _iter31)
              {
                _iter32.write(oprot);
              }
            }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.start_keys = new java.util.ArrayList<io.datafibre.fibre.thrift.TExprNode>(_list36.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExprNode _elem37;
          for (int _i38 = 0; _i38 < _list36.size; ++_i38)
          {
            _elem37 = new io.datafibre.fibre.thrift.TExprNode();
            _elem37.read(iprot);
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.end_keys = new java.util.ArrayList<io.datafibre.fibre.thrift.TExprNode>(_list39.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExprNode _elem40;
          for (int _i41 = 0; _i41 < _list39.size; ++_i41)
          {
            _elem40 = new io.datafibre.fibre.thrift.TExprNode();
            _elem40.read(iprot);
      ...
      if (incoming.get(4)) {
        {
          ...
          struct.in_keys = new java.util.ArrayList<java.util.List<io.datafibre.fibre.thrift.TExprNode>>(_list42.size);
          @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExprNode> _elem43;
          for (int _i44 = 0; _i44 < _list42.size; ++_i44)
          {
            {
              org.apache.thrift.protocol.TList _list45 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
              _elem43 = new java.util.ArrayList<io.datafibre.fibre.thrift.TExprNode>(_list45.size);
              @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExprNode _elem46;
              for (int _i47 = 0; _i47 < _list45.size; ++_i47)
              {
                _elem46 = new io.datafibre.fibre.thrift.TExprNode();
                _elem46.read(iprot);
                _elem43.add(_elem46);
              }
            }
