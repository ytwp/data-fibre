...
public class TQueryExecRequest implements org.apache.thrift.TBase<TQueryExecRequest, TQueryExecRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TQueryExecRequest> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TPlanFragment> fragments; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> dest_fragment_idx; // optional
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations>> per_node_scan_ranges; // optional
  public @org.apache.thrift.annotation.Nullable TResultSetMetadata result_set_metadata; // optional
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TQueryGlobals query_globals; // required
  /**
   * 
   * @see io.datafibre.fibre.thrift.TStmtType
   */
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TStmtType stmt_type; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.FRAGMENTS, new org.apache.thrift.meta_data.FieldMetaData("fragments", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, io.datafibre.fibre.thrift.TPlanFragment.class))));
    ...
    tmpMap.put(_Fields.PER_NODE_SCAN_RANGES, new org.apache.thrift.meta_data.FieldMetaData("per_node_scan_ranges", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            ...
            new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
                new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, io.datafibre.fibre.thrift.TScanRangeLocations.class)))));
    ...
    tmpMap.put(_Fields.STMT_TYPE, new org.apache.thrift.meta_data.FieldMetaData("stmt_type", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, io.datafibre.fibre.thrift.TStmtType.class)));
  ...
  public TQueryExecRequest(
    java.util.List<io.datafibre.fibre.thrift.TPlanFragment> fragments,
    io.datafibre.fibre.thrift.TQueryGlobals query_globals,
    io.datafibre.fibre.thrift.TStmtType stmt_type)
  {
    this();
  ...
  public TQueryExecRequest(TQueryExecRequest other) {
    ...
    if (other.isSetFragments()) {
      java.util.List<io.datafibre.fibre.thrift.TPlanFragment> __this__fragments = new java.util.ArrayList<io.datafibre.fibre.thrift.TPlanFragment>(other.fragments.size());
      for (io.datafibre.fibre.thrift.TPlanFragment other_element : other.fragments) {
        __this__fragments.add(new io.datafibre.fibre.thrift.TPlanFragment(other_element));
      }
    ...
    if (other.isSetPer_node_scan_ranges()) {
      java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations>> __this__per_node_scan_ranges = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations>>(other.per_node_scan_ranges.size());
      for (java.util.Map.Entry<java.lang.Integer, java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations>> other_element : other.per_node_scan_ranges.entrySet()) {

        java.lang.Integer other_element_key = other_element.getKey();
        java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations> other_element_value = other_element.getValue();

        java.lang.Integer __this__per_node_scan_ranges_copy_key = other_element_key;

        java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations> __this__per_node_scan_ranges_copy_value = new java.util.ArrayList<io.datafibre.fibre.thrift.TScanRangeLocations>(other_element_value.size());
        for (io.datafibre.fibre.thrift.TScanRangeLocations other_element_value_element : other_element_value) {
          __this__per_node_scan_ranges_copy_value.add(new io.datafibre.fibre.thrift.TScanRangeLocations(other_element_value_element));
        }
  ...
  public TQueryExecRequest setDesc_tbl(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TDescriptorTable desc_tbl) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TPlanFragment> getFragmentsIterator() {
    return (this.fragments == null) ? null : this.fragments.iterator();
  }

  public void addToFragments(io.datafibre.fibre.thrift.TPlanFragment elem) {
    if (this.fragments == null) {
      this.fragments = new java.util.ArrayList<io.datafibre.fibre.thrift.TPlanFragment>();
    }
    this.fragments.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TPlanFragment> getFragments() {
    return this.fragments;
  }

  public TQueryExecRequest setFragments(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TPlanFragment> fragments) {
    this.fragments = fragments;
    return this;
  }
  ...
  public void putToPer_node_scan_ranges(int key, java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations> val) {
    if (this.per_node_scan_ranges == null) {
      this.per_node_scan_ranges = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations>>();
    }
    this.per_node_scan_ranges.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations>> getPer_node_scan_ranges() {
    return this.per_node_scan_ranges;
  }

  public TQueryExecRequest setPer_node_scan_ranges(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations>> per_node_scan_ranges) {
  ...
  public TQueryExecRequest setQuery_globals(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TQueryGlobals query_globals) {
    this.query_globals = query_globals;
    return this;
  }
   ...
   */
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TStmtType getStmt_type() {
   ...
   * @see io.datafibre.fibre.thrift.TStmtType
   */
  public TQueryExecRequest setStmt_type(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TStmtType stmt_type) {
    this.stmt_type = stmt_type;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case FRAGMENTS:
      if (value == null) {
        ...
        setFragments((java.util.List<io.datafibre.fibre.thrift.TPlanFragment>)value);
      }
      break;
    ...
    case PER_NODE_SCAN_RANGES:
      if (value == null) {
        ...
        setPer_node_scan_ranges((java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations>>)value);
      }
      break;
    ...
    case STMT_TYPE:
      if (value == null) {
        ...
        setStmt_type((io.datafibre.fibre.thrift.TStmtType)value);
      }
      break;
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fragments = new java.util.ArrayList<io.datafibre.fibre.thrift.TPlanFragment>(_list50.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TPlanFragment _elem51;
                for (int _i52 = 0; _i52 < _list50.size; ++_i52)
                {
                  _elem51 = new io.datafibre.fibre.thrift.TPlanFragment();
                  _elem51.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.per_node_scan_ranges = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations>>(2*_map56.size);
                int _key57;
                @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations> _val58;
                for (int _i59 = 0; _i59 < _map56.size; ++_i59)
                {
                  _key57 = iprot.readI32();
                  {
                    org.apache.thrift.protocol.TList _list60 = iprot.readListBegin();
                    _val58 = new java.util.ArrayList<io.datafibre.fibre.thrift.TScanRangeLocations>(_list60.size);
                    @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TScanRangeLocations _elem61;
                    for (int _i62 = 0; _i62 < _list60.size; ++_i62)
                    {
                      _elem61 = new io.datafibre.fibre.thrift.TScanRangeLocations();
                      _elem61.read(iprot);
                      _val58.add(_elem61);
                    }
                    iprot.readListEnd();
          ...
          case 9: // STMT_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.stmt_type = io.datafibre.fibre.thrift.TStmtType.findByValue(iprot.readI32());
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TQueryExecRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.fragments != null) {
        oprot.writeFieldBegin(FRAGMENTS_FIELD_DESC);
        {
          ...
          for (io.datafibre.fibre.thrift.TPlanFragment _iter63 : struct.fragments)
          {
            _iter63.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.per_node_scan_ranges != null) {
        if (struct.isSetPer_node_scan_ranges()) {
          oprot.writeFieldBegin(PER_NODE_SCAN_RANGES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.Integer, java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations>> _iter65 : struct.per_node_scan_ranges.entrySet())
            {
              oprot.writeI32(_iter65.getKey());
              {
                ...
                for (io.datafibre.fibre.thrift.TScanRangeLocations _iter66 : _iter65.getValue())
                {
                  _iter66.write(oprot);
                }
                oprot.writeListEnd();
  ...
  private static class TQueryExecRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TQueryExecRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TQueryExecRequest struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        for (io.datafibre.fibre.thrift.TPlanFragment _iter67 : struct.fragments)
        {
          _iter67.write(oprot);
        }
      }
      ...
      if (struct.isSetPer_node_scan_ranges()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.Integer, java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations>> _iter69 : struct.per_node_scan_ranges.entrySet())
          {
            oprot.writeI32(_iter69.getKey());
            {
              oprot.writeI32(_iter69.getValue().size());
              for (io.datafibre.fibre.thrift.TScanRangeLocations _iter70 : _iter69.getValue())
              {
                _iter70.write(oprot);
              }
            }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TQueryExecRequest struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      {
        ...
        struct.fragments = new java.util.ArrayList<io.datafibre.fibre.thrift.TPlanFragment>(_list71.size);
        @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TPlanFragment _elem72;
        for (int _i73 = 0; _i73 < _list71.size; ++_i73)
        {
          _elem72 = new io.datafibre.fibre.thrift.TPlanFragment();
          _elem72.read(iprot);
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.per_node_scan_ranges = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations>>(2*_map77.size);
          int _key78;
          @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TScanRangeLocations> _val79;
          for (int _i80 = 0; _i80 < _map77.size; ++_i80)
          {
            _key78 = iprot.readI32();
            {
              ...
              _val79 = new java.util.ArrayList<io.datafibre.fibre.thrift.TScanRangeLocations>(_list81.size);
              @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TScanRangeLocations _elem82;
              for (int _i83 = 0; _i83 < _list81.size; ++_i83)
              {
                _elem82 = new io.datafibre.fibre.thrift.TScanRangeLocations();
                _elem82.read(iprot);
                _val79.add(_elem82);
              }
            }
