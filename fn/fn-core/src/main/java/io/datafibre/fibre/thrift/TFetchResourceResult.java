...
public class TFetchResourceResult implements org.apache.thrift.TBase<TFetchResourceResult, TFetchResourceResult._Fields>, java.io.Serializable, Cloneable, Comparable<TFetchResourceResult> {
  ...
  /**
   * 
   * @see io.datafibre.fibre.thrift.TAgentServiceVersion
   */
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TAgentServiceVersion protocolVersion; // required
  ...
  static {
    ...
    tmpMap.put(_Fields.PROTOCOL_VERSION, new org.apache.thrift.meta_data.FieldMetaData("protocolVersion", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, io.datafibre.fibre.thrift.TAgentServiceVersion.class)));
  ...
  public TFetchResourceResult(
    io.datafibre.fibre.thrift.TAgentServiceVersion protocolVersion,
   ...
   */
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TAgentServiceVersion getProtocolVersion() {
   ...
   * @see io.datafibre.fibre.thrift.TAgentServiceVersion
   */
  public TFetchResourceResult setProtocolVersion(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TAgentServiceVersion protocolVersion) {
    this.protocolVersion = protocolVersion;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case PROTOCOL_VERSION:
      if (value == null) {
        ...
        setProtocolVersion((io.datafibre.fibre.thrift.TAgentServiceVersion)value);
      }
      break;
        ...
        switch (schemeField.id) {
          case 1: // PROTOCOL_VERSION
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.protocolVersion = io.datafibre.fibre.thrift.TAgentServiceVersion.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.resourceByUser = new java.util.HashMap<java.lang.String,TUserResource>(2*_map164.size);
                @org.apache.thrift.annotation.Nullable java.lang.String _key165;
                @org.apache.thrift.annotation.Nullable TUserResource _val166;
                for (int _i167 = 0; _i167 < _map164.size; ++_i167)
                {
                  _key165 = iprot.readString();
                  _val166 = new TUserResource();
                  _val166.read(iprot);
                  struct.resourceByUser.put(_key165, _val166);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFetchResourceResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.resourceByUser != null) {
        oprot.writeFieldBegin(RESOURCE_BY_USER_FIELD_DESC);
        {
          ...
          for (java.util.Map.Entry<java.lang.String, TUserResource> _iter168 : struct.resourceByUser.entrySet())
          {
  ...
  private static class TFetchResourceResultTupleScheme extends org.apache.thrift.scheme.TupleScheme<TFetchResourceResult> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TFetchResourceResult struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.resourceVersion);
      {
        ...
        for (java.util.Map.Entry<java.lang.String, TUserResource> _iter169 : struct.resourceByUser.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TFetchResourceResult struct) throws org.apache.thrift.TException {
      ...
      struct.setResourceVersionIsSet(true);
      {
        ...
        struct.resourceByUser = new java.util.HashMap<java.lang.String,TUserResource>(2*_map170.size);
        @org.apache.thrift.annotation.Nullable java.lang.String _key171;
        @org.apache.thrift.annotation.Nullable TUserResource _val172;
        for (int _i173 = 0; _i173 < _map170.size; ++_i173)
        {
          _key171 = iprot.readString();
          _val172 = new TUserResource();
          _val172.read(iprot);
          struct.resourceByUser.put(_key171, _val172);
        }
      }
      struct.setResourceByUserIsSet(true);
    }
