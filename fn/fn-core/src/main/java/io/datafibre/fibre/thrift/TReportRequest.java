...
public class TReportRequest implements org.apache.thrift.TBase<TReportRequest, TReportRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TReportRequest> {
  ...
  public @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TBackend backend; // required
  public long report_version; // optional
  public @org.apache.thrift.annotation.Nullable java.util.Map<com.starrocks.thrift.TTaskType,java.util.Set<java.lang.Long>> tasks; // optional
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TWorkGroup> active_workgroups; // optional
  public @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TResourceUsage resource_usage; // optional
  public @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TDataCacheMetrics datacache_metrics; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.TASKS, new org.apache.thrift.meta_data.FieldMetaData("tasks", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.MapMetaData(org.apache.thrift.protocol.TType.MAP, 
            new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, com.starrocks.thrift.TTaskType.class), 
    ...
    tmpMap.put(_Fields.DATACACHE_METRICS, new org.apache.thrift.meta_data.FieldMetaData("datacache_metrics", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, com.starrocks.thrift.TDataCacheMetrics.class)));
  ...
  public TReportRequest(
    com.starrocks.thrift.TBackend backend)
  {
    this();
  ...
  public TReportRequest(TReportRequest other) {
    ...
    if (other.isSetTasks()) {
      java.util.Map<com.starrocks.thrift.TTaskType,java.util.Set<java.lang.Long>> __this__tasks = new java.util.EnumMap<com.starrocks.thrift.TTaskType,java.util.Set<java.lang.Long>>(com.starrocks.thrift.TTaskType.class);
      for (java.util.Map.Entry<com.starrocks.thrift.TTaskType, java.util.Set<java.lang.Long>> other_element : other.tasks.entrySet()) {

        com.starrocks.thrift.TTaskType other_element_key = other_element.getKey();
        java.util.Set<java.lang.Long> other_element_value = other_element.getValue();

        com.starrocks.thrift.TTaskType __this__tasks_copy_key = other_element_key;
    ...
    if (other.isSetActive_workgroups()) {
      java.util.List<com.starrocks.thrift.TWorkGroup> __this__active_workgroups = new java.util.ArrayList<com.starrocks.thrift.TWorkGroup>(other.active_workgroups.size());
      for (com.starrocks.thrift.TWorkGroup other_element : other.active_workgroups) {
        __this__active_workgroups.add(new com.starrocks.thrift.TWorkGroup(other_element));
      }
    ...
    if (other.isSetDatacache_metrics()) {
      this.datacache_metrics = new com.starrocks.thrift.TDataCacheMetrics(other.datacache_metrics);
    }
  }
  ...
  public TReportRequest setBackend(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TBackend backend) {
    this.backend = backend;
    return this;
  }
  ...
  public void putToTasks(com.starrocks.thrift.TTaskType key, java.util.Set<java.lang.Long> val) {
    if (this.tasks == null) {
      this.tasks = new java.util.EnumMap<com.starrocks.thrift.TTaskType,java.util.Set<java.lang.Long>>(com.starrocks.thrift.TTaskType.class);
    }
    this.tasks.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<com.starrocks.thrift.TTaskType,java.util.Set<java.lang.Long>> getTasks() {
    return this.tasks;
  }

  public TReportRequest setTasks(@org.apache.thrift.annotation.Nullable java.util.Map<com.starrocks.thrift.TTaskType,java.util.Set<java.lang.Long>> tasks) {
    this.tasks = tasks;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<com.starrocks.thrift.TWorkGroup> getActive_workgroupsIterator() {
    return (this.active_workgroups == null) ? null : this.active_workgroups.iterator();
  }

  public void addToActive_workgroups(com.starrocks.thrift.TWorkGroup elem) {
    if (this.active_workgroups == null) {
      this.active_workgroups = new java.util.ArrayList<com.starrocks.thrift.TWorkGroup>();
    }
    this.active_workgroups.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<com.starrocks.thrift.TWorkGroup> getActive_workgroups() {
    return this.active_workgroups;
  }

  public TReportRequest setActive_workgroups(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TWorkGroup> active_workgroups) {
  ...
  public TReportRequest setResource_usage(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TResourceUsage resource_usage) {
  ...
  @org.apache.thrift.annotation.Nullable
  public com.starrocks.thrift.TDataCacheMetrics getDatacache_metrics() {
    return this.datacache_metrics;
  }

  public TReportRequest setDatacache_metrics(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TDataCacheMetrics datacache_metrics) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case TASKS:
      if (value == null) {
        ...
        setTasks((java.util.Map<com.starrocks.thrift.TTaskType,java.util.Set<java.lang.Long>>)value);
      }
      break;
    ...
    case ACTIVE_WORKGROUPS:
      if (value == null) {
        ...
        setActive_workgroups((java.util.List<com.starrocks.thrift.TWorkGroup>)value);
      }
      break;
    ...
    case DATACACHE_METRICS:
      if (value == null) {
        ...
        setDatacache_metrics((com.starrocks.thrift.TDataCacheMetrics)value);
      }
      break;
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TReportRequest struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.tasks = new java.util.EnumMap<com.starrocks.thrift.TTaskType,java.util.Set<java.lang.Long>>(com.starrocks.thrift.TTaskType.class);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTaskType _key83;
                @org.apache.thrift.annotation.Nullable java.util.Set<java.lang.Long> _val84;
                for (int _i85 = 0; _i85 < _map82.size; ++_i85)
                {
                  _key83 = com.starrocks.thrift.TTaskType.findByValue(iprot.readI32());
                  {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.active_workgroups = new java.util.ArrayList<com.starrocks.thrift.TWorkGroup>(_list100.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TWorkGroup _elem101;
                for (int _i102 = 0; _i102 < _list100.size; ++_i102)
                {
                  _elem101 = new com.starrocks.thrift.TWorkGroup();
                  _elem101.read(iprot);
          ...
          case 11: // DATACACHE_METRICS
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.datacache_metrics = new com.starrocks.thrift.TDataCacheMetrics();
      ...
      if (struct.tasks != null) {
        if (struct.isSetTasks()) {
          oprot.writeFieldBegin(TASKS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<com.starrocks.thrift.TTaskType, java.util.Set<java.lang.Long>> _iter103 : struct.tasks.entrySet())
            {
      ...
      if (struct.active_workgroups != null) {
        if (struct.isSetActive_workgroups()) {
          oprot.writeFieldBegin(ACTIVE_WORKGROUPS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TWorkGroup _iter108 : struct.active_workgroups)
            {
      ...
      if (struct.isSetTasks()) {
        {
          ...
          for (java.util.Map.Entry<com.starrocks.thrift.TTaskType, java.util.Set<java.lang.Long>> _iter109 : struct.tasks.entrySet())
          {
      ...
      if (struct.isSetActive_workgroups()) {
        {
          ...
          for (com.starrocks.thrift.TWorkGroup _iter114 : struct.active_workgroups)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.tasks = new java.util.EnumMap<com.starrocks.thrift.TTaskType,java.util.Set<java.lang.Long>>(com.starrocks.thrift.TTaskType.class);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TTaskType _key116;
          @org.apache.thrift.annotation.Nullable java.util.Set<java.lang.Long> _val117;
          for (int _i118 = 0; _i118 < _map115.size; ++_i118)
          {
            _key116 = com.starrocks.thrift.TTaskType.findByValue(iprot.readI32());
            {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.active_workgroups = new java.util.ArrayList<com.starrocks.thrift.TWorkGroup>(_list133.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TWorkGroup _elem134;
          for (int _i135 = 0; _i135 < _list133.size; ++_i135)
          {
            _elem134 = new com.starrocks.thrift.TWorkGroup();
            _elem134.read(iprot);
