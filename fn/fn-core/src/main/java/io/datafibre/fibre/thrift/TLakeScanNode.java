...
public class TLakeScanNode implements org.apache.thrift.TBase<TLakeScanNode, TLakeScanNode._Fields>, java.io.Serializable, Cloneable, Comparable<TLakeScanNode> {
  ...
  public TLakeScanNode setKey_column_type(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TPrimitiveType> key_column_type) {
    this.key_column_type = key_column_type;
    return this;
  }
  ...
  public TLakeScanNode setBucket_exprs(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> bucket_exprs) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.key_column_type = new java.util.ArrayList<io.datafibre.fibre.thrift.TPrimitiveType>(_list307.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TPrimitiveType _elem308;
                for (int _i309 = 0; _i309 < _list307.size; ++_i309)
                {
                  _elem308 = io.datafibre.fibre.thrift.TPrimitiveType.findByValue(iprot.readI32());
                  if (_elem308 != null)
                  {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.bucket_exprs = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list320.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem321;
                for (int _i322 = 0; _i322 < _list320.size; ++_i322)
                {
                  _elem321 = new io.datafibre.fibre.thrift.TExpr();
                  _elem321.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TLakeScanNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.key_column_type != null) {
        oprot.writeFieldBegin(KEY_COLUMN_TYPE_FIELD_DESC);
        {
          ...
          for (io.datafibre.fibre.thrift.TPrimitiveType _iter327 : struct.key_column_type)
          {
      ...
      if (struct.bucket_exprs != null) {
        if (struct.isSetBucket_exprs()) {
          oprot.writeFieldBegin(BUCKET_EXPRS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TExpr _iter331 : struct.bucket_exprs)
            {
  ...
  private static class TLakeScanNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TLakeScanNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TLakeScanNode struct) throws org.apache.thrift.TException {
      ...
      }
      {
        ...
        for (io.datafibre.fibre.thrift.TPrimitiveType _iter334 : struct.key_column_type)
        {
      ...
      if (struct.isSetBucket_exprs()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TExpr _iter338 : struct.bucket_exprs)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TLakeScanNode struct) throws org.apache.thrift.TException {
      ...
      struct.setKey_column_nameIsSet(true);
      {
        ...
        struct.key_column_type = new java.util.ArrayList<io.datafibre.fibre.thrift.TPrimitiveType>(_list343.size);
        @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TPrimitiveType _elem344;
        for (int _i345 = 0; _i345 < _list343.size; ++_i345)
        {
          _elem344 = io.datafibre.fibre.thrift.TPrimitiveType.findByValue(iprot.readI32());
          if (_elem344 != null)
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.bucket_exprs = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list356.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem357;
          for (int _i358 = 0; _i358 < _list356.size; ++_i358)
          {
            _elem357 = new io.datafibre.fibre.thrift.TExpr();
            _elem357.read(iprot);
