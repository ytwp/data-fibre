...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/main/java/org/apache/doris/http/common/StarRocksHttpPostObjectAggregator.java
 ...
 */
public class StarRocksHttpPostObjectAggregator extends HttpObjectAggregator {
    private boolean startAggregated = false;

    public StarRocksHttpPostObjectAggregator(int maxContentLength) {
    ...
    // StarRocks FE needn't handle 100-continue header
    @Override
