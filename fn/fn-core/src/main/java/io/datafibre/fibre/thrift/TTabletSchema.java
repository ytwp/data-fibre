...
public class TTabletSchema implements org.apache.thrift.TBase<TTabletSchema, TTabletSchema._Fields>, java.io.Serializable, Cloneable, Comparable<TTabletSchema> {
  ...
  /**
   * 
   * @see io.datafibre.fibre.thrift.TKeysType
   */
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TKeysType keys_type; // required
  /**
   * 
   * @see io.datafibre.fibre.thrift.TStorageType
   */
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TStorageType storage_type; // required
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TColumn> columns; // required
  public double bloom_filter_fpp; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TOlapTableIndex> indexes; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.KEYS_TYPE, new org.apache.thrift.meta_data.FieldMetaData("keys_type", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, io.datafibre.fibre.thrift.TKeysType.class)));
    tmpMap.put(_Fields.STORAGE_TYPE, new org.apache.thrift.meta_data.FieldMetaData("storage_type", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.EnumMetaData(org.apache.thrift.protocol.TType.ENUM, io.datafibre.fibre.thrift.TStorageType.class)));
    ...
    tmpMap.put(_Fields.INDEXES, new org.apache.thrift.meta_data.FieldMetaData("indexes", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, io.datafibre.fibre.thrift.TOlapTableIndex.class))));
  ...
  public TTabletSchema(
    ...
    int schema_hash,
    io.datafibre.fibre.thrift.TKeysType keys_type,
    io.datafibre.fibre.thrift.TStorageType storage_type,
    java.util.List<io.datafibre.fibre.thrift.TColumn> columns)
  {
    this();
  ...
  public TTabletSchema(TTabletSchema other) {
    ...
    if (other.isSetIndexes()) {
      java.util.List<io.datafibre.fibre.thrift.TOlapTableIndex> __this__indexes = new java.util.ArrayList<io.datafibre.fibre.thrift.TOlapTableIndex>(other.indexes.size());
      for (io.datafibre.fibre.thrift.TOlapTableIndex other_element : other.indexes) {
        __this__indexes.add(new io.datafibre.fibre.thrift.TOlapTableIndex(other_element));
      }
   ...
   */
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TKeysType getKeys_type() {
   ...
   * @see io.datafibre.fibre.thrift.TKeysType
   */
  public TTabletSchema setKeys_type(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TKeysType keys_type) {
    this.keys_type = keys_type;
    return this;
  }
   ...
   */
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TStorageType getStorage_type() {
   ...
   * @see io.datafibre.fibre.thrift.TStorageType
   */
  public TTabletSchema setStorage_type(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TStorageType storage_type) {
    this.storage_type = storage_type;
    return this;
  }
  ...
  public TTabletSchema setColumns(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TColumn> columns) {
    this.columns = columns;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TOlapTableIndex> getIndexesIterator() {
    return (this.indexes == null) ? null : this.indexes.iterator();
  }

  public void addToIndexes(io.datafibre.fibre.thrift.TOlapTableIndex elem) {
    if (this.indexes == null) {
      this.indexes = new java.util.ArrayList<io.datafibre.fibre.thrift.TOlapTableIndex>();
    }
    this.indexes.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TOlapTableIndex> getIndexes() {
    return this.indexes;
  }

  public TTabletSchema setIndexes(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TOlapTableIndex> indexes) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case KEYS_TYPE:
      if (value == null) {
        ...
        setKeys_type((io.datafibre.fibre.thrift.TKeysType)value);
      }
      break;
    ...
    case STORAGE_TYPE:
      if (value == null) {
        ...
        setStorage_type((io.datafibre.fibre.thrift.TStorageType)value);
      }
      break;
    ...
    case INDEXES:
      if (value == null) {
        ...
        setIndexes((java.util.List<io.datafibre.fibre.thrift.TOlapTableIndex>)value);
      }
      break;
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TTabletSchema struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 3: // KEYS_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.keys_type = io.datafibre.fibre.thrift.TKeysType.findByValue(iprot.readI32());
          ...
          case 4: // STORAGE_TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.storage_type = io.datafibre.fibre.thrift.TStorageType.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.columns = new java.util.ArrayList<io.datafibre.fibre.thrift.TColumn>(_list0.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TColumn _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = new io.datafibre.fibre.thrift.TColumn();
                  _elem1.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.indexes = new java.util.ArrayList<io.datafibre.fibre.thrift.TOlapTableIndex>(_list3.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TOlapTableIndex _elem4;
                for (int _i5 = 0; _i5 < _list3.size; ++_i5)
                {
                  _elem4 = new io.datafibre.fibre.thrift.TOlapTableIndex();
                  _elem4.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TTabletSchema struct) throws org.apache.thrift.TException {
      ...
      if (struct.columns != null) {
        oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
        {
          ...
          for (io.datafibre.fibre.thrift.TColumn _iter12 : struct.columns)
          {
            _iter12.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.indexes != null) {
        if (struct.isSetIndexes()) {
          oprot.writeFieldBegin(INDEXES_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TOlapTableIndex _iter13 : struct.indexes)
            {
              _iter13.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class TTabletSchemaTupleScheme extends org.apache.thrift.scheme.TupleScheme<TTabletSchema> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TTabletSchema struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.storage_type.getValue());
      {
        ...
        for (io.datafibre.fibre.thrift.TColumn _iter16 : struct.columns)
        {
          _iter16.write(oprot);
        }
      }
      ...
      if (struct.isSetIndexes()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TOlapTableIndex _iter17 : struct.indexes)
          {
            _iter17.write(oprot);
          }
        }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TTabletSchema struct) throws org.apache.thrift.TException {
      ...
      struct.setStorage_typeIsSet(true);
      {
        ...
        struct.columns = new java.util.ArrayList<io.datafibre.fibre.thrift.TColumn>(_list20.size);
        @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TColumn _elem21;
        for (int _i22 = 0; _i22 < _list20.size; ++_i22)
        {
          _elem21 = new io.datafibre.fibre.thrift.TColumn();
          _elem21.read(iprot);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.indexes = new java.util.ArrayList<io.datafibre.fibre.thrift.TOlapTableIndex>(_list23.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TOlapTableIndex _elem24;
          for (int _i25 = 0; _i25 < _list23.size; ++_i25)
          {
            _elem24 = new io.datafibre.fibre.thrift.TOlapTableIndex();
            _elem24.read(iprot);
