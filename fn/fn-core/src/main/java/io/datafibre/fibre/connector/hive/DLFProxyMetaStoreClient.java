...
public class DLFProxyMetaStoreClient implements IMetaStoreClient {
    ...
    @Override
    public void alter_partitions(String catalogId, String dbName, String tblName, List<Partition> partitions,
                                 EnvironmentContext environmentContext)
            throws InvalidOperationException, MetaException, TException {
    ...
    @Override
    public Partition appendPartition(String catalogId, String dbName, String tblName, List<String> values)
            throws InvalidObjectException, AlreadyExistsException, MetaException, TException {
    ...
    @Override
    public boolean dropPartition(String catalogId, String dbName, String tblName, List<String> values,
    ...
    @Override
    public List<Partition> dropPartitions(String catalogId, String dbName, String tblName, List<ObjectPair<Integer,
            byte[]>> partExprs, PartitionDropOptions partitionDropOptions) throws NoSuchObjectException, MetaException,
            TException {
    ...
    @Override
    public void truncateTable(String dbName, String tableName, List<String> partNames) throws MetaException,
            TException {
    ...
    @Override
    public Partition exchange_partition(Map<String, String> partitionSpecs, String srcCatalogId, String srcDb,
    ...
    @Override
    public List<Partition> exchange_partitions(Map<String, String> partitionSpecs, String srcCatalogId,
    ...
    @Override
    public List<String> getAllTables(String catalogId, String dbName) throws MetaException, TException,
            UnknownDBException {
    ...
    @Override
    public List<FieldSchema> getFields(String catalogId, String db, String tableName) throws MetaException,
    ...
    @Override
    public Partition getPartition(String catalogId, String dbName, String tblName, List<String> values)
            throws NoSuchObjectException, MetaException, TException {
    ...
    @Override
    public List<FieldSchema> getSchema(String catalogId, String db, String tableName) throws MetaException,
            TException, UnknownTableException, UnknownDBException {
    ...
    @Override
    public List<Table> getTableObjectsByName(String catalogId, String dbName, List<String> tableNames)
            throws MetaException, InvalidOperationException, UnknownDBException, TException {
    ...
    @Override
    public List<String> getTables(String catalogId, String dbname, String tablePattern) throws MetaException,
    ...
    @Override
    public List<String> getMaterializedViewsForRewriting(String dbName) throws MetaException, TException,
            UnknownDBException {
    ...
    @Override
    public List<String> getMaterializedViewsForRewriting(String catalogId, String dbName) throws MetaException,
            TException, UnknownDBException {
    ...
    @Override
    public List<TableMeta> getTableMeta(String catalogId, String dbPatterns, String tablePatterns,
    ...
    @Override
    public List<String> listPartitionNames(String catalogId, String dbName, String tblName, int max)
            throws NoSuchObjectException, MetaException, TException {
    ...
    @Override
    public List<Partition> listPartitions(String catalogId, String dbName, String tblName, int max)
            throws NoSuchObjectException, MetaException, TException {
    ...
    @Override
    public List<Partition> listPartitions(String catalogId, String databaseName, String tableName,
                                          List<String> values, int max) throws NoSuchObjectException, MetaException, TException {
    ...
    @Override
    public List<Partition> listPartitionsWithAuthInfo(String catalogId, String database, String table,
                                                      List<String> partVals, int maxParts, String user, List<String> groups)
            throws MetaException, TException, NoSuchObjectException {
        return call(this.readWriteClient, client -> client.listPartitionsWithAuthInfo(catalogId, database, table,
    ...
    @Override
    public void renamePartition(String catalogId, String dbName, String tblName, List<String> partitionValues,
    ...
    @Override
    public void addUniqueConstraint(List<SQLUniqueConstraint> uniqueConstraintCols) throws MetaException,
            NoSuchObjectException, TException {
        run(client -> client.addUniqueConstraint(uniqueConstraintCols), "addUniqueConstraint", uniqueConstraintCols);
    }

    @Override
    public void addNotNullConstraint(List<SQLNotNullConstraint> notNullConstraintCols) throws MetaException,
            NoSuchObjectException, TException {
    ...
    @Override
    public void addDefaultConstraint(List<SQLDefaultConstraint> defaultConstraints) throws MetaException,
            NoSuchObjectException, TException {
    ...
    @Override
    public List<WMTrigger> getTriggersForResourcePlan(String resourcePlan) throws NoSuchObjectException,
            MetaException, TException {
    ...
    public void run(ThrowingConsumer<IMetaStoreClient, TException> consumer, String actionName, Object... parameters)
            throws TException {
