...
//   https://github.com/apache/incubator-doris/blob/master/fe/fe-core/src/main/java/org/apache/doris/qe/JournalObserver.java
...
public class JournalObserver implements Comparable<JournalObserver> {
    ...
    public void waitForReplay(int timeoutMs) throws DdlException {
        ...
        try {
            ...
            if (!ok) {
                LOG.warn("timeout waiting result from log replayer thread. timeout ms: {}", timeoutMs);
