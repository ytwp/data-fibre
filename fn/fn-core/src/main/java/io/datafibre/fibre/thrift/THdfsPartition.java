...
public class THdfsPartition implements org.apache.thrift.TBase<THdfsPartition, THdfsPartition._Fields>, java.io.Serializable, Cloneable, Comparable<THdfsPartition> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> partition_key_exprs; // optional
  ...
  public THdfsPartition(THdfsPartition other) {
    ...
    if (other.isSetPartition_key_exprs()) {
      java.util.List<com.starrocks.thrift.TExpr> __this__partition_key_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(other.partition_key_exprs.size());
      for (com.starrocks.thrift.TExpr other_element : other.partition_key_exprs) {
        __this__partition_key_exprs.add(new com.starrocks.thrift.TExpr(other_element));
      }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<com.starrocks.thrift.TExpr> getPartition_key_exprsIterator() {
    return (this.partition_key_exprs == null) ? null : this.partition_key_exprs.iterator();
  }

  public void addToPartition_key_exprs(com.starrocks.thrift.TExpr elem) {
    if (this.partition_key_exprs == null) {
      this.partition_key_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>();
    }
    this.partition_key_exprs.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<com.starrocks.thrift.TExpr> getPartition_key_exprs() {
    return this.partition_key_exprs;
  }

  public THdfsPartition setPartition_key_exprs(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> partition_key_exprs) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case PARTITION_KEY_EXPRS:
      if (value == null) {
        ...
        setPartition_key_exprs((java.util.List<com.starrocks.thrift.TExpr>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_key_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list192.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem193;
                for (int _i194 = 0; _i194 < _list192.size; ++_i194)
                {
                  _elem193 = new com.starrocks.thrift.TExpr();
                  _elem193.read(iprot);
      ...
      if (struct.partition_key_exprs != null) {
        if (struct.isSetPartition_key_exprs()) {
          oprot.writeFieldBegin(PARTITION_KEY_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter195 : struct.partition_key_exprs)
            {
      ...
      if (struct.isSetPartition_key_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter196 : struct.partition_key_exprs)
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.partition_key_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list197.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem198;
          for (int _i199 = 0; _i199 < _list197.size; ++_i199)
          {
            _elem198 = new com.starrocks.thrift.TExpr();
            _elem198.read(iprot);
