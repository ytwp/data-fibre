...
public class TCrossJoinNode implements org.apache.thrift.TBase<TCrossJoinNode, TCrossJoinNode._Fields>, java.io.Serializable, Cloneable, Comparable<TCrossJoinNode> {
  ...
  public TCrossJoinNode setBuild_runtime_filters(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TRuntimeFilterDescription> build_runtime_filters) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.build_runtime_filters = new java.util.ArrayList<com.starrocks.thrift.TRuntimeFilterDescription>(_list914.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TRuntimeFilterDescription _elem915;
                for (int _i916 = 0; _i916 < _list914.size; ++_i916)
                {
                  _elem915 = new com.starrocks.thrift.TRuntimeFilterDescription();
                  _elem915.read(iprot);
      ...
      if (struct.build_runtime_filters != null) {
        if (struct.isSetBuild_runtime_filters()) {
          oprot.writeFieldBegin(BUILD_RUNTIME_FILTERS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TRuntimeFilterDescription _iter917 : struct.build_runtime_filters)
            {
      ...
      if (struct.isSetBuild_runtime_filters()) {
        {
          ...
          for (com.starrocks.thrift.TRuntimeFilterDescription _iter918 : struct.build_runtime_filters)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.build_runtime_filters = new java.util.ArrayList<com.starrocks.thrift.TRuntimeFilterDescription>(_list919.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TRuntimeFilterDescription _elem920;
          for (int _i921 = 0; _i921 < _list919.size; ++_i921)
          {
            _elem920 = new com.starrocks.thrift.TRuntimeFilterDescription();
            _elem920.read(iprot);
