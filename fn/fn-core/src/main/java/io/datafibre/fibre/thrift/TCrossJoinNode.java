...
public class TCrossJoinNode implements org.apache.thrift.TBase<TCrossJoinNode, TCrossJoinNode._Fields>, java.io.Serializable, Cloneable, Comparable<TCrossJoinNode> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TCrossJoinNode");

  private static final org.apache.thrift.protocol.TField BUILD_RUNTIME_FILTERS_FIELD_DESC = new org.apache.thrift.protocol.TField("build_runtime_filters", org.apache.thrift.protocol.TType.LIST, (short)1);

  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TCrossJoinNodeStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TCrossJoinNodeTupleSchemeFactory();
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    BUILD_RUNTIME_FILTERS((short)1, "build_runtime_filters");
  ...
  private static final _Fields optionals[] = {_Fields.BUILD_RUNTIME_FILTERS};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TCrossJoinNode.class, metaDataMap);
  }

  public TCrossJoinNode() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public TCrossJoinNode(TCrossJoinNode other) {
  ...
  @Override
  public TCrossJoinNode deepCopy() {
    return new TCrossJoinNode(this);
  }
  ...
  public TCrossJoinNode setBuild_runtime_filters(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TRuntimeFilterDescription> build_runtime_filters) {
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof TCrossJoinNode)
      return this.equals((TCrossJoinNode)that);
    return false;
  }

  public boolean equals(TCrossJoinNode that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TCrossJoinNode other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TCrossJoinNode(");
    boolean first = true;
  ...
  private static class TCrossJoinNodeStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public TCrossJoinNodeStandardScheme getScheme() {
      return new TCrossJoinNodeStandardScheme();
    }
  }

  private static class TCrossJoinNodeStandardScheme extends org.apache.thrift.scheme.StandardScheme<TCrossJoinNode> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, TCrossJoinNode struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.build_runtime_filters = new java.util.ArrayList<io.datafibre.fibre.thrift.TRuntimeFilterDescription>(_list914.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TRuntimeFilterDescription _elem915;
                for (int _i916 = 0; _i916 < _list914.size; ++_i916)
                {
                  _elem915 = new io.datafibre.fibre.thrift.TRuntimeFilterDescription();
                  _elem915.read(iprot);
                  struct.build_runtime_filters.add(_elem915);
                }
                iprot.readListEnd();
              }
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCrossJoinNode struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.build_runtime_filters != null) {
        if (struct.isSetBuild_runtime_filters()) {
          oprot.writeFieldBegin(BUILD_RUNTIME_FILTERS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TRuntimeFilterDescription _iter917 : struct.build_runtime_filters)
            {
  ...
  private static class TCrossJoinNodeTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public TCrossJoinNodeTupleScheme getScheme() {
      return new TCrossJoinNodeTupleScheme();
    }
  }

  private static class TCrossJoinNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TCrossJoinNode> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TCrossJoinNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetBuild_runtime_filters()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TRuntimeFilterDescription _iter918 : struct.build_runtime_filters)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TCrossJoinNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      java.util.BitSet incoming = iprot.readBitSet(1);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list919 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.build_runtime_filters = new java.util.ArrayList<io.datafibre.fibre.thrift.TRuntimeFilterDescription>(_list919.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TRuntimeFilterDescription _elem920;
          for (int _i921 = 0; _i921 < _list919.size; ++_i921)
          {
            _elem920 = new io.datafibre.fibre.thrift.TRuntimeFilterDescription();
            _elem920.read(iprot);
            struct.build_runtime_filters.add(_elem920);
          }
        }
        struct.setBuild_runtime_filtersIsSet(true);
      }
