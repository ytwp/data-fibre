...
public interface PTabletWriterOpenRequestOrBuilder extends
   ...
   */
  java.util.List<com.starrocks.proto.PTabletWithPartition> 
      getTabletsList();
  /**
   * <code>repeated .starrocks.PTabletWithPartition tablets = 5;</code>
   */
  com.starrocks.proto.PTabletWithPartition getTablets(int index);
  /**
   * <code>repeated .starrocks.PTabletWithPartition tablets = 5;</code>
   */
  int getTabletsCount();
   ...
   * <code>repeated .starrocks.PTabletWithPartition tablets = 5;</code>
   */
  java.util.List<? extends com.starrocks.proto.PTabletWithPartitionOrBuilder> 
      getTabletsOrBuilderList();
  /**
   * <code>repeated .starrocks.PTabletWithPartition tablets = 5;</code>
   */
  com.starrocks.proto.PTabletWithPartitionOrBuilder getTabletsOrBuilder(
      int index);
   ...
   */
  com.starrocks.proto.WriteQuorumTypePB getWriteQuorum();
