...
public class TCaseExpr implements org.apache.thrift.TBase<TCaseExpr, TCaseExpr._Fields>, java.io.Serializable, Cloneable, Comparable<TCaseExpr> {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case HAS_CASE_EXPR:
      if (value == null) {
        ...
        setHas_case_expr((java.lang.Boolean)value);
      }
      break;
    ...
    case HAS_ELSE_EXPR:
      if (value == null) {
        ...
        setHas_else_expr((java.lang.Boolean)value);
      }
      break;
  ...
  public int compareTo(TCaseExpr other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetHas_case_expr(), other.isSetHas_case_expr());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetHas_else_expr(), other.isSetHas_else_expr());
    if (lastComparison != 0) {
      return lastComparison;
    }
