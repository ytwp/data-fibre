...
public class TCommitRemoteTxnRequest implements org.apache.thrift.TBase<TCommitRemoteTxnRequest, TCommitRemoteTxnRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TCommitRemoteTxnRequest> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TCommitRemoteTxnRequest");
  ...
  private static final org.apache.thrift.protocol.TField COMMIT_TIMEOUT_MS_FIELD_DESC = new org.apache.thrift.protocol.TField("commit_timeout_ms", org.apache.thrift.protocol.TType.I32, (short)4);
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TCommitRemoteTxnRequestStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TCommitRemoteTxnRequestTupleSchemeFactory();
  ...
  public int commit_timeout_ms; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TTabletCommitInfo> commit_infos; // optional
  public @org.apache.thrift.annotation.Nullable TTxnCommitAttachment commit_attachment; // optional
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TTabletFailInfo> fail_infos; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    COMMIT_TIMEOUT_MS((short)4, "commit_timeout_ms"),
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 3: // AUTH_INFO
          return AUTH_INFO;
        case 4: // COMMIT_TIMEOUT_MS
          return COMMIT_TIMEOUT_MS;
        case 5: // COMMIT_INFOS
          return COMMIT_INFOS;
  ...
  private static final int __COMMIT_TIMEOUT_MS_ISSET_ID = 2;
  private byte __isset_bitfield = 0;
  private static final _Fields optionals[] = {_Fields.TXN_ID,_Fields.DB_ID,_Fields.AUTH_INFO,_Fields.COMMIT_TIMEOUT_MS,_Fields.COMMIT_INFOS,_Fields.COMMIT_ATTACHMENT,_Fields.FAIL_INFOS};
  ...
  static {
    ...
    tmpMap.put(_Fields.COMMIT_TIMEOUT_MS, new org.apache.thrift.meta_data.FieldMetaData("commit_timeout_ms", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TCommitRemoteTxnRequest.class, metaDataMap);
  }

  public TCommitRemoteTxnRequest() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public TCommitRemoteTxnRequest(TCommitRemoteTxnRequest other) {
    ...
    this.commit_timeout_ms = other.commit_timeout_ms;
    if (other.isSetCommit_infos()) {
      java.util.List<io.datafibre.fibre.thrift.TTabletCommitInfo> __this__commit_infos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletCommitInfo>(other.commit_infos.size());
      for (io.datafibre.fibre.thrift.TTabletCommitInfo other_element : other.commit_infos) {
        __this__commit_infos.add(new io.datafibre.fibre.thrift.TTabletCommitInfo(other_element));
      }
    ...
    if (other.isSetFail_infos()) {
      java.util.List<io.datafibre.fibre.thrift.TTabletFailInfo> __this__fail_infos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletFailInfo>(other.fail_infos.size());
      for (io.datafibre.fibre.thrift.TTabletFailInfo other_element : other.fail_infos) {
        __this__fail_infos.add(new io.datafibre.fibre.thrift.TTabletFailInfo(other_element));
      }
  ...
  @Override
  public TCommitRemoteTxnRequest deepCopy() {
    return new TCommitRemoteTxnRequest(this);
  }
  ...
  public void clear() {
    ...
    this.db_id = 0;
    this.auth_info = null;
    setCommit_timeout_msIsSet(false);
    this.commit_timeout_ms = 0;
  ...
  public TCommitRemoteTxnRequest setTxn_id(long txn_id) {
    this.txn_id = txn_id;
    setTxn_idIsSet(true);
    return this;
  }
  ...
  public TCommitRemoteTxnRequest setDb_id(long db_id) {
    this.db_id = db_id;
    setDb_idIsSet(true);
    return this;
  }
  ...
  public TCommitRemoteTxnRequest setAuth_info(@org.apache.thrift.annotation.Nullable TAuthenticateParams auth_info) {
  ...
  public int getCommit_timeout_ms() {
    return this.commit_timeout_ms;
  }

  public TCommitRemoteTxnRequest setCommit_timeout_ms(int commit_timeout_ms) {
    this.commit_timeout_ms = commit_timeout_ms;
    setCommit_timeout_msIsSet(true);
    return this;
  }

  public void unsetCommit_timeout_ms() {
    __isset_bitfield = org.apache.thrift.EncodingUtils.clearBit(__isset_bitfield, __COMMIT_TIMEOUT_MS_ISSET_ID);
  }

  /** Returns true if field commit_timeout_ms is set (has been assigned a value) and false otherwise */
  public boolean isSetCommit_timeout_ms() {
    return org.apache.thrift.EncodingUtils.testBit(__isset_bitfield, __COMMIT_TIMEOUT_MS_ISSET_ID);
  }

  public void setCommit_timeout_msIsSet(boolean value) {
    __isset_bitfield = org.apache.thrift.EncodingUtils.setBit(__isset_bitfield, __COMMIT_TIMEOUT_MS_ISSET_ID, value);
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TTabletCommitInfo> getCommit_infosIterator() {
    return (this.commit_infos == null) ? null : this.commit_infos.iterator();
  }

  public void addToCommit_infos(io.datafibre.fibre.thrift.TTabletCommitInfo elem) {
    if (this.commit_infos == null) {
      this.commit_infos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletCommitInfo>();
    }
    this.commit_infos.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TTabletCommitInfo> getCommit_infos() {
    return this.commit_infos;
  }

  public TCommitRemoteTxnRequest setCommit_infos(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TTabletCommitInfo> commit_infos) {
  ...
  public TCommitRemoteTxnRequest setCommit_attachment(@org.apache.thrift.annotation.Nullable TTxnCommitAttachment commit_attachment) {
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TTabletFailInfo> getFail_infosIterator() {
    return (this.fail_infos == null) ? null : this.fail_infos.iterator();
  }

  public void addToFail_infos(io.datafibre.fibre.thrift.TTabletFailInfo elem) {
    if (this.fail_infos == null) {
      this.fail_infos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletFailInfo>();
    }
    this.fail_infos.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TTabletFailInfo> getFail_infos() {
    return this.fail_infos;
  }

  public TCommitRemoteTxnRequest setFail_infos(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TTabletFailInfo> fail_infos) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case COMMIT_TIMEOUT_MS:
      if (value == null) {
        unsetCommit_timeout_ms();
      } else {
        setCommit_timeout_ms((java.lang.Integer)value);
      }
      break;
    ...
    case COMMIT_INFOS:
      if (value == null) {
        ...
        setCommit_infos((java.util.List<io.datafibre.fibre.thrift.TTabletCommitInfo>)value);
      }
      break;
    ...
    case FAIL_INFOS:
      if (value == null) {
        ...
        setFail_infos((java.util.List<io.datafibre.fibre.thrift.TTabletFailInfo>)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof TCommitRemoteTxnRequest)
      return this.equals((TCommitRemoteTxnRequest)that);
    return false;
  }

  public boolean equals(TCommitRemoteTxnRequest that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
    ...
    boolean this_present_commit_timeout_ms = true && this.isSetCommit_timeout_ms();
    boolean that_present_commit_timeout_ms = true && that.isSetCommit_timeout_ms();
    if (this_present_commit_timeout_ms || that_present_commit_timeout_ms) {
      if (!(this_present_commit_timeout_ms && that_present_commit_timeout_ms))
        return false;
      if (this.commit_timeout_ms != that.commit_timeout_ms)
        return false;
    }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetCommit_timeout_ms()) ? 131071 : 524287);
    if (isSetCommit_timeout_ms())
      hashCode = hashCode * 8191 + commit_timeout_ms;
  ...
  @Override
  public int compareTo(TCommitRemoteTxnRequest other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetCommit_timeout_ms(), other.isSetCommit_timeout_ms());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCommit_timeout_ms()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.commit_timeout_ms, other.commit_timeout_ms);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TCommitRemoteTxnRequest(");
    boolean first = true;
    ...
    if (isSetCommit_timeout_ms()) {
      if (!first) sb.append(", ");
      sb.append("commit_timeout_ms:");
      sb.append(this.commit_timeout_ms);
      first = false;
    }
    if (isSetCommit_infos()) {
      if (!first) sb.append(", ");
  ...
  private static class TCommitRemoteTxnRequestStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public TCommitRemoteTxnRequestStandardScheme getScheme() {
      return new TCommitRemoteTxnRequestStandardScheme();
    }
  }

  private static class TCommitRemoteTxnRequestStandardScheme extends org.apache.thrift.scheme.StandardScheme<TCommitRemoteTxnRequest> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, TCommitRemoteTxnRequest struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 4: // COMMIT_TIMEOUT_MS
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.commit_timeout_ms = iprot.readI32();
              struct.setCommit_timeout_msIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.commit_infos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletCommitInfo>(_list550.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletCommitInfo _elem551;
                for (int _i552 = 0; _i552 < _list550.size; ++_i552)
                {
                  _elem551 = new io.datafibre.fibre.thrift.TTabletCommitInfo();
                  _elem551.read(iprot);
                  struct.commit_infos.add(_elem551);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fail_infos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletFailInfo>(_list553.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletFailInfo _elem554;
                for (int _i555 = 0; _i555 < _list553.size; ++_i555)
                {
                  _elem554 = new io.datafibre.fibre.thrift.TTabletFailInfo();
                  _elem554.read(iprot);
                  struct.fail_infos.add(_elem554);
                }
                iprot.readListEnd();
              }
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, TCommitRemoteTxnRequest struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.isSetCommit_timeout_ms()) {
        oprot.writeFieldBegin(COMMIT_TIMEOUT_MS_FIELD_DESC);
        oprot.writeI32(struct.commit_timeout_ms);
        oprot.writeFieldEnd();
      }
      if (struct.commit_infos != null) {
        if (struct.isSetCommit_infos()) {
          oprot.writeFieldBegin(COMMIT_INFOS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TTabletCommitInfo _iter556 : struct.commit_infos)
            {
      ...
      if (struct.fail_infos != null) {
        if (struct.isSetFail_infos()) {
          oprot.writeFieldBegin(FAIL_INFOS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TTabletFailInfo _iter557 : struct.fail_infos)
            {
  ...
  private static class TCommitRemoteTxnRequestTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public TCommitRemoteTxnRequestTupleScheme getScheme() {
      return new TCommitRemoteTxnRequestTupleScheme();
    }
  }

  private static class TCommitRemoteTxnRequestTupleScheme extends org.apache.thrift.scheme.TupleScheme<TCommitRemoteTxnRequest> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TCommitRemoteTxnRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetCommit_infos()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TTabletCommitInfo _iter558 : struct.commit_infos)
          {
      ...
      if (struct.isSetFail_infos()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TTabletFailInfo _iter559 : struct.fail_infos)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TCommitRemoteTxnRequest struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list560 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.commit_infos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletCommitInfo>(_list560.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletCommitInfo _elem561;
          for (int _i562 = 0; _i562 < _list560.size; ++_i562)
          {
            _elem561 = new io.datafibre.fibre.thrift.TTabletCommitInfo();
            _elem561.read(iprot);
            struct.commit_infos.add(_elem561);
          }
        }
        struct.setCommit_infosIsSet(true);
      }
      ...
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TList _list563 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
          struct.fail_infos = new java.util.ArrayList<io.datafibre.fibre.thrift.TTabletFailInfo>(_list563.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TTabletFailInfo _elem564;
          for (int _i565 = 0; _i565 < _list563.size; ++_i565)
          {
            _elem564 = new io.datafibre.fibre.thrift.TTabletFailInfo();
            _elem564.read(iprot);
            struct.fail_infos.add(_elem564);
          }
        }
        struct.setFail_infosIsSet(true);
      }
