...
public class TExecShortCircuitParams implements org.apache.thrift.TBase<TExecShortCircuitParams, TExecShortCircuitParams._Fields>, java.io.Serializable, Cloneable, Comparable<TExecShortCircuitParams> {
  ...
  public @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TDataSink data_sink; // optional
  public boolean is_binary_row; // optional
  public boolean enable_profile; // optional
  public @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TScanRange scan_range; // optional
  ...
  public TExecShortCircuitParams(TExecShortCircuitParams other) {
    ...
    if (other.isSetData_sink()) {
      this.data_sink = new com.starrocks.thrift.TDataSink(other.data_sink);
    }
  ...
  public TExecShortCircuitParams setDesc_tbl(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TDescriptorTable desc_tbl) {
  ...
  public TExecShortCircuitParams setPlan(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TPlan plan) {
    this.plan = plan;
    return this;
  }
  ...
  public TExecShortCircuitParams setOutput_exprs(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> output_exprs) {
  ...
  @org.apache.thrift.annotation.Nullable
  public com.starrocks.thrift.TDataSink getData_sink() {
    return this.data_sink;
  }

  public TExecShortCircuitParams setData_sink(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TDataSink data_sink) {
  ...
  public TExecShortCircuitParams setScan_range(@org.apache.thrift.annotation.Nullable com.starrocks.thrift.TScanRange scan_range) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case DATA_SINK:
      if (value == null) {
        ...
        setData_sink((com.starrocks.thrift.TDataSink)value);
      }
      break;
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TExecShortCircuitParams struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.output_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list8.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new com.starrocks.thrift.TExpr();
                  _elem9.read(iprot);
          ...
          case 4: // DATA_SINK
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.data_sink = new com.starrocks.thrift.TDataSink();
      ...
      if (struct.output_exprs != null) {
        if (struct.isSetOutput_exprs()) {
          oprot.writeFieldBegin(OUTPUT_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter20 : struct.output_exprs)
            {
              _iter20.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetOutput_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter24 : struct.output_exprs)
          {
            _iter24.write(oprot);
          }
        }
