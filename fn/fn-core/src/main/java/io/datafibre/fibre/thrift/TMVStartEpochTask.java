...
public class TMVStartEpochTask implements org.apache.thrift.TBase<TMVStartEpochTask, TMVStartEpochTask._Fields>, java.io.Serializable, Cloneable, Comparable<TMVStartEpochTask> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>> per_node_scan_ranges; // optional
  ...
  public TMVStartEpochTask(TMVStartEpochTask other) {
    ...
    if (other.isSetPer_node_scan_ranges()) {
      java.util.Map<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>> __this__per_node_scan_ranges = new java.util.HashMap<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>>(other.per_node_scan_ranges.size());
      for (java.util.Map.Entry<io.datafibre.fibre.thrift.TUniqueId, java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>> other_element : other.per_node_scan_ranges.entrySet()) {
        ...
        io.datafibre.fibre.thrift.TUniqueId __this__per_node_scan_ranges_copy_key = new io.datafibre.fibre.thrift.TUniqueId(other_element_key);

        java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>> __this__per_node_scan_ranges_copy_value = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>(other_element_value.size());
        for (java.util.Map.Entry<java.lang.Integer, java.util.List<io.datafibre.fibre.thrift.TScanRange>> other_element_value_element : other_element_value.entrySet()) {
          ...
          java.util.List<io.datafibre.fibre.thrift.TScanRange> __this__per_node_scan_ranges_copy_value_copy_value = new java.util.ArrayList<io.datafibre.fibre.thrift.TScanRange>(other_element_value_element_value.size());
          for (io.datafibre.fibre.thrift.TScanRange other_element_value_element_value_element : other_element_value_element_value) {
            __this__per_node_scan_ranges_copy_value_copy_value.add(new io.datafibre.fibre.thrift.TScanRange(other_element_value_element_value_element));
          }
  ...
  public void putToPer_node_scan_ranges(io.datafibre.fibre.thrift.TUniqueId key, java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>> val) {
    if (this.per_node_scan_ranges == null) {
      this.per_node_scan_ranges = new java.util.HashMap<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>>();
    }
    this.per_node_scan_ranges.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>> getPer_node_scan_ranges() {
    return this.per_node_scan_ranges;
  }

  public TMVStartEpochTask setPer_node_scan_ranges(@org.apache.thrift.annotation.Nullable java.util.Map<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>> per_node_scan_ranges) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case PER_NODE_SCAN_RANGES:
      if (value == null) {
        ...
        setPer_node_scan_ranges((java.util.Map<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.per_node_scan_ranges = new java.util.HashMap<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>>(2*_map8.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TUniqueId _key9;
                @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>> _val10;
                for (int _i11 = 0; _i11 < _map8.size; ++_i11)
                {
                  _key9 = new io.datafibre.fibre.thrift.TUniqueId();
                  _key9.read(iprot);
                  {
                    org.apache.thrift.protocol.TMap _map12 = iprot.readMapBegin();
                    _val10 = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>(2*_map12.size);
                    int _key13;
                    @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TScanRange> _val14;
                    for (int _i15 = 0; _i15 < _map12.size; ++_i15)
                    {
                      _key13 = iprot.readI32();
                      {
                        org.apache.thrift.protocol.TList _list16 = iprot.readListBegin();
                        _val14 = new java.util.ArrayList<io.datafibre.fibre.thrift.TScanRange>(_list16.size);
                        @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TScanRange _elem17;
                        for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                        {
                          _elem17 = new io.datafibre.fibre.thrift.TScanRange();
                          _elem17.read(iprot);
                          _val14.add(_elem17);
                        }
                        iprot.readListEnd();
      ...
      if (struct.per_node_scan_ranges != null) {
        if (struct.isSetPer_node_scan_ranges()) {
          oprot.writeFieldBegin(PER_NODE_SCAN_RANGES_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<io.datafibre.fibre.thrift.TUniqueId, java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>> _iter19 : struct.per_node_scan_ranges.entrySet())
            {
              _iter19.getKey().write(oprot);
              {
                ...
                for (java.util.Map.Entry<java.lang.Integer, java.util.List<io.datafibre.fibre.thrift.TScanRange>> _iter20 : _iter19.getValue().entrySet())
                {
                  oprot.writeI32(_iter20.getKey());
                  {
                    ...
                    for (io.datafibre.fibre.thrift.TScanRange _iter21 : _iter20.getValue())
                    {
                      _iter21.write(oprot);
                    }
                    oprot.writeListEnd();
      ...
      if (struct.isSetPer_node_scan_ranges()) {
        {
          ...
          for (java.util.Map.Entry<io.datafibre.fibre.thrift.TUniqueId, java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>> _iter22 : struct.per_node_scan_ranges.entrySet())
          {
            _iter22.getKey().write(oprot);
            {
              oprot.writeI32(_iter22.getValue().size());
              for (java.util.Map.Entry<java.lang.Integer, java.util.List<io.datafibre.fibre.thrift.TScanRange>> _iter23 : _iter22.getValue().entrySet())
              {
                oprot.writeI32(_iter23.getKey());
                {
                  oprot.writeI32(_iter23.getValue().size());
                  for (io.datafibre.fibre.thrift.TScanRange _iter24 : _iter23.getValue())
                  {
                    _iter24.write(oprot);
                  }
                }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.per_node_scan_ranges = new java.util.HashMap<io.datafibre.fibre.thrift.TUniqueId,java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>>(2*_map25.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TUniqueId _key26;
          @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>> _val27;
          for (int _i28 = 0; _i28 < _map25.size; ++_i28)
          {
            _key26 = new io.datafibre.fibre.thrift.TUniqueId();
            _key26.read(iprot);
            {
              ...
              _val27 = new java.util.HashMap<java.lang.Integer,java.util.List<io.datafibre.fibre.thrift.TScanRange>>(2*_map29.size);
              int _key30;
              @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TScanRange> _val31;
              for (int _i32 = 0; _i32 < _map29.size; ++_i32)
              {
                _key30 = iprot.readI32();
                {
                  ...
                  _val31 = new java.util.ArrayList<io.datafibre.fibre.thrift.TScanRange>(_list33.size);
                  @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TScanRange _elem34;
                  for (int _i35 = 0; _i35 < _list33.size; ++_i35)
                  {
                    _elem34 = new io.datafibre.fibre.thrift.TScanRange();
                    _elem34.read(iprot);
                    _val31.add(_elem34);
                  }
                }
