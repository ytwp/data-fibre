...
public class TAnalyticWindowBoundary implements org.apache.thrift.TBase<TAnalyticWindowBoundary, TAnalyticWindowBoundary._Fields>, java.io.Serializable, Cloneable, Comparable<TAnalyticWindowBoundary> {
  ...
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr range_offset_predicate; // optional
  ...
  public TAnalyticWindowBoundary(TAnalyticWindowBoundary other) {
    ...
    if (other.isSetRange_offset_predicate()) {
      this.range_offset_predicate = new io.datafibre.fibre.thrift.TExpr(other.range_offset_predicate);
    }
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TExpr getRange_offset_predicate() {
    return this.range_offset_predicate;
  }

  public TAnalyticWindowBoundary setRange_offset_predicate(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr range_offset_predicate) {
  ...
  public TAnalyticWindowBoundary setRows_offset_value(long rows_offset_value) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case RANGE_OFFSET_PREDICATE:
      if (value == null) {
        ...
        setRange_offset_predicate((io.datafibre.fibre.thrift.TExpr)value);
      }
      break;
    ...
    case ROWS_OFFSET_VALUE:
      if (value == null) {
        ...
        setRows_offset_value((java.lang.Long)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((isSetRange_offset_predicate()) ? 131071 : 524287);
    if (isSetRange_offset_predicate())
      hashCode = hashCode * 8191 + range_offset_predicate.hashCode();

    hashCode = hashCode * 8191 + ((isSetRows_offset_value()) ? 131071 : 524287);
  ...
  public int compareTo(TAnalyticWindowBoundary other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRange_offset_predicate(), other.isSetRange_offset_predicate());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRange_offset_predicate()) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetRows_offset_value(), other.isSetRows_offset_value());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRows_offset_value()) {
        ...
        switch (schemeField.id) {
          case 1: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = io.datafibre.fibre.thrift.TAnalyticWindowBoundaryType.findByValue(iprot.readI32());
          ...
          case 2: // RANGE_OFFSET_PREDICATE
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.range_offset_predicate = new io.datafibre.fibre.thrift.TExpr();
