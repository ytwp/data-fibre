...
public class TStreamAggregationNode implements org.apache.thrift.TBase<TStreamAggregationNode, TStreamAggregationNode._Fields>, java.io.Serializable, Cloneable, Comparable<TStreamAggregationNode> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> aggregate_functions; // optional
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TIMTDescriptor agg_result_imt; // optional
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TIMTDescriptor agg_intermediate_imt; // optional
  public @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TIMTDescriptor agg_detail_imt; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.AGG_RESULT_IMT, new org.apache.thrift.meta_data.FieldMetaData("agg_result_imt", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, io.datafibre.fibre.thrift.TIMTDescriptor.class)));
  ...
  public TStreamAggregationNode(TStreamAggregationNode other) {
    ...
    if (other.isSetAgg_result_imt()) {
      this.agg_result_imt = new io.datafibre.fibre.thrift.TIMTDescriptor(other.agg_result_imt);
    }
    if (other.isSetAgg_intermediate_imt()) {
      this.agg_intermediate_imt = new io.datafibre.fibre.thrift.TIMTDescriptor(other.agg_intermediate_imt);
    }
    if (other.isSetAgg_detail_imt()) {
      this.agg_detail_imt = new io.datafibre.fibre.thrift.TIMTDescriptor(other.agg_detail_imt);
    }
  ...
  public TStreamAggregationNode setGrouping_exprs(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> grouping_exprs) {
  ...
  public TStreamAggregationNode setAggregate_functions(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> aggregate_functions) {
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TIMTDescriptor getAgg_result_imt() {
    return this.agg_result_imt;
  }

  public TStreamAggregationNode setAgg_result_imt(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TIMTDescriptor agg_result_imt) {
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TIMTDescriptor getAgg_intermediate_imt() {
    return this.agg_intermediate_imt;
  }

  public TStreamAggregationNode setAgg_intermediate_imt(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TIMTDescriptor agg_intermediate_imt) {
  ...
  @org.apache.thrift.annotation.Nullable
  public io.datafibre.fibre.thrift.TIMTDescriptor getAgg_detail_imt() {
    return this.agg_detail_imt;
  }

  public TStreamAggregationNode setAgg_detail_imt(@org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TIMTDescriptor agg_detail_imt) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case AGG_RESULT_IMT:
      if (value == null) {
        ...
        setAgg_result_imt((io.datafibre.fibre.thrift.TIMTDescriptor)value);
      }
      break;
    ...
    case AGG_INTERMEDIATE_IMT:
      if (value == null) {
        ...
        setAgg_intermediate_imt((io.datafibre.fibre.thrift.TIMTDescriptor)value);
      }
      break;
    ...
    case AGG_DETAIL_IMT:
      if (value == null) {
        ...
        setAgg_detail_imt((io.datafibre.fibre.thrift.TIMTDescriptor)value);
      }
      break;
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.grouping_exprs = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list978.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem979;
                for (int _i980 = 0; _i980 < _list978.size; ++_i980)
                {
                  _elem979 = new io.datafibre.fibre.thrift.TExpr();
                  _elem979.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.aggregate_functions = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list981.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem982;
                for (int _i983 = 0; _i983 < _list981.size; ++_i983)
                {
                  _elem982 = new io.datafibre.fibre.thrift.TExpr();
                  _elem982.read(iprot);
          ...
          case 10: // AGG_RESULT_IMT
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.agg_result_imt = new io.datafibre.fibre.thrift.TIMTDescriptor();
          ...
          case 11: // AGG_INTERMEDIATE_IMT
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.agg_intermediate_imt = new io.datafibre.fibre.thrift.TIMTDescriptor();
          ...
          case 12: // AGG_DETAIL_IMT
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.agg_detail_imt = new io.datafibre.fibre.thrift.TIMTDescriptor();
      ...
      if (struct.grouping_exprs != null) {
        if (struct.isSetGrouping_exprs()) {
          oprot.writeFieldBegin(GROUPING_EXPRS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TExpr _iter984 : struct.grouping_exprs)
            {
      ...
      if (struct.aggregate_functions != null) {
        if (struct.isSetAggregate_functions()) {
          oprot.writeFieldBegin(AGGREGATE_FUNCTIONS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TExpr _iter985 : struct.aggregate_functions)
            {
      ...
      if (struct.isSetGrouping_exprs()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TExpr _iter986 : struct.grouping_exprs)
          {
      ...
      if (struct.isSetAggregate_functions()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TExpr _iter987 : struct.aggregate_functions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.grouping_exprs = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list988.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem989;
          for (int _i990 = 0; _i990 < _list988.size; ++_i990)
          {
            _elem989 = new io.datafibre.fibre.thrift.TExpr();
            _elem989.read(iprot);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.aggregate_functions = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list991.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem992;
          for (int _i993 = 0; _i993 < _list991.size; ++_i993)
          {
            _elem992 = new io.datafibre.fibre.thrift.TExpr();
            _elem992.read(iprot);
