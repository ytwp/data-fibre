...
public class TStreamJoinNode implements org.apache.thrift.TBase<TStreamJoinNode, TStreamJoinNode._Fields>, java.io.Serializable, Cloneable, Comparable<TStreamJoinNode> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TStreamJoinNode");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TStreamJoinNodeStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TStreamJoinNodeTupleSchemeFactory();
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> other_join_conjuncts; // optional
  ...
  private static final _Fields optionals[] = {_Fields.OTHER_JOIN_CONJUNCTS,_Fields.IS_PUSH_DOWN,_Fields.SQL_JOIN_PREDICATES,_Fields.SQL_PREDICATES,_Fields.DISTRIBUTION_MODE,_Fields.PARTITION_EXPRS,_Fields.OUTPUT_COLUMNS};
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TStreamJoinNode.class, metaDataMap);
  }

  public TStreamJoinNode() {
  }
   ...
   */
  public TStreamJoinNode(TStreamJoinNode other) {
    ...
    if (other.isSetOther_join_conjuncts()) {
      java.util.List<io.datafibre.fibre.thrift.TExpr> __this__other_join_conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(other.other_join_conjuncts.size());
      for (io.datafibre.fibre.thrift.TExpr other_element : other.other_join_conjuncts) {
        __this__other_join_conjuncts.add(new io.datafibre.fibre.thrift.TExpr(other_element));
      }
  ...
  @Override
  public TStreamJoinNode deepCopy() {
    return new TStreamJoinNode(this);
  }
   ...
   * @see TJoinOp
   */
  public TStreamJoinNode setJoin_op(@org.apache.thrift.annotation.Nullable TJoinOp join_op) {
    this.join_op = join_op;
    return this;
  }
  ...
  public TStreamJoinNode setEq_join_conjuncts(@org.apache.thrift.annotation.Nullable java.util.List<TEqJoinCondition> eq_join_conjuncts) {
    this.eq_join_conjuncts = eq_join_conjuncts;
    return this;
  }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TExpr> getOther_join_conjunctsIterator() {
    return (this.other_join_conjuncts == null) ? null : this.other_join_conjuncts.iterator();
  }

  public void addToOther_join_conjuncts(io.datafibre.fibre.thrift.TExpr elem) {
    if (this.other_join_conjuncts == null) {
      this.other_join_conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>();
    }
    this.other_join_conjuncts.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TExpr> getOther_join_conjuncts() {
    return this.other_join_conjuncts;
  }

  public TStreamJoinNode setOther_join_conjuncts(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> other_join_conjuncts) {
  ...
  public TStreamJoinNode setIs_push_down(boolean is_push_down) {
  ...
  public TStreamJoinNode setSql_join_predicates(@org.apache.thrift.annotation.Nullable java.lang.String sql_join_predicates) {
  ...
  public TStreamJoinNode setSql_predicates(@org.apache.thrift.annotation.Nullable java.lang.String sql_predicates) {
   ...
   * @see TJoinDistributionMode
   */
  public TStreamJoinNode setDistribution_mode(@org.apache.thrift.annotation.Nullable TJoinDistributionMode distribution_mode) {
  ...
  public TStreamJoinNode setPartition_exprs(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> partition_exprs) {
  ...
  public TStreamJoinNode setOutput_columns(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> output_columns) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case OTHER_JOIN_CONJUNCTS:
      if (value == null) {
        ...
        setOther_join_conjuncts((java.util.List<io.datafibre.fibre.thrift.TExpr>)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof TStreamJoinNode)
      return this.equals((TStreamJoinNode)that);
    return false;
  }

  public boolean equals(TStreamJoinNode that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TStreamJoinNode other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TStreamJoinNode(");
    boolean first = true;
  ...
  private static class TStreamJoinNodeStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public TStreamJoinNodeStandardScheme getScheme() {
      return new TStreamJoinNodeStandardScheme();
    }
  }

  private static class TStreamJoinNodeStandardScheme extends org.apache.thrift.scheme.StandardScheme<TStreamJoinNode> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, TStreamJoinNode struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.eq_join_conjuncts = new java.util.ArrayList<TEqJoinCondition>(_list946.size);
                @org.apache.thrift.annotation.Nullable TEqJoinCondition _elem947;
                for (int _i948 = 0; _i948 < _list946.size; ++_i948)
                {
                  _elem947 = new TEqJoinCondition();
                  _elem947.read(iprot);
                  struct.eq_join_conjuncts.add(_elem947);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.other_join_conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list949.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem950;
                for (int _i951 = 0; _i951 < _list949.size; ++_i951)
                {
                  _elem950 = new io.datafibre.fibre.thrift.TExpr();
                  _elem950.read(iprot);
                  struct.other_join_conjuncts.add(_elem950);
                }
                iprot.readListEnd();
              }
          ...
          case 52: // DISTRIBUTION_MODE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.distribution_mode = io.datafibre.fibre.thrift.TJoinDistributionMode.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_exprs = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list952.size);
                @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem953;
                for (int _i954 = 0; _i954 < _list952.size; ++_i954)
                {
                  _elem953 = new io.datafibre.fibre.thrift.TExpr();
                  _elem953.read(iprot);
                  struct.partition_exprs.add(_elem953);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.output_columns = new java.util.ArrayList<java.lang.Integer>(_list955.size);
                int _elem956;
                for (int _i957 = 0; _i957 < _list955.size; ++_i957)
                {
                  _elem956 = iprot.readI32();
                  struct.output_columns.add(_elem956);
                }
                iprot.readListEnd();
              }
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, TStreamJoinNode struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.eq_join_conjuncts != null) {
        oprot.writeFieldBegin(EQ_JOIN_CONJUNCTS_FIELD_DESC);
        {
          ...
          for (TEqJoinCondition _iter958 : struct.eq_join_conjuncts)
          {
      ...
      if (struct.other_join_conjuncts != null) {
        if (struct.isSetOther_join_conjuncts()) {
          oprot.writeFieldBegin(OTHER_JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TExpr _iter959 : struct.other_join_conjuncts)
            {
      ...
      if (struct.partition_exprs != null) {
        if (struct.isSetPartition_exprs()) {
          oprot.writeFieldBegin(PARTITION_EXPRS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TExpr _iter960 : struct.partition_exprs)
            {
      ...
      if (struct.output_columns != null) {
        if (struct.isSetOutput_columns()) {
          oprot.writeFieldBegin(OUTPUT_COLUMNS_FIELD_DESC);
          {
            ...
            for (int _iter961 : struct.output_columns)
            {
              oprot.writeI32(_iter961);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class TStreamJoinNodeTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public TStreamJoinNodeTupleScheme getScheme() {
      return new TStreamJoinNodeTupleScheme();
    }
  }

  private static class TStreamJoinNodeTupleScheme extends org.apache.thrift.scheme.TupleScheme<TStreamJoinNode> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TStreamJoinNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol oprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      oprot.writeI32(struct.join_op.getValue());
      {
        oprot.writeI32(struct.eq_join_conjuncts.size());
        for (TEqJoinCondition _iter962 : struct.eq_join_conjuncts)
        {
      ...
      if (struct.isSetOther_join_conjuncts()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TExpr _iter963 : struct.other_join_conjuncts)
          {
      ...
      if (struct.isSetPartition_exprs()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TExpr _iter964 : struct.partition_exprs)
          {
      ...
      if (struct.isSetOutput_columns()) {
        {
          ...
          for (int _iter965 : struct.output_columns)
          {
            oprot.writeI32(_iter965);
          }
        }
      }
    }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TStreamJoinNode struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      struct.join_op = io.datafibre.fibre.thrift.TJoinOp.findByValue(iprot.readI32());
      struct.setJoin_opIsSet(true);
      {
        org.apache.thrift.protocol.TList _list966 = iprot.readListBegin(org.apache.thrift.protocol.TType.STRUCT);
        struct.eq_join_conjuncts = new java.util.ArrayList<TEqJoinCondition>(_list966.size);
        @org.apache.thrift.annotation.Nullable TEqJoinCondition _elem967;
        for (int _i968 = 0; _i968 < _list966.size; ++_i968)
        {
          _elem967 = new TEqJoinCondition();
          _elem967.read(iprot);
          struct.eq_join_conjuncts.add(_elem967);
        }
      }
      struct.setEq_join_conjunctsIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.other_join_conjuncts = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list969.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem970;
          for (int _i971 = 0; _i971 < _list969.size; ++_i971)
          {
            _elem970 = new io.datafibre.fibre.thrift.TExpr();
            _elem970.read(iprot);
            struct.other_join_conjuncts.add(_elem970);
          }
        }
        struct.setOther_join_conjunctsIsSet(true);
      }
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.partition_exprs = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list972.size);
          @org.apache.thrift.annotation.Nullable io.datafibre.fibre.thrift.TExpr _elem973;
          for (int _i974 = 0; _i974 < _list972.size; ++_i974)
          {
            _elem973 = new io.datafibre.fibre.thrift.TExpr();
            _elem973.read(iprot);
            struct.partition_exprs.add(_elem973);
          }
        }
        struct.setPartition_exprsIsSet(true);
      }
      if (incoming.get(6)) {
        {
          org.apache.thrift.protocol.TList _list975 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.output_columns = new java.util.ArrayList<java.lang.Integer>(_list975.size);
          int _elem976;
          for (int _i977 = 0; _i977 < _list975.size; ++_i977)
          {
            _elem976 = iprot.readI32();
            struct.output_columns.add(_elem976);
          }
        }
        struct.setOutput_columnsIsSet(true);
      }
