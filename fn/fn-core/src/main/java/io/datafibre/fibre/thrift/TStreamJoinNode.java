...
public class TStreamJoinNode implements org.apache.thrift.TBase<TStreamJoinNode, TStreamJoinNode._Fields>, java.io.Serializable, Cloneable, Comparable<TStreamJoinNode> {
  ...
  public TStreamJoinNode setOther_join_conjuncts(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> other_join_conjuncts) {
  ...
  public TStreamJoinNode setPartition_exprs(@org.apache.thrift.annotation.Nullable java.util.List<com.starrocks.thrift.TExpr> partition_exprs) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.other_join_conjuncts = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list949.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem950;
                for (int _i951 = 0; _i951 < _list949.size; ++_i951)
                {
                  _elem950 = new com.starrocks.thrift.TExpr();
                  _elem950.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list952.size);
                @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem953;
                for (int _i954 = 0; _i954 < _list952.size; ++_i954)
                {
                  _elem953 = new com.starrocks.thrift.TExpr();
                  _elem953.read(iprot);
      ...
      if (struct.other_join_conjuncts != null) {
        if (struct.isSetOther_join_conjuncts()) {
          oprot.writeFieldBegin(OTHER_JOIN_CONJUNCTS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter959 : struct.other_join_conjuncts)
            {
      ...
      if (struct.partition_exprs != null) {
        if (struct.isSetPartition_exprs()) {
          oprot.writeFieldBegin(PARTITION_EXPRS_FIELD_DESC);
          {
            ...
            for (com.starrocks.thrift.TExpr _iter960 : struct.partition_exprs)
            {
      ...
      if (struct.isSetOther_join_conjuncts()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter963 : struct.other_join_conjuncts)
          {
      ...
      if (struct.isSetPartition_exprs()) {
        {
          ...
          for (com.starrocks.thrift.TExpr _iter964 : struct.partition_exprs)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.other_join_conjuncts = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list969.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem970;
          for (int _i971 = 0; _i971 < _list969.size; ++_i971)
          {
            _elem970 = new com.starrocks.thrift.TExpr();
            _elem970.read(iprot);
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.partition_exprs = new java.util.ArrayList<com.starrocks.thrift.TExpr>(_list972.size);
          @org.apache.thrift.annotation.Nullable com.starrocks.thrift.TExpr _elem973;
          for (int _i974 = 0; _i974 < _list972.size; ++_i974)
          {
            _elem973 = new com.starrocks.thrift.TExpr();
            _elem973.read(iprot);
