...
public class TKeyLiteralExpr implements org.apache.thrift.TBase<TKeyLiteralExpr, TKeyLiteralExpr._Fields>, java.io.Serializable, Cloneable, Comparable<TKeyLiteralExpr> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> literal_exprs; // optional
  ...
  public TKeyLiteralExpr(TKeyLiteralExpr other) {
    if (other.isSetLiteral_exprs()) {
      java.util.List<io.datafibre.fibre.thrift.TExpr> __this__literal_exprs = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(other.literal_exprs.size());
      for (io.datafibre.fibre.thrift.TExpr other_element : other.literal_exprs) {
        __this__literal_exprs.add(new io.datafibre.fibre.thrift.TExpr(other_element));
      }
  ...
  @org.apache.thrift.annotation.Nullable
  public java.util.Iterator<io.datafibre.fibre.thrift.TExpr> getLiteral_exprsIterator() {
    return (this.literal_exprs == null) ? null : this.literal_exprs.iterator();
  }

  public void addToLiteral_exprs(io.datafibre.fibre.thrift.TExpr elem) {
    if (this.literal_exprs == null) {
      this.literal_exprs = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>();
    }
    this.literal_exprs.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<io.datafibre.fibre.thrift.TExpr> getLiteral_exprs() {
    return this.literal_exprs;
  }

  public TKeyLiteralExpr setLiteral_exprs(@org.apache.thrift.annotation.Nullable java.util.List<io.datafibre.fibre.thrift.TExpr> literal_exprs) {
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case LITERAL_EXPRS:
      if (value == null) {
        ...
        setLiteral_exprs((java.util.List<io.datafibre.fibre.thrift.TExpr>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.literal_exprs = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list0.size);
      ...
      if (struct.literal_exprs != null) {
        if (struct.isSetLiteral_exprs()) {
          oprot.writeFieldBegin(LITERAL_EXPRS_FIELD_DESC);
          {
            ...
            for (io.datafibre.fibre.thrift.TExpr _iter3 : struct.literal_exprs)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetLiteral_exprs()) {
        {
          ...
          for (io.datafibre.fibre.thrift.TExpr _iter4 : struct.literal_exprs)
          {
            _iter4.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.literal_exprs = new java.util.ArrayList<io.datafibre.fibre.thrift.TExpr>(_list5.size);
